...
public class ServiceDeskController extends SuperController {
	...
	*/
	...
	@NotNull(name = ServiceDeskVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = serviceDeskService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = ServiceDeskVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = serviceDeskService.hasRefers(ids);
		// 收集可以删除的ID值
