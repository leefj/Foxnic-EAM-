...
public class ServerOsTypeController extends SuperController {
	...
	*/
	...
	@NotNull(name = ServerOsTypeVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = serverOsTypeService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = ServerOsTypeVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = serverOsTypeService.hasRefers(ids);
		// 收集可以删除的ID值
