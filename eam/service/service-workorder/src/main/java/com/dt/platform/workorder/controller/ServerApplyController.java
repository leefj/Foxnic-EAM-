...
public class ServerApplyController extends SuperController implements BpmCallbackController{
	...
	*/
	...
	@NotNull(name = ServerApplyVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = serverApplyService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = ServerApplyVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = serverApplyService.hasRefers(ids);
		// 收集可以删除的ID值
	...
	*/
	...
	public Result<ServerApply> getById(String id) {
		...
		// join 关联的对象
		serverApplyService.dao().fill(serverApply)
			.with("originator")
			.execute();
	...
	*/
	...
	public Result<PagedList<ServerApply>> queryPagedList(ServerApplyVO sample) {
		...
		// join 关联的对象
		serverApplyService.dao().fill(list)
			.with("originator")
			.execute();
		// 填充流程相关的属性
