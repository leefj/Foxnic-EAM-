...
public class ServicePortalController extends SuperController {
	...
	*/
	...
	@NotNull(name = ServicePortalVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = servicePortalService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = ServicePortalVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = servicePortalService.hasRefers(ids);
		// 收集可以删除的ID值
	...
	*/
	...
	public Result<ServicePortal> getById(String id) {
		...
		// join 关联的对象
		servicePortalService.dao().fill(servicePortal)
			.with(ServicePortalMeta.GROUP)
			.execute();
	...
	*/
	...
	public Result<PagedList<ServicePortal>> queryPagedList(ServicePortalVO sample) {
		...
		// join 关联的对象
		servicePortalService.dao().fill(list)
			.with(ServicePortalMeta.GROUP)
			.execute();
		result.success(true).data(list);
		return result;
