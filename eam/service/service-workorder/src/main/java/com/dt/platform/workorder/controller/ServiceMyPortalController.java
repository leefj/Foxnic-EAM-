...
public class ServiceMyPortalController extends SuperController {
	...
	*/
	...
	@NotNull(name = ServiceMyPortalVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = serviceMyPortalService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = ServiceMyPortalVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = serviceMyPortalService.hasRefers(ids);
		// 收集可以删除的ID值
