...
public class SlbStrategyApplyController extends SuperController implements BpmCallbackController{
	...
	*/
	...
	@NotNull(name = SlbStrategyApplyVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = slbStrategyApplyService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = SlbStrategyApplyVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = slbStrategyApplyService.hasRefers(ids);
		// 收集可以删除的ID值
	...
	*/
	...
	public Result<SlbStrategyApply> getById(String id) {
		...
		// join 关联的对象
		slbStrategyApplyService.dao().fill(slbStrategyApply)
			.with("originator")
			.execute();
	...
	*/
	...
	public Result<PagedList<SlbStrategyApply>> queryPagedList(SlbStrategyApplyVO sample) {
		...
		// join 关联的对象
		slbStrategyApplyService.dao().fill(list)
			.with("originator")
			.execute();
		// 填充流程相关的属性
