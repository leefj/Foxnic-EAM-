...
public class ModuleGroupServiceImpl extends SuperService<ModuleGroup> implements IModuleGroupService {
	 ...
	 * */
	@Override
	public List<ModuleGroup> queryList(ModuleGroup sample) {
	 ...
	 * */
	@Override
	public PagedList<ModuleGroup> queryPagedList(ModuleGroup sample, int pageSize, int pageIndex) {
	...
	@Override
	public ExcelWriter exportExcel(ModuleGroup sample) {
