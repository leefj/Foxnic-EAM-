package com.dt.platform.hrm.controller;
...
import com.dt.platform.hrm.service.IPersonService;
...
public class PersonController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = PersonVOMeta.IDENTITY_CARD , value = "身份证号" , required = false , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = PersonVOMeta.POSITION_ID , value = "员工岗位" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = PersonVOMeta.EMPLOYEE_TITLE_ID , value = "员工职称" , required = false , dataTypeClass=String.class),
