...
public class AssetStatusController extends SuperController {
	...
	*/
	...
	@NotNull(name = AssetStatusVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = assetStatusService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AssetStatusVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = assetStatusService.hasRefers(ids);
		// 收集可以删除的ID值
