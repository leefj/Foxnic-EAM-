...
public class AssetStatusRuleController extends SuperController {
	...
	*/
	...
	@NotNull(name = AssetStatusRuleVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = assetStatusRuleService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AssetStatusRuleVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = assetStatusRuleService.hasRefers(ids);
		// 收集可以删除的ID值
