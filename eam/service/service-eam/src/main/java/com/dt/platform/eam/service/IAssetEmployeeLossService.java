...
public interface IAssetEmployeeLossService extends ISuperService<AssetEmployeeLoss> {
	 ...
	 * @return 查询结果
	 * */
	List<AssetEmployeeLoss> queryList(AssetEmployeeLoss sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<AssetEmployeeLoss> queryPagedList(AssetEmployeeLoss sample,int pageSize,int pageIndex);
