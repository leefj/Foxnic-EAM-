...
public class AssetEmployeeApplyServiceImpl extends SuperService<AssetEmployeeApply> implements IAssetEmployeeApplyService {
	 ...
	 * */
	@Override
	public List<AssetEmployeeApply> queryList(AssetEmployeeApply sample) {
	 ...
	 * */
	@Override
	public PagedList<AssetEmployeeApply> queryPagedList(AssetEmployeeApply sample, int pageSize, int pageIndex) {
