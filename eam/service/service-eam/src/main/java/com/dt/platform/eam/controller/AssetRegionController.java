...
public class AssetRegionController extends SuperController {
	...
	*/
	...
	@NotNull(name = AssetRegionVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = assetRegionService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AssetRegionVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = assetRegionService.hasRefers(ids);
		// 收集可以删除的ID值
