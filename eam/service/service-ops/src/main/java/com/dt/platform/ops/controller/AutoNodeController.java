...
public class AutoNodeController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = AutoNodeVOMeta.VOUCHER_ID , value = "凭证" , required = false , dataTypeClass=String.class),
	...
	*/
	...
	@NotNull(name = AutoNodeVOMeta.ID)
	...
	*/
	...
	public Result<AutoNode> getById(String id) {
		...
		// join 关联的对象
		autoNodeService.dao().fill(autoNode)
