...
public class MonitorObjectModelController extends SuperController {
	...
	*/
	...
	@NotNull(name = MonitorObjectModelVOMeta.ID)
	...
	*/
	...
	@NotNull(name = MonitorObjectModelVOMeta.IDS)
	...
	*/
	...
	public Result<MonitorObjectModel> getById(String id) {
		...
		// join 关联的对象
		monitorObjectModelService.dao().fill(monitorObjectModel)
			.with(MonitorObjectModelMeta.GROUP)
			.execute();
	...
	*/
	...
	public Result<PagedList<MonitorObjectModel>> queryPagedList(MonitorObjectModelVO sample) {
		...
		// join 关联的对象
		monitorObjectModelService.dao().fill(list)
			.with(MonitorObjectModelMeta.GROUP)
			.execute();
		result.success(true).data(list);
		return result;
