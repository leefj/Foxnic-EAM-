...
public class AutoActionScriptController extends SuperController {
	...
	*/
	...
	@NotNull(name = AutoActionScriptVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = autoActionScriptService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AutoActionScriptVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = autoActionScriptService.hasRefers(ids);
		// 收集可以删除的ID值
