...
public class MonitorObjectController extends SuperController {
	...
	*/
	...
	@NotNull(name = MonitorObjectVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = monitorObjectService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = MonitorObjectVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = monitorObjectService.hasRefers(ids);
		// 收集可以删除的ID值
	...
	*/
	...
	public Result<MonitorObject> getById(String id) {
		...
		// join 关联的对象
		monitorObjectService.dao().fill(monitorObject)
			.with(MonitorObjectMeta.GROUP)
			.with(MonitorObjectMeta.OBJECT_MODEL)
			.execute();
	...
	*/
	...
	public Result<PagedList<MonitorObject>> queryPagedList(MonitorObjectVO sample) {
		...
		// join 关联的对象
		monitorObjectService.dao().fill(list)
			.with(MonitorObjectMeta.GROUP)
			.with(MonitorObjectMeta.OBJECT_MODEL)
			.execute();
		result.success(true).data(list);
