...
public class SystemConsoleInfoController extends SuperController {
	...
	*/
	...
	@NotNull(name = SystemConsoleInfoVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = systemConsoleInfoService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = SystemConsoleInfoVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = systemConsoleInfoService.hasRefers(ids);
		// 收集可以删除的ID值
	...
	*/
	...
	public Result<SystemConsoleInfo> getById(String id) {
		...
		// join 关联的对象
		systemConsoleInfoService.dao().fill(systemConsoleInfo)
			.with(SystemConsoleInfoMeta.TYPE_DICT)
			.execute();
	...
	*/
	...
	public Result<PagedList<SystemConsoleInfo>> queryPagedList(SystemConsoleInfoVO sample) {
		...
		// join 关联的对象
		systemConsoleInfoService.dao().fill(list)
			.with(SystemConsoleInfoMeta.TYPE_DICT)
			.execute();
		result.success(true).data(list);
		return result;
