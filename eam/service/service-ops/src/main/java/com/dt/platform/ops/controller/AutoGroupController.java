...
public class AutoGroupController extends SuperController {
	...
	*/
	...
	@NotNull(name = AutoGroupVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = autoGroupService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AutoGroupVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = autoGroupService.hasRefers(ids);
		// 收集可以删除的ID值
