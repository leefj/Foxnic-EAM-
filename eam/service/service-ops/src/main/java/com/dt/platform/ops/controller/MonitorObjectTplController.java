...
public class MonitorObjectTplController extends SuperController {
	...
	*/
	...
	@NotNull(name = MonitorObjectTplVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = monitorObjectTplService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = MonitorObjectTplVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = monitorObjectTplService.hasRefers(ids);
		// 收集可以删除的ID值
