...
public class AutoActionController extends SuperController {
	...
	*/
	...
	@NotNull(name = AutoActionVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = autoActionService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AutoActionVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = autoActionService.hasRefers(ids);
		// 收集可以删除的ID值
	...
	*/
	...
	public Result<AutoAction> getById(String id) {
		...
		// join 关联的对象
		autoActionService.dao().fill(autoAction)
			.with(AutoActionMeta.AUTO_ACTION_SCRIPT_LIST)
			.with(AutoActionMeta.AUTO_ACTION_FILE_LIST)
			.execute();
	...
	*/
	...
	public Result<PagedList<AutoAction>> queryPagedList(AutoActionVO sample) {
		...
		// join 关联的对象
		autoActionService.dao().fill(list)
			.with(AutoActionMeta.AUTO_ACTION_SCRIPT_LIST)
			.with(AutoActionMeta.AUTO_ACTION_FILE_LIST)
			.execute();
		result.success(true).data(list);
