            ...
            var tableConfig={
                ...
                cols: [[
                  ...
                  //  ,{ field: 'nodeIp', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('主机IP') , templet: function (d) { return templet('nodeIp',d.nodeIp,d);}  }
                    ,{ field: 'nodeNameShow', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('数据库名称') , templet: function (d) { return templet('nodeNameShow',d.nodeNameShow,d);}  }
                    ,{ field: 'dataDbStatus', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('状态') , templet: function (d) {
                        if(d.dataDbStatus=="1"){
                            return "在线"
                        }else{
                            return "下线"
                   ...
                   ,{ field: 'dataDbSize', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('数据库大小') , templet: function (d) { return templet('dataDbSize',d.dataDbSize,d);}  }
                    ,{ field: 'dataDbConnectNumber', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('连接数') , templet: function (d) { return templet('dataDbConnectNumber',d.dataDbConnectNumber,d);}  }
                    ,{ field: 'dataDbNodeVersion', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('版本') , templet: function (d) { return templet('dataDbNodeVersion',d.dataDbNodeVersion,d);}  }
