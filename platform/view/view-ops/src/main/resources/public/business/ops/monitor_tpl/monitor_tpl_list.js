		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'type', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('归类'), templet: function (d) { return templet('type' ,fox.joinLabel(d.tplType,"name",',','','type'),d);}}
