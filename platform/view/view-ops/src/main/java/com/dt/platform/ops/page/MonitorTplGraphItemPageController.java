...
public class MonitorTplGraphItemPageController extends ViewController {
	...
	public String list(Model model,HttpServletRequest request,String graphId,String pageAction) {
		model.addAttribute("graphId",graphId);
		model.addAttribute("pageAction",pageAction);
		return getTemplatePath(prefix,"monitor_tpl_graph_item_list");
	}
	...
	public String form(Model model,HttpServletRequest request , String id,String graphId) {
		model.addAttribute("graphId",graphId);
		return getTemplatePath(prefix,"monitor_tpl_graph_item_form");
	}
}