...
function ListPage() {
	...
	function bindButtonEvent() {
		...
		table.on('toolbar(data-table)', function(obj){
			...
			switch(obj.event){
				case 'create':
					admin.putTempData('cont-contract-performance-form-data', {});
					openCreateFrom();
					break;
				case 'batch-del':
	...
	function showEditForm(data) {
		...
		admin.popupCenter({
			...
			content: '/business/contract/contract_performance/contract_performance_form.html' + (queryString?("?"+queryString):""),
			finish: function () {
				if(action=="create") {
					refreshTableData();
				}
