...
export class IndexNoticePlugin extends BasePlugin {
    static id = 'IndexNoticePlugin';
    // 关联渲染器名字
    ...
    scaffold = {
        type: 'iframe',
        src: '/business/oa/portal/part_notice.html?height=400'
    };
...
registerEditorPlugin(IndexNoticePlugin);
