...
export class IndexDownloadPlugin extends BasePlugin {
    static id = 'IndexDownloadPlugin';
    // 关联渲染器名字
    rendererName = 'index-download';
    ...
    scaffold = {
        type: 'iframe',
        src: '/business/oa/portal/part_download.html?height=400'
    };
...
registerEditorPlugin(IndexDownloadPlugin);
