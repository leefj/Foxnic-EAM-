...
function ListPage() {
	...
	//模块基础路径
	const moduleURL="/service-common/sys-invoke-log";
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'userAgent', align:"left",fixed:false,  hide:true, sort: true  , title: fox.translate('UserAgent') , templet: function (d) { return templet('userAgent',d.userAgent,d);}  }
	...
	function refreshTableData(sortField,sortType,reset) {
		...
		var value = {};
		value.application={ inputType:"button",value: $("#application").val() ,fuzzy: true,splitValue:false,valuePrefix:"",valueSuffix:"" };
		value.hostName={ inputType:"button",value: $("#hostName").val() ,fuzzy: true,splitValue:false,valuePrefix:"",valueSuffix:"" };
		value.type={ inputType:"button",value: $("#type").val() ,fuzzy: true,splitValue:false,valuePrefix:"",valueSuffix:"" };
		value.userAgent={ inputType:"button",value: $("#userAgent").val()};
		value.clientIp={ inputType:"button",value: $("#clientIp").val() ,fuzzy: true,splitValue:false,valuePrefix:"",valueSuffix:"" };
	...
	function showEditForm(data) {
		...
		admin.popupCenter({
			...
			content: '/business/common/invoke_log/invoke_log_form.html' + (queryString?("?"+queryString):""),
			finish: function () {
				if(action=="create") {
					refreshTableData();
				}
