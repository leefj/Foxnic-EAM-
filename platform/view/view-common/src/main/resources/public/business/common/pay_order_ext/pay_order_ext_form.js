...
function FormPage() {
	...
	this.init=function(layui) {
		...
		action=admin.getTempData('sys-pay-order-ext-form-data-form-action');
		//如果没有修改和保存权限
		...
		if(window.pageExt.form.beforeInit) {
			window.pageExt.form.beforeInit(action,admin.getTempData('sys-pay-order-ext-form-data'));
		}
	...
	function adjustPopup(arg) {
		...
		adjustPopupTask=setTimeout(function () {
			...
			var area=admin.changePopupArea(null,bodyHeight+footerHeight,'sys-pay-order-ext-form-data-win');
			if(area==null) return;
			admin.putTempData('sys-pay-order-ext-form-area', area);
	...
	function renderFormFields() {
		...
		fox.renderSelectBox({
			el: "orderId",
			radio: true,
			tips: fox.translate("请选择",'','cmp:form')+fox.translate("支付订单编号",'','cmp:form'),
			filterable: true,
			paging: true,
			pageRemote: true,
			layVerify: 'required',
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('sys-pay-order-ext-form-data');
		}
	...
	function getRawFormData() {
		if(!rawFormData) {
			rawFormData = admin.getTempData('sys-pay-order-ext-form-data');
		}
		return rawFormData;
	}
	...
	function saveForm(param,callback) {
		...
		admin.post(api, param, function (data) {
			if (data.success) {
				...
				if(doNext) {
					admin.finishPopupCenterById('sys-pay-order-ext-form-data-win');
				}
    ...
    function bindButtonEvent() {
	    ...
	    //关闭窗口
	    $("#cancel-button").click(function(){ admin.finishPopupCenterById('sys-pay-order-ext-form-data-win',this); });
