...
export class FlowProfilePlugin extends BasePlugin {
    static id = 'FlowProfilePlugin';
    // 关联渲染器名字
    rendererName = 'flow-profile';
    ...
    scaffold = {
        type: 'iframe',
        src: '/business/oa/portal/part_flow_stat.html?height=400'
    };
...
registerEditorPlugin(FlowProfilePlugin);
