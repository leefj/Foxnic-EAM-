...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        layerFuc:function (data){
            var queryString="?dashBoardId="+data.id;
            admin.popupCenter({
                title: "分层",
                resize: false,
                offset: [20,null],
                area: ["80%","85%"],
                type: 2,
                id:"sys-dashboard-layer-data-win",
                content: '/business/common/dashboard_layer/dashboard_layer_list.html' +queryString,
                finish: function () {
                }
            });
        },
        layerEleFuc:function (data){
            console.log('layerEleFuc',data);
            var queryString="?dashBoardId="+data.id;
            admin.popupCenter({
                title: "分层",
                resize: false,
                ...
                type: 2,
                id:"sys-dashboard-layer-data-win",
                content: '/business/common/dashboard_layer_ele/dashboard_layer_ele_list.html' +queryString,
                finish: function () {
                }
            });
        },
        review:function (data){
            console.log('layerEleFuc',data);
            var url="/business/common/dashboard/dashboard_show.html?code="+data.code
