...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        designer:function (data){
            window.open("/business/common/page_ui_editor/gh_pages/index.html#/edit/0g?id="+data.id,"_blank");
        },
        review:function (data){
            myWindow=window.open("/business/common/page_info/page_info_apply.html?id="+data.id,"_blank");
