...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        makeFormQueryString:function(data,queryString,action) {
            if(data.id){
                queryString=queryString+"&formId="+data.formId;
            }else{
                queryString="formId="+FORM_ID;
            }
            return queryString;
        },
        /**
        ...
        formDesinger:function (data){
            window.open("../form/vform/dist/build/index.html?formId="+data.id,"_blank")
            console.log('formDesinger',data);
        },
        formView:function (data){
            console.log('formView',data);
        },
        formApply:function (ps){
            console.log('formView',ps);
            var btnClass="form-apply"
