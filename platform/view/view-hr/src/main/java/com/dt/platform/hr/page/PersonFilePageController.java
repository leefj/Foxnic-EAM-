...
public class PersonFilePageController extends ViewController {
	...
	@RequestMapping("/not_employee_person_file_list.html")
	public String list2(Model model,HttpServletRequest request) {
		return getTemplatePath(prefix,"not_employee_person_file_list");
	}
	...
	public String list(Model model,HttpServletRequest request) {
		return getTemplatePath(prefix,"person_file_list");
	}
	...
	public String form(Model model,HttpServletRequest request , String id) {
		return getTemplatePath(prefix,"person_file_form");
	}
}