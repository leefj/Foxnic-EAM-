		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'taskPaperId', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('评分卷') , templet: function (d) { return templet('taskPaperId',d.taskPaperId,d);}  }
					...
					,{ field: 'sn', align:"right",fixed:false,  hide:false, sort: true  , title: fox.translate('顺序') , templet: function (d) { return templet('sn',d.sn,d);}  }
