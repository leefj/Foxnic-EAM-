    ...
    var list={
        ...
        processRcd(selected,obj){
            admin.popupCenter({
                ...
                content: '/business/hr/attendance_data_process/attendance_data_process_list.html',
                finish: function () {

                }
            });
        },
        processing:function (ps){
            console.log('processing',ps);
            var btnClass="process-data";
            var btn=$('.'+btnClass).filter("[data-id='" +ps.id + "']");
            var api=moduleURL+"/process";
