		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'assessorStr', align:"",fixed:false,  hide:false, sort: false  , title: fox.translate('考核人') , templet: function (d) { return templet('assessorStr',fox.getProperty(d,["assessor","name"],0,'','assessorStr'),d);} }
