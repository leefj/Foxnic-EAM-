...
function ListPage() {
	...
	const queryURL=moduleURL+'/query-abnormal-data-paged-list';
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'normalDay', align:"right",fixed:false,  hide:false, sort: true  , title: fox.translate('上班天数') , templet: function (d) { return templet('normalDay',d.normalDay,d);}  }
