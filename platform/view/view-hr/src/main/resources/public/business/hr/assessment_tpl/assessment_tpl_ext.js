...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var formAction=admin.getTempData('hr-assessment-tpl-form-data-form-action');
    ...
    var form={
         ...
         *  加载 指标数据
         */
        indicatorSelectList:function (ifr,win,data) {
            // debugger
            console.log("indicatorSelectList",ifr,data);
            //设置 iframe 高度
            ifr.height("400px");
            var assessmentId="";
            //设置地址
