...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        beforeInit:function () {
            ...
            var operHtmlHtml=document.getElementById("tableOperationTemplate").innerHTML;
            operHtmlHtml=operHtmlHtml.replace(/lay-event="view"/i, "style=\"display:none\"")
            operHtmlHtml=operHtmlHtml.replace(/lay-event="edit"/i, "style=\"display:none\"")
            operHtmlHtml=operHtmlHtml.replace(/lay-event="del"/i, "style=\"display:none\"")
            document.getElementById("tableOperationTemplate").innerHTML=operHtmlHtml;
        ...
        templet:function (field,value,r) {
            if(field=="assesseeStr"){
                ...
                }else if (r.relationship=="secondLeader"){
                    if(r.withSecondLeaderList&&r.withSecondLeaderList.length>0){
                ...
                }else if (r.relationship=="sameUser"){
