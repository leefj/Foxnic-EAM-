...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        afterQuery : function (data) {
            for (var i = 0; i < data.length; i++) {
                ...
                if(data[i].status=="valid") {
                    ...
                    fox.disableButton($('.person-file-out').filter("[data-id='" + data[i].id + "']"), true);
        ...
        makeFormQueryString:function(data,queryString,action) {
            ...
            queryString="fileId="+FILE_ID;
            console.log("queryString22",queryString);
            return queryString;
        },
        /**
        ...
        confirmFunc:function (ps, it){
            console.log('confirmFunc',ps,it);

            var btnClass="person-file-out"
            var btn=$('.'+btnClass).filter("[data-id='" +ps.id + "']");
            var api="/service-hr/hr-person-file-out/confirm";
