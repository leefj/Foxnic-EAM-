    ...
    var list={
        ...
        beforeInit:function () {
            ...
            if(ACTION_STATUS=="finish"){
                ...
                operHtml2=operHtml2.replace(/lay-event="reset-data"/i, "style=\"display:none\"")
        ...
        afterQuery : function (data) {
            for (var i = 0; i < data.length; i++) {
                ...
                if(data[i].status=="valid") {
                    ...
                    fox.disableButton($('.person-reset-data').filter("[data-id='" + data[i].id + "']"), true);
                }else  {
        ...
        resetData:function (ps, it){
            console.log('moreAction',ps,it);
            var btnClass="person-reset-data";
            var btn=$('.'+btnClass).filter("[data-id='" +ps.id + "']");
            var pt={};
            pt.id=ps.id;
            var api="/service-hr/hr-salary-detail/reset"
        ...
        validData:function (selected, obj){
            ...
            var btn=$('.'+btnClass);
            var pt={};
            pt.actionId=ACTION_ID;
            var api="/service-hr/hr-salary-detail/valid"
            top.layer.confirm(fox.translate('确定进行该操作吗？'), function (i) {
                top.layer.close(i);
                admin.post(api, pt, function (r) {
                    if (r.success) {
