...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        templet:function (field,value,r) {
            ...
            if(field=="nameStr"){
                var html="";
                if(r.assessmentBill&&r.assessmentBill.taskName){
                    html=r.assessmentBill.taskName;
                }
                return html;
            }
            if(field=="stimeStr"){
                var html="";
                if(r.assessmentBill&&r.assessmentBill.stime){
                    html=r.assessmentBill.stime;
                }
                return html;
            }
            ...
            if(field=="etimeStr"){
                var html="";
                if(r.assessmentBill&&r.assessmentBill.etime){
                    html=r.assessmentBill.etime;
                }
                return html;
            }
        ...
        taskAction (data, it){
            admin.popupCenter({
                ...
                content: '/business/hr/assessment_bill_task_dtl/assessment_bill_task_dtl_list.html?billTaskId='+data.id,
                finish: function () {
