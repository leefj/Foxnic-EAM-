...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        scoreItem:function (data){
            console.log('scoreItem',data);

            var queryString="?tplId="+data.id;
            admin.popupCenter({
                title: "评分项",
                resize: false,
                offset: [10,null],
                ...
                content: '/business/hr/score_tpl_item/score_tpl_item_list.html' +queryString,
                finish: function () {
