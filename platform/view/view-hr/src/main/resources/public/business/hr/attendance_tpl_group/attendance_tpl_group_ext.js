...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var form={
        ...
        beforeSubmit:function (data) {
            ...
            data.onWorkTime="2000-01-01 "+data.onWorkTime;
            data.onWorkTimeUp="2000-01-01 "+data.onWorkTimeUp;
            data.onWorkTimeDown="2000-01-01 "+data.onWorkTimeDown;

            data.offWorkTime="2000-01-01 "+data.offWorkTime;
            data.offWorkTimeUp="2000-01-01 "+data.offWorkTimeUp;
            data.offWorkTimeDown="2000-01-01 "+data.offWorkTimeDown;

            data.halfWorkUp="2000-01-01 "+data.halfWorkUp;
            data.halfWorkDown="2000-01-01 "+data.halfWorkDown;
