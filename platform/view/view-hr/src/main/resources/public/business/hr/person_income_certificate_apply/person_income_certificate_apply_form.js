...
function FormPage() {
	...
	this.init=function(layui) {
		...
		action=admin.getTempData('hr-person-income-certificate-apply-form-data-form-action');
		//如果没有修改和保存权限
		...
		if(window.pageExt.form.beforeInit) {
			window.pageExt.form.beforeInit(action,admin.getTempData('hr-person-income-certificate-apply-form-data'));
		}
	...
	function adjustPopup(arg) {
		...
		adjustPopupTask=setTimeout(function () {
			...
			var area=admin.changePopupArea(null,bodyHeight+footerHeight,'hr-person-income-certificate-apply-form-data-win');
			if(area==null) return;
			admin.putTempData('hr-person-income-certificate-apply-form-area', area);
	...
	function renderFormFields() {
		...
		laydate.render({
			...
			trigger:"click",
				...
				window.pageExt.form.onDatePickerChanged && window.pageExt.form.onDatePickerChanged("confirmDate",value, date, endDate);
			}
		});
	    //渲染图片字段
		foxup.render({
	...
	function fillFormData(formData) {
		if(!formData) {
			formData = admin.getTempData('hr-person-income-certificate-apply-form-data');
		}
		...
		if (hasData) {
			...
			if(formData["confirmDate"]) {
				$("#confirmDate").val(fox.dateFormat(formData["confirmDate"],"yyyy-MM-dd"));
			}
	...
	function getRawFormData() {
		if(!rawFormData) {
			rawFormData = admin.getTempData('hr-person-income-certificate-apply-form-data');
		}
		return rawFormData;
	}
	...
	function saveForm(param,callback) {
		...
		admin.post(api, param, function (data) {
			if (data.success) {
				...
				if(doNext) {
					admin.finishPopupCenterById('hr-person-income-certificate-apply-form-data-win');
				}
    ...
    function bindButtonEvent() {
	    ...
	    //关闭窗口
	    $("#cancel-button").click(function(){ admin.finishPopupCenterById('hr-person-income-certificate-apply-form-data-win',this); });
