		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'jobContent', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('工作职责') , templet: function (d) { return templet('jobContent',d.jobContent,d);}  }
