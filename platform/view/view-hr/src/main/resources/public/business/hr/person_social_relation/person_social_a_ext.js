...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        beforeInit:function () {
            ...
            if(ROLE&&ROLE=="admin"){
                var toolHtml=document.getElementById("toolbarTemplate").innerHTML;
                toolHtml=toolHtml.replace(/lay-event="approval"/i, "style=\"display:none\"")
                document.getElementById("toolbarTemplate").innerHTML=toolHtml;
            }
        ...
        templet:function (field,value,r) {
            if(field=="fileIds"){
                if(value&&value.length>5){
                    return "<a href=\"/service-storage/sys-file/download?id="+value+"\">附件下载</a>"
                }else{
                    return "";
                }
            }
        ...
        makeFormQueryString:function(data,queryString,action) {
            ...
            var itemFlag="hr.personSocialRelation_"+timestamp
            queryString="itemFlag="+itemFlag+"&type=hr.personSocialRelation";
            admin.putTempData(itemFlag, itemIds);
