...
function ListPage() {
	...
	//模块基础路径
	const moduleURL="/service-vehicle/oa-vehicle-insurance-record";
	...
	function showEditForm(data) {
		...
		admin.popupCenter({
			...
			content: '/business/vehicle/le_insurance_record/le_insurance_record_form.html' + (queryString?("?"+queryString):""),
			finish: function () {
				if(action=="create") {
					refreshTableData();
				}
