...
function FormPage() {
	...
	function getRawFormData() {
		if(!rawFormData) {
			rawFormData = admin.getTempData('vehicle-maintenance-form-data');
		}
		return rawFormData;
	}
    ...
    function bindButtonEvent() {
	    ...
	    //关闭窗口
	    $("#cancel-button").click(function(){ admin.finishPopupCenterById('vehicle-maintenance-form-data-win',this); });
