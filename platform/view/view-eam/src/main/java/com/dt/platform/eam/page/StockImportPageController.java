...
@Controller("EamStockImportPageController")
@RequestMapping(StockImportPageController.prefix)
public class StockImportPageController extends ViewController {

	public static final String prefix="business/eam/stock_import";

	private StockImportServiceProxy proxy;
	 ...
	 * 3、微服务时，通过feign调用; <br>
	 * */
	public StockImportServiceProxy proxy() {
		if(proxy==null) {
			proxy=StockImportServiceProxy.api();
		}
		return proxy;
	}
