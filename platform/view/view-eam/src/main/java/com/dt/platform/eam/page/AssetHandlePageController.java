...
public class AssetHandlePageController extends ViewController {
	...
	public String list(Model model,HttpServletRequest request) {
		return getTemplatePath(prefix,"asset_handle_list");
	}
	...
	public String form(Model model,HttpServletRequest request , String id,String processId) {
		...
		model.addAttribute("billType", AssetOperateEnum.EAM_ASSET_HANDLE.code());
		//打印流程数据
		...
		return getTemplatePath(prefix,"asset_handle_form");
	}
}