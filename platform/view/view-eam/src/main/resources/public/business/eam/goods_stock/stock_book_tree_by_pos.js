...
function ListPage() {
	...
	this.init=function(layui) {
		...
		admin.request("/service-eam/eam-warehouse-position/query-tree-data",{},function(r) {
				menuTree=$.fn.zTree.init($("#menu-tree"), cfgs,r);
	...
	function onNodeClick(event, treeId, treeNode) {
		...
		$("#asset-list-ifr")[0].contentWindow.module.searchPos(treeNode.id,treeNode.type);
	}
