...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    //列表页的扩展
    var list={
        baseInfo:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/product_function/product_function_list.html?productId="+PRODUCT_ID+"&t="+timestamp
        },
        dataProperty:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/product_content/product_tsl_form.html?ctType=tsl&ownerId="+PRODUCT_ID+"&t="+timestamp
        },
        dataService:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order/repair_order_list.html?productId="+PRODUCT_ID+"&t="+timestamp
        },
        dataLog:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order/repair_order_list.html?productId="+PRODUCT_ID+"&t="+timestamp
        },
        dataConf:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order/repair_order_list.html?productId="+PRODUCT_ID+"&t="+timestamp
        },
        mnReport:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order/repair_order_list.html?productId="+PRODUCT_ID+"&t="+timestamp
        },
        mnEq:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order/repair_order_list.html?productId="+PRODUCT_ID+"&t="+timestamp
        },
        /**
