...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var form={
        ...
        afterDataFill:function (data) {
            ...
            if(data.stockGoodsOut){
                $("#orderId-button").html(data.stockGoodsOut.name);
            }
        ...
        selectOrder:function (data,input,button) {
            ...
            //stockGoodsOut
            var queryString="?importType=stock&importId="+importId+"&ownerCode=stock&ownerType=stock"
            admin.popupCenter({
                title: "库存出库单",
                resize: false,
                offset: [10,null],
                area: ["95%","95%"],
                type: 2,
                id:"eam-stock-order-list-data-win",
                content: '/business/eam/asset_stock_goods_out/out_import_list.html' +queryString,
                finish: function () {
        ...
        assetList:function (ifr,win,data) {
            ...
            win.location="/business/eam/stock_import/import_asset_list.html?importId="+importId+"&pageType="+formAction+"&t=123456789";
        },
        /**
         * 文件上传组件回调
         *  event 类型包括：
