...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var form={
        ...
        beforeInit:function (action,data) {
            ...
            $("#totalCost").attr("disabled","disabled").css("background-color","#e6e6e6");
        },
        ...
        maintainSelectList:function (ifr,win,data) {
            ...
            //设置地址
            win.location="/business/eam/maintain_task_project/maintain_task_project_exec_list.html"+queryString
