    ...
    function (exports) {
        function getColumnList(templet) {
            var COL_ALL_DATA={
                ...
                ,equipment_status:{ field: 'equipmentStatus', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('启停状态'), templet:function (d){ return templet('equipmentStatus',fox.getEnumText(RADIO_EQUIPMENTSTATUS_DATA,d.equipmentStatus,'','equipmentStatus'),d);}}
