		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'pointAbormalCount', align:"left",fixed:false,  hide:false, sort: false  , title: fox.translate('巡检点数(异常)') , templet: function (d) { return templet('pointAbormalCount',d.pointAbormalCount,d);}  }
