...
function ListPage() {
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'usageRange', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('使用场景') , templet: function (d) { return templet('usageRange',d.usageRange,d);}  }
					...
					,{ field: 'supplier', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('供应商') , templet: function (d) { return templet('supplier',d.supplier,d);}  }
	...
	function refreshTableData(sortField,sortType,reset) {
		...
		value.usageRange={ inputType:"button",value: $("#usageRange").val() ,fuzzy: true,splitValue:false,valuePrefix:"",valueSuffix:"" };
