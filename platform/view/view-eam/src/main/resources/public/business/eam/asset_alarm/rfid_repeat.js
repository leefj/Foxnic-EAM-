    ...
    function renderTable() {
        ...
        function renderTableInternal() {
            ...
            var tableConfig={
                ...
                url: moduleURL +'/query-asset-rfid-repeat',
                height: 'full-'+(h+28),
                limit: 50,
                page:false,
                where: ps,
                cols: [[
                    ...
                    ,{ field: 'rfid', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('RFID标签') , templet: function (d) { return templet('serialNumber',d.serialNumber,d);}  }
