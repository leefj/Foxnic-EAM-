...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
	...
	//列表页的扩展
	var list={
		stockFunc:function (ifr,win,data) {
			ifr.height("450px");
			var queryString="?source=asset&assetId="+ASSET_ID+"&ownerCode=stock&ownerType=stock&t="+timestamp;
			win.location='/business/eam/goods_stock_goods/asset_part_goods_list.html' + queryString;
		},
		goodsFunc:function (ifr,win,data) {
			ifr.height("450px");
			var queryString="?source=asset&assetId="+ASSET_ID+"&ownerCode=part&ownerType=part&t="+timestamp;
			win.location='/business/eam/goods_stock_goods/asset_part_goods_list.html' + queryString;
		},
		asssetFunc:function (ifr,win,data) {
			ifr.height("450px");
			var queryString="?source=asset&assetId="+ASSET_ID+"&ownerCode=part&ownerType=part&t="+timestamp;
			win.location='/business/eam/goods_stock_goods/asset_part_goods_list.html' + queryString;
		},
