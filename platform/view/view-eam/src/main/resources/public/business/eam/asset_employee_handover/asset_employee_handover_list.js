...
function ListPage() {
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'receiveOrgId', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('交接部门') , templet: function (d) { return templet('receiveOrgId',fox.getProperty(d,["receiveOrganization","fullName"],0,'','receiveOrgId'),d);} }
					,{ field: 'receiveUserId', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('交接人') , templet: function (d) { return templet('receiveUserId',fox.getProperty(d,["receiverUser","name"],0,'','receiveUserId'),d);} }
	...
	function bindButtonEvent() {
        ...
        function batchDelete(selected) {
            ...
            if(ids.length==0) {
				top.layer.msg(fox.translate('请选择需要删除的'+'资产交接'+"!"));
            	return;
            }
            //调用批量删除接口
			top.layer.confirm(fox.translate('确定删除已选中的'+'资产交接'+'吗？'), function (i) {
                top.layer.close(i);
