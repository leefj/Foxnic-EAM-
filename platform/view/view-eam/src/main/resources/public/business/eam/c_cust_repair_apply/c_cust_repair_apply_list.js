		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'type', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('报修类型'), templet: function (d) { return templet('type' ,fox.joinLabel(d.repairType,"name",',','','type'),d);}}
