	...
	function renderTable() {
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				url: '/service-eam/eam-asset/query-asset-sub-goods-stock-paged-list',
				height: 'full-'+(h+28),
				limit: 50,
				where: ps,
				cols: [[
					...
					,{ field: 'stockCurNumber', align:"left",fixed:false,  hide:false, sort: true, title: fox.translate('数量') , templet: function (d) { return templet('stockCurNumber',d.stockCurNumber,d);}  }
