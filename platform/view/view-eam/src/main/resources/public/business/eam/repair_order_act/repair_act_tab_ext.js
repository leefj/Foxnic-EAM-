...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        orderDispatched:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=dispatched"
        },
        orderWaitRepair:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=wait_repair"
        },
        orderRepairing:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=repairing"
        },
        orderWaitAcceptance:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=wait_acceptance"
        },
        orderFinish:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=finish"
        },
