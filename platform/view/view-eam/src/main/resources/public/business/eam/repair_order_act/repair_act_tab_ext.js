...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        orderDispatched:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=dispatched&t="+timestamp
        },
        orderWaitRepair:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=wait_repair&t="+timestamp
        },
        orderRepairing:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=repairing&t="+timestamp
        },
        orderWaitAcceptance:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=wait_acceptance&t="+timestamp
        },
        orderAcceptanceFailed:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=acceptance_failed&t="+timestamp
        },
        orderFinish:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=finish&t="+timestamp
        },
        orderCancel:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=cancel&t="+timestamp
        },
        orderAll:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/eam/repair_order_act/repair_order_act_list.html?repairStatus=all&t="+timestamp
        },
        /**
         * 列表页初始化前调用
         * */
