...
function ListPage() {
	...
	const queryURL=moduleURL+'/query-paged-list-by-selected';
	const deleteURL=moduleURL+'/delete';
	const batchDeleteURL=moduleURL+'/select-delete-by-ids';
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'projectBaseCost', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('标准工时(小时)') , templet: function (d) { return templet('projectBaseCost',d.projectBaseCost,d);}  }
	...
	function bindButtonEvent() {
		...
		function batchDelete(selected) {
			...
			top.layer.confirm(fox.translate('确定删除已选中的'+'保养项目'+'吗？'), function (i) {
				top.layer.close(i);
				admin.post(batchDeleteURL,  ps, function (data) {
					if (data.success) {
	...
	function showEditForm(data) {
		...
		admin.popupCenter({
			...
			content: '/business/eam/maintain_task_project/maintain_task_project_exec_form.html' + (queryString?("?"+queryString):""),
			finish: function () {
				refreshTableData();
			}
		});
