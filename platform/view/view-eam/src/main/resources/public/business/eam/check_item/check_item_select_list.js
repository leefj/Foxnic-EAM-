...
function ListPage() {
	...
	function bindButtonEvent() {
		...
		table.on('toolbar(data-table)', function(obj){
			...
			switch(obj.event){
				case 'create':
					...
					var data={};
					top.layer.confirm(fox.translate('确定选择已选中的'+'检查项'+'吗？'), function (i) {
						top.layer.close(i);
						admin.post(moduleURL+"/select-save-ids", { ownerId:OWNER_ID,selectCode:SELECT_CODE,ids: selected }, function (data) {
							if (data.success) {
								admin.finishPopupCenterById('eam-check-item-select-list-win');
							}else{
								fox.showMessage(data);
							}
		...
		function openCreateFrom() {
			...
			top.layer.confirm(fox.translate('确定选择已选中的'+'检查项'+'吗？'), function (i) {
				top.layer.close(i);
				admin.post("", { ids: ids }, function (data) {
					if (data.success) {
