...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var form={
        ...
        beforeInit:function (action,data) {
            ...
            $("#taskAbnormalInfo").attr("disabled","disabled").css("background-color","#e6e6e6");
            $("#taskId").attr("disabled","disabled").css("background-color","#e6e6e6");
        ...
        afterDataFill:function (data) {
            ...
            setTimeout(function(){
                var taskSel=xmSelect.get('#taskId', true);
                $("#taskId").attr("disabled","disabled").css("background-color","#e6e6e6");
                if(taskSel){
                    taskSel.update({disabled: true})
                }
            },100)
