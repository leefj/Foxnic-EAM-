...
function ListPage() {
        ...
        function renderTableInternal() {
          ...
          //      ,{ field: 'goodsStockMin', align:"",fixed:false,  hide:false, sort: false  , title: fox.translate('库存下限'), templet: function (d) { return templet('goodsStockMin' ,fox.joinLabel(d.goods,"stockMin"),d);}}
            ...
            var GOODS_DEF_COLS=[
                ...
                ,{ field: 'goodsStatus', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('物品状态'), templet:function (d){ return templet('goodsStatus',fox.getEnumText(SELECT_GOODSSTATUS_DATA,d.goodsStatus),d);}}
    ...
    function saveSelectData(callback){
        ...
        if(OPER_TYPE=="eam_asset_stock_goods_purchase_select"){
            if(postData.ids.length>=2){
                top.layer.msg("只能选择一个物品档案", {icon: 2, time: 1500});
                return;
            }
