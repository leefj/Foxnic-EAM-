...
function ListPage() {
	...
	const queryURL=moduleURL+'/query-none-point-paged-list';
		...
		function renderTableInternal() {
			...
			if(templet==null) {
				templet=function(field,value,row) {
					if(field=="custTaskCode"){
						if(row.task&&row.task.taskCode){
							return row.task.taskCode
						}else{
							return "null";
						}
					}
					if(field=="custTaskName"){
						if(row.task&&row.task.planName){
							return row.task.planName
						}else{
							return "null";
						}
					}
					if(field=="custTaskCreateTime"){
						if(row.task&&row.task.createTime){
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'custTaskCode', align:"left",fixed:false,  hide:false, sort: false  , title: fox.translate('任务编号') , templet: function (d) { return templet('custTaskCode',d.task,d);}  }
					,{ field: 'custTaskName', align:"left",fixed:false,  hide:false, sort: false  , title: fox.translate('任务名称') , templet: function (d) { return templet('custTaskName',d.task,d);}  }
					,{ field: 'custTaskCreateTime', align:"left",fixed:false,  hide:false, sort: false  , title: fox.translate('任务创建时间') , templet: function (d) { return templet('custTaskCreateTime',d.task,d);}  }

					,{ field: 'id', align:"left",fixed:false,  hide:true, sort: true  , title: fox.translate('主键') , templet: function (d) { return templet('id',d.id,d);}  }
					,{ field: 'pointStatus', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('巡检点状态'), templet:function (d){ return templet('pointStatus',fox.getEnumText(RADIO_POINTSTATUS_DATA,d.pointStatus,'','pointStatus'),d);}}
					...
					,{ field: 'operTime', align:"right", fixed:false, hide:false, sort: true   ,title: fox.translate('巡检时间') ,templet: function (d) { return templet('operTime',fox.dateFormat(d.operTime,"yyyy-MM-dd HH:mm:ss"),d); }  }
