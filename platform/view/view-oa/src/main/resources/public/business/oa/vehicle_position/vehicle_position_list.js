...
function ListPage() {
	...
	//模块基础路径
	const moduleURL="/service-oa/oa-vehicle-position";
	...
	function showEditForm(data) {
		...
		admin.popupCenter({
			...
			content: '/business/oa/vehicle_position/vehicle_position_form.html' + (queryString?("?"+queryString):""),
			finish: function () {
				if(action=="create") {
					refreshTableData();
				}
