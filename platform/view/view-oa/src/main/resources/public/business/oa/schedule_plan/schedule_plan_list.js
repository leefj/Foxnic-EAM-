...
function ListPage() {
		...
		function renderTableInternal() {
			...
			var tableConfig={
				...
				cols: [[
					...
					,{ field: 'rank', align:"left",fixed:false,  hide:false, sort: true  , title: fox.translate('优先级'), templet:function (d){ return templet('rank',fox.getEnumText(RADIO_RANK_DATA,d.rank,'','rank'),d);}}
	...
	function refreshTableData(sortField,sortType,reset) {
		...
		var value = {};
		value.rank={ inputType:"radio_box", value: getSelectedValue("#rank","value"), label:getSelectedValue("#rank","nameStr") };
