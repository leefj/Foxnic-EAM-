...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    //列表页的扩展
    var list={
        myCustomer:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/oa/crm_customer/crm_customer_list.html?tabStatus=myCustomer&t="+timestamp
        },
        mySubordinates:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/oa/crm_customer/crm_customer_list.html?tabStatus=mySubordinates&t="+timestamp
        },
        shareToMe:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/oa/crm_customer/crm_customer_list.html?tabStatus=shareToMe&t="+timestamp
        },
        myCare:function (ifr,win,data) {
            ifr.height("720px");
            win.location="/business/oa/crm_customer/crm_customer_list.html?tabStatus=myCare&t="+timestamp
        },
