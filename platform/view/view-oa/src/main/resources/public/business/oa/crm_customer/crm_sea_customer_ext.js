...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        toInvalid:function(data,it){
            var api=moduleURL+"/to-invalid";
            var btnClass="invalid-button";
        ...
        allocate:function(selected,obj){
            ...
            admin.putTempData('oa-crm-customer-leader-form-data-form-action', "create",true);
            var queryString="";
            queryString="?customerIds="+JSON.stringify(selected);
            admin.putTempData('oa-crm-customer-leader-form-data', {});
            var area=admin.getTempData('oa-crm-customer-leader-form-area');
            var height= (area && area.height) ? area.height : ($(window).height()*0.6);
            var top= (area && area.top) ? area.top : (($(window).height()-height)/2);
            ...
            title=fox.translate('添加','','cmp:table')+title;
            admin.putTempData('oa-crm-customer-leader-form-customer-ids', JSON.stringify(selected),true);
            admin.popupCenter({
                title: title,
                resize: false,
                offset: [top,null],
