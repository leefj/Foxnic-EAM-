        ...
        templet:function (field,value,r) {
            ...
            if(field=="fdId"){
                if(r.fdType=="folder"){
                    var v="";
                    if(r.netdiskFolder){
                        v=r.netdiskFolder.name;
                    }
                    return "<image style='margin-right:5px;width:35px;height: 35px' src='/assets/netdiskimg/folder.png'></image>"+v
                    ...
                    if(r.netdiskOriginFile&&r.netdiskOriginFile.fileType){
                        if(r.netdiskOriginFile.fileType=="file_doc"){
                            html="<image style='margin-right:5px;width:25px;height:25px' src='/assets/netdiskimg/document3.png'></image>"+r.netdiskOriginFile.fileName
                            ...
                            html="<image style='margin-right:5px;width:25px;height: 25px' src='/assets/netdiskimg/zip.png'></image>"+r.netdiskOriginFile.fileName
                        }else {
                            html="<image style='margin-right:5px;width:25px;height: 25px' src='/assets/netdiskimg/document3.png'></image>"+r.netdiskOriginFile.fileName
                        }
                    }
