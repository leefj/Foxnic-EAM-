    ...
    var list={
        ...
        moreAction:function (menu,data, it){
            ...
            if(menu.id=="del"){
                ...
                var fdData=[];
                var fdObj={fdId:data.id,fdType:"file"};
                fdData.push(fdObj);
                $("#userId").val("");
