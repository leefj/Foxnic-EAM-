...
function ListPage() {
		...
		table.on('toolbar(data-table)', function(obj){
			...
			switch(obj.event){
				...
				case 'batch-del':
					...
					break;
				case 'tool-lock-customer':
					window.pageExt.list.lockCustomer && window.pageExt.list.lockCustomer(selected,obj);
					break;
				case 'tool-transfer':
					window.pageExt.list.transfer && window.pageExt.list.transfer(selected,obj);
					break;
				case 'tool-allocate':
					window.pageExt.list.allocate && window.pageExt.list.allocate(selected,obj);
					break;
				case 'tool-share-customer':
					window.pageExt.list.shareCustomer && window.pageExt.list.shareCustomer(selected,obj);
					break;
				case 'tool-to-open-sea':
					window.pageExt.list.toOpenSea && window.pageExt.list.toOpenSea(selected,obj);
					break;
				case 'tool-to-invalid':
					window.pageExt.list.toInvalid && window.pageExt.list.toInvalid(selected,obj);
					break;
				case 'refresh-data':
					refreshTableData();
					break;
	...
	function bindRowOperationEvent() {
		...
		table.on('tool(data-table)', function (obj) {
			...
			else if (layEvent === 'shareuser') { // 成交
				window.pageExt.list.shareuser(data,this);
			}
			else if (layEvent === 'invalid') { // 成交
				window.pageExt.list.toInvalid(data,this);
			}
