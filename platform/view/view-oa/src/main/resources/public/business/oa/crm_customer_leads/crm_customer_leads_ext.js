...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var formAction=admin.getTempData('oa-crm-customer-leads-form-data-form-action');
    //列表页的扩展
    var list={
        /**
         * 列表页初始化前调用
        ...
        toCustomer:function (ps,obj) {
            console.log('toCustomer',ps,obj);
            var btnClass="to-customer-button"
            var successMessage="操作成功"
            var btn=$('.'+btnClass).filter("[data-id='" +ps.id + "']");
            var api=moduleURL+"/convert-to-customer";
