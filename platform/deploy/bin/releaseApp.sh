...
##deploy tomcat
if [ -f "/opt/tomcat/tomcat_shopprod/webapps/upload/app_release_last.tar.gz" ];then
  rm -rf /opt/tomcat/tomcat_shopprod/webapps/upload/app_release_last.tar.gz
  cp /tmp/app_release_last.tar.gz /opt/tomcat/tomcat_shopprod/webapps/upload
fi
