...
java -noverify -Dfile.encoding=UTF-8 -Djava.io.tmpdir=/app/app/bpm/tmp -Dloader.path=/app/app/bpm/lib -jar /app/app/bpm/bpm.jar --spring.config.location=/app/app/bpm/application.yml
EOF
