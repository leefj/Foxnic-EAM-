...
public class EncryptUtil {
    ...
    public static void main(String[] args) {
        ...
        String user="root";
        String pwd="123456";
        String url="jdbc:mysql://db.dev.xyjm.store:3308/foxnic?autoReconnectForPools=true&socketTimeout=1800000&connectTimeout=30000&useSSL=false&serverTimezone=Hongkong&useUnicode=true&characterEncoding=utf-8&autoReconnect=true&allowPublicKeyRetrieval=true&tinyInt1isBit=false";
