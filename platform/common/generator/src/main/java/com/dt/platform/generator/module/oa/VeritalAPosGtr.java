...
public class VeritalAPosGtr extends BaseCodeGenerator {
    ...
    public VeritalAPosGtr() {
        super(OaTables.OA_VEHICLE_POSITION.$TABLE,BASIC_MGR_MENU_ID);
    }
    ...
    public void generateCode() throws Exception {
        ...
        //cfg.setRelationField(Apply.class,VehicleTables.OA_VEHICLE_POSITION.HANDLE_ID, Info.class, VehicleTables.VEHICLE_A_SELECT_ITEM.ASSET_ID,true);
