...
import com.dt.platform.oa.page.DownloadLogPageController;
import com.dt.platform.proxy.oa.DownloadLogServiceProxy;
import com.github.foxnic.generator.config.WriteMode;

public class DowmFileLogGtr extends BaseCodeGenerator {


    public DowmFileLogGtr() {
    ...
    public static void main(String[] args) throws Exception {
        DowmFileLogGtr g=new DowmFileLogGtr();
        //生成代码
        g.generateCode();
