...
public class AssetDepreciationCalRuleGtr extends BaseCodeGenerator{
    ...
    public void generateCode() throws Exception {
        ...
        cfg.view().field(EAMTables.EAM_ASSET_DEPRECIATION_CAL_RULE.UPDATE_BY).table().disable(true);
        ...
        cfg.view().list().addJsVariable("DEPRECIATION_ID","[[${depreciationId}]]","depreciationId");
