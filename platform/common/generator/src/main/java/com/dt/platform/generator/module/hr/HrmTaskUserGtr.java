...
public class HrmTaskUserGtr extends BaseCodeGenerator {
    public HrmTaskUserGtr() {
        super(HrTables.HR_SCORE_TASK_USER.$TABLE,"803970322595315713");
    }
    ...
    public static void main(String[] args) throws Exception {
        HrmTaskUserGtr g=new HrmTaskUserGtr();
        //生成代码
        g.generateCode();
