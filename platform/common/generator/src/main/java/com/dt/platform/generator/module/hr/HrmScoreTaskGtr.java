...
import com.dt.platform.hr.page.ScoreTaskPageController;
...
public class HrmScoreTaskGtr extends BaseCodeGenerator {
    public HrmScoreTaskGtr() {
        super(HrTables.HR_SCORE_TASK.$TABLE,"803970322595315713");
    }
    ...
    public static void main(String[] args) throws Exception {
        HrmScoreTaskGtr g=new HrmScoreTaskGtr();
        //生成代码
        g.generateCode();
