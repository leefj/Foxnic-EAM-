...
import com.dt.platform.oa.page.NetdiskMyFavoritePageController;
import com.dt.platform.oa.page.NetdiskMySharePageController;
...
public class NetDiskMyFavGtr extends BaseCodeGenerator {


    public NetDiskMyFavGtr() {
        super(OaTables.OA_NETDISK_MY_FAVORITE.$TABLE,"755784921531809792");
    }

    public void generateCode() throws Exception {
        System.out.println(this.getClass().getName());
        cfg.view().field(OaTables.OA_NETDISK_MY_FAVORITE.ID).basic().hidden(true);
        ...
        cfg.view().field(OaTables.OA_NETDISK_MY_FAVORITE.USER_ID).table().fillBy("ownerUser","name");
        cfg.view().field(OaTables.OA_NETDISK_MY_FAVORITE.USER_ID).form().button().chooseEmployee(true);
        ...
        cfg.view().field(OaTables.OA_NETDISK_MY_FAVORITE.USER_ID).table().disable(true);
        cfg.view().form().addGroup(null,
                new Object[] {
                        OaTables.OA_NETDISK_MY_FAVORITE.USER_ID,
                    //    OaTables.OA_NETDISK_MY_FAVORITE.FILE_ID,
                }
        );
    ...
    public static void main(String[] args) throws Exception {
        NetDiskMyFavGtr g=new NetDiskMyFavGtr();
        //生成代码
        g.generateCode();
...
//        g.removeByBatchId("471622036347682816");
        //生成菜单
  //     g.generateMenu(NetdiskMyFavoriteServiceProxy.class, NetdiskMyFavoritePageController.class);
    }
