...
public class PerformRcdGtr extends BaseCodeGenerator {
    public PerformRcdGtr() {
        super(HrTables.HR_PERFORMANCE_RCD.$TABLE,"803970075315929088");
    }
    ...
    public static void main(String[] args) throws Exception {
        PerformRcdGtr g=new PerformRcdGtr();
        //生成代码
        g.generateCode();
