...
public class VehicleSelectItemAGtr extends BaseCodeGenerator {
    ...
    public VehicleSelectItemAGtr() {
        super(OaTables.OA_VEHICLE_A_SELECT_ITEM.$TABLE,"616256885288337408");
    }
    ...
    public void generateCode() throws Exception {
        ...
        cfg.view().search().inputLayout(
                new Object[]{
                        OaTables.OA_VEHICLE_A_SELECT_ITEM.ID,
                }
        );
        ...
        cfg.setRelationField(VehicleApply.class,OaTables.OA_VEHICLE_A_SELECT_ITEM.HANDLE_ID, VehicleInfo.class, OaTables.OA_VEHICLE_A_SELECT_ITEM.ASSET_ID,true);
