...
public class EAMTables {
	...
	*/
	public static class EAM_ASSET extends DBTable {
		...
		*/
		 ...
		 * 清理类型
		*/
		public static final DBField CLEAN_OUT_TYPE = new DBField(DBDataType.STRING , "clean_out_type","cleanOutType","清理类型","清理类型",false,false,true);
		...
		*/
		 ...
		 * 清理时间
		*/
		public static final DBField CLEAN_TIME = new DBField(DBDataType.DATE , "clean_time","cleanTime","清理时间","清理时间",false,false,true);
		...
		*/
		 ...
		 * 启停状态
		*/
		public static final DBField EQUIPMENT_STATUS = new DBField(DBDataType.STRING , "equipment_status","equipmentStatus","启停状态","启停状态",false,false,true);
		...
		*/
		 ...
		 * 巡检时间
		*/
		public static final DBField LAST_INSPECT_TIME = new DBField(DBDataType.DATE , "last_inspect_time","lastInspectTime","巡检时间","巡检时间",false,false,true);
		
		/**
		 * 经度数据
		*/
		public static final DBField LONGITUDE = new DBField(DBDataType.DECIMAL , "longitude","longitude","经度数据","经度数据",false,false,true);
		
		/**
		 * 维度数据
		*/
		public static final DBField DIMENSION = new DBField(DBDataType.DECIMAL , "dimension","dimension","维度数据","维度数据",false,false,true);
		...
		*/
		 ...
		 * 处置ID
		*/
		public static final DBField HANDLE_ID = new DBField(DBDataType.STRING , "handle_id","handleId","处置ID","处置ID",false,false,true);
	...
	*/
	public static class EAM_ASSET_DATA_PERMISSIONS extends DBTable {
		...
		*/
		 ...
		 * 仓库
		*/
		public static final DBField WAREHOUSE_AUTHORITY_ENABLE = new DBField(DBDataType.STRING , "warehouse_authority_enable","warehouseAuthorityEnable","仓库","仓库",false,false,true);
	...
	*/
	 ...
	 * 仓库
	*/
	public static class EAM_ASSET_DATA_PERMISSIONS_WH extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_data_permissions_wh";
		...
		*/
		...
		public EAM_ASSET_DATA_PERMISSIONS_WH() {
			this.init($NAME,"仓库" , ID , PERMISSION_ID , VALUE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME);
		}
		public static final EAM_ASSET_DATA_PERMISSIONS_WH $TABLE=new EAM_ASSET_DATA_PERMISSIONS_WH();
	}
	...
	*/
	 ...
	 * 资产发现
	*/
	public static class EAM_ASSET_DISCOVERY extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_discovery";
		...
		*/
		 ...
		 * 发现方式
		*/
		public static final DBField DISCOVERY_METHOD = new DBField(DBDataType.STRING , "discovery_method","discoveryMethod","发现方式","发现方式",false,false,true);
		...
		*/
		...
		public EAM_ASSET_DISCOVERY() {
			this.init($NAME,"资产发现" , ID , CATEGORY_ID , DISCOVERY_METHOD , RFID , BATCH_CODE , OWNER_CODE , ASSET_CODE , ASSET_STATUS , GOODS_ID , SERIAL_NUMBER , OWN_COMPANY_ID , MANAGER_ID , USE_ORGANIZATION_ID , USE_USER_ID , REGION_ID , POSITION_ID , POSITION_DETAIL , WAREHOUSE_ID , SOURCE_ID , ASSET_NUMBER , ATTACH , PICTURE_ID , NOTES , ASSET_NOTES , MAINTAINER_ID , MAINTAINER_NAME , MAINTENANCE_STATUS , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_ASSET_DISCOVERY $TABLE=new EAM_ASSET_DISCOVERY();
	}
	...
	*/
	public static class EAM_ASSET_HANDLE extends DBTable {
		...
		*/
		 ...
		 * 处理日期
		*/
		public static final DBField PLAN_FINISH_DATE = new DBField(DBDataType.DATE , "plan_finish_date","planFinishDate","处理日期","处理日期",false,false,true);
		...
		*/
		...
		public EAM_ASSET_HANDLE() {
			this.init($NAME,"资产处置" , ID , PROC_ID , BUSINESS_CODE , NAME , STATUS , TYPE , CONTENT , PLAN_FINISH_DATE , ORIGINATOR_ID , FILE_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , SELECTED_CODE , CHS_TYPE , CHS_STATUS , CHS_VERSION , CHANGE_INSTANCE_ID , SUMMARY , LATEST_APPROVER_ID , LATEST_APPROVER_NAME , NEXT_APPROVER_IDS , NEXT_APPROVER_NAMES , APPROVAL_OPINION);
		}
	 ...
	 * 处置类型
	*/
	public static class EAM_ASSET_HANDLE_TYPE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_handle_type";
		...
		*/
		 ...
		 * 名称
		*/
		public static final DBField LABEL = new DBField(DBDataType.STRING , "label","label","名称","名称",false,false,true);
		...
		*/
		 ...
		 * 资产状态
		*/
		public static final DBField HANDLE_STATUS = new DBField(DBDataType.STRING , "handle_status","handleStatus","资产状态","资产状态",false,false,true);
		...
		*/
		...
		public EAM_ASSET_HANDLE_TYPE() {
			this.init($NAME,"处置类型" , ID , CODE , LABEL , STATUS , HANDLE_STATUS , CLEAN_STATUS , ACTION_METHOD , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_HANDLE_TYPE $TABLE=new EAM_ASSET_HANDLE_TYPE();
	}
	...
	*/
	...
	/**
	*/
	public static class EAM_ASSET_LABEL_LAYOUT_DEF extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_label_layout_def";
		...
		*/
		...
		public EAM_ASSET_LABEL_LAYOUT_DEF() {
			this.init($NAME,"" , ID , TPL_ID , COL_ID , COL_CODE , TYPE , ROW_NUMBER , ROW_HEIGHT , ROW_SPAN , COL_SPAN , SORT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_ASSET_LABEL_LAYOUT_DEF $TABLE=new EAM_ASSET_LABEL_LAYOUT_DEF();
	}
	...
	*/
	public static class EAM_ASSET_LABEL_TPL extends DBTable {
		...
		*/
		 ...
		 * 类型,默认为1，2为专用标签
		*/
		public static final DBField TYPE = new DBField(DBDataType.STRING , "type","type","类型","默认为1，2为专用标签",false,false,true);
	...
	*/
	 ...
	 * 位置变化
	*/
	public static class EAM_ASSET_POS_CHANGE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_pos_change";
		...
		*/
		...
		public EAM_ASSET_POS_CHANGE() {
			this.init($NAME,"位置变化" , ID , ASSET_ID , LONGITUDE , DIMENSION , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_ASSET_POS_CHANGE $TABLE=new EAM_ASSET_POS_CHANGE();
	}
	...
	*/
	public static class EAM_ASSET_PROCESS_RECORD extends DBTable {
		...
		*/
		 ...
		 * 资产名称
		*/
		public static final DBField ASSET_ID = new DBField(DBDataType.STRING , "asset_id","assetId","资产名称","资产名称",false,false,true);
	...
	*/
	 ...
	 * 运行情况
	*/
	public static class EAM_ASSET_RUNNING_SITUATION extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_running_situation";
		...
		*/
		 ...
		 * 设备
		*/
		public static final DBField STATUS = new DBField(DBDataType.STRING , "status","status","设备","设备",false,false,true);
		...
		*/
		 ...
		 * 记录来源
		*/
		public static final DBField SOURCE = new DBField(DBDataType.STRING , "source","source","记录来源","记录来源",false,false,true);
		...
		*/
		...
		public EAM_ASSET_RUNNING_SITUATION() {
			this.init($NAME,"运行情况" , ID , ASSET_ID , STATUS , REC_TIME , SOURCE , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_ASSET_RUNNING_SITUATION $TABLE=new EAM_ASSET_RUNNING_SITUATION();
	}
	
	/**
	 * 扫码配置
	*/
	public static class EAM_ASSET_SCAN_SCENE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_asset_scan_scene";
		...
		*/
		 ...
		 * 场景编码
		*/
		public static final DBField CODE = new DBField(DBDataType.STRING , "code","code","场景编码","场景编码",false,false,true);
		
		/**
		 * 场景名称
		*/
		public static final DBField NAME = new DBField(DBDataType.STRING , "name","name","场景名称","场景名称",false,false,true);
		...
		*/
		...
		public EAM_ASSET_SCAN_SCENE() {
			this.init($NAME,"扫码配置" , ID , CODE , NAME , METHOD , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_ASSET_SCAN_SCENE $TABLE=new EAM_ASSET_SCAN_SCENE();
	}
	...
	*/
	public static class EAM_ASSET_STOCK_GOODS_USE extends DBTable {
		 ...
		 * 表名
		*/
		public static final String $NAME = "eam_asset_stock_goods_use";
	...
	public static class EAM_BRAND_DEMO extends DBTable {
		...
		*/
		...
		public EAM_BRAND_DEMO() {
			this.init($NAME,"品牌" , ID , SORT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	*/
	public static class EAM_C_CUST_REPAIR_APPLY extends DBTable {
		...
		*/
		...
		public EAM_C_CUST_REPAIR_APPLY() {
			this.init($NAME,"报修申请" , ID , BUSINESS_CODE , STATUS , TYPE , NAME , PLAN_FINISH_DATE , POS , REPORT_USER_NAME , REPORT_USER_ID , CONTACT , CONTENT , PICTURE_ID , PROCESS_USER_ID , START_DATE , FINISH_DATE , RESULT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	 ...
	 * 报修类型
	*/
	public static class EAM_C_CUST_REPAIR_TYPE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_c_cust_repair_type";
		...
		*/
		...
		public EAM_C_CUST_REPAIR_TYPE() {
			this.init($NAME,"报修类型" , ID , NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_C_CUST_REPAIR_TYPE $TABLE=new EAM_C_CUST_REPAIR_TYPE();
	}
	...
	*/
	 ...
	 * 检查模版
	*/
	public static class EAM_CHECK_GROUP extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_check_group";
		...
		*/
		...
		public EAM_CHECK_GROUP() {
			this.init($NAME,"检查模版" , ID , NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_CHECK_GROUP $TABLE=new EAM_CHECK_GROUP();
	}
	
	/**
	 * 检查项内容
	*/
	public static class EAM_CHECK_GROUP_ITEM extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_check_group_item";
		...
		*/
		 ...
		 * 组
		*/
		public static final DBField GROUP_ID = new DBField(DBDataType.STRING , "group_id","groupId","组","组",false,false,true);
		
		/**
		 * 检查项
		*/
		public static final DBField ITEM_ID = new DBField(DBDataType.STRING , "item_id","itemId","检查项","检查项",false,false,true);
		...
		*/
		...
		public EAM_CHECK_GROUP_ITEM() {
			this.init($NAME,"检查项内容" , ID , GROUP_ID , ITEM_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_CHECK_GROUP_ITEM $TABLE=new EAM_CHECK_GROUP_ITEM();
	}
	
	/**
	 * 检查项
	*/
	public static class EAM_CHECK_ITEM extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_check_item";
		...
		*/
		 ...
		 * 描述
		*/
		public static final DBField CHECK_DESC = new DBField(DBDataType.STRING , "check_desc","checkDesc","描述","描述",false,false,true);
		
		/**
		 * 组件类型
		*/
		public static final DBField TYPE = new DBField(DBDataType.STRING , "type","type","组件类型","组件类型",false,false,true);
		
		/**
		 * 配置项
		*/
		public static final DBField CONFIG = new DBField(DBDataType.STRING , "config","config","配置项","配置项",false,false,true);
		
		/**
		 * 默认内容
		*/
		public static final DBField DEF_VALUE = new DBField(DBDataType.STRING , "def_value","defValue","默认内容","默认内容",false,false,true);
		...
		*/
		...
		public EAM_CHECK_ITEM() {
			this.init($NAME,"检查项" , ID , OWNER , CODE , STATUS , NAME , CHECK_DESC , TYPE , CONFIG , DEF_VALUE , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_CHECK_ITEM $TABLE=new EAM_CHECK_ITEM();
	}
	
	/**
	 * 检查项选择
	*/
	public static class EAM_CHECK_SELECT extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_check_select";
		...
		*/
		 ...
		 * 巡检点位
		*/
		public static final DBField TASK_POINT_ID = new DBField(DBDataType.STRING , "task_point_id","taskPointId","巡检点位","巡检点位",false,false,true);
		
		/**
		 * 巡检点位
		*/
		public static final DBField POINT_ID = new DBField(DBDataType.STRING , "point_id","pointId","巡检点位","巡检点位",false,false,true);
		
		/**
		 * 是否检查
		*/
		public static final DBField IF_CHECK = new DBField(DBDataType.STRING , "if_check","ifCheck","是否检查","是否检查",false,false,true);
		...
		*/
		 ...
		 * 检查项编码
		*/
		public static final DBField ITEM_CODE = new DBField(DBDataType.STRING , "item_code","itemCode","检查项编码","检查项编码",false,false,true);
		
		/**
		 * 检查项
		*/
		public static final DBField ITEM_NAME = new DBField(DBDataType.STRING , "item_name","itemName","检查项","检查项",false,false,true);
		
		/**
		 * 检查项描述
		*/
		public static final DBField ITEM_DESC = new DBField(DBDataType.STRING , "item_desc","itemDesc","检查项描述","检查项描述",false,false,true);
		
		/**
		 * 检查结果
		*/
		public static final DBField RESULT = new DBField(DBDataType.STRING , "result","result","检查结果","检查结果",false,false,true);
		
		/**
		 * 内容元数据
		*/
		public static final DBField RESULT_META_DATA = new DBField(DBDataType.STRING , "result_meta_data","resultMetaData","内容元数据","内容元数据",false,false,true);
		...
		*/
		 ...
		 * 默认值
		*/
		public static final DBField CONFIG_DEF_VALUE = new DBField(DBDataType.STRING , "config_def_value","configDefValue","默认值","默认值",false,false,true);
		...
		*/
		...
		public EAM_CHECK_SELECT() {
			this.init($NAME,"检查项选择" , ID , TASK_ID , TASK_POINT_ID , POINT_ID , IF_CHECK , TYPE , ITEM_ID , ITEM_CODE , ITEM_NAME , ITEM_DESC , RESULT , RESULT_META_DATA , CONFIG , CONFIG_DEF_VALUE , SORT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_CHECK_SELECT $TABLE=new EAM_CHECK_SELECT();
	}
	...
	*/
	 ...
	 * demo
	*/
	public static class EAM_DEMO_C2 extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_demo_c2";
		...
		*/
		...
		public EAM_DEMO_C2() {
			this.init($NAME,"demo" , ID , TITLE , PRICE , VALID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_DEMO_C2 $TABLE=new EAM_DEMO_C2();
	}
	
	/**
	 * 备件关联
	*/
	public static class EAM_DEVICE_ASSOCIATE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_device_associate";
		...
		*/
		 ...
		 * 名称
		*/
		public static final DBField ASSOCIATE_NAME = new DBField(DBDataType.STRING , "associate_name","associateName","名称","名称",false,false,true);
		...
		*/
		...
		public EAM_DEVICE_ASSOCIATE() {
			this.init($NAME,"备件关联" , ID , ASSOCIATE_NAME , PARENT_ID , SORT , HIERARCHY , HIERARCHY_NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_DEVICE_ASSOCIATE $TABLE=new EAM_DEVICE_ASSOCIATE();
	}
	
	/**
	 * 备件关联
	*/
	public static class EAM_DEVICE_ASSOCIATE_ITEM extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_device_associate_item";
		...
		*/
		 ...
		 * 关联
		*/
		public static final DBField ASSOCIATE_ID = new DBField(DBDataType.STRING , "associate_id","associateId","关联","关联",false,false,true);
		
		/**
		 * 设备备件
		*/
		public static final DBField OWNER_ID = new DBField(DBDataType.STRING , "owner_id","ownerId","设备备件","设备备件",false,false,true);
		...
		*/
		...
		public EAM_DEVICE_ASSOCIATE_ITEM() {
			this.init($NAME,"备件关联" , ID , ASSOCIATE_ID , OWNER_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_DEVICE_ASSOCIATE_ITEM $TABLE=new EAM_DEVICE_ASSOCIATE_ITEM();
	}
	
	/**
	 * 备件清单
	*/
	public static class EAM_DEVICE_SP extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_device_sp";
		...
		*/
		 ...
		 * 备件编号
		*/
		public static final DBField CODE = new DBField(DBDataType.STRING , "code","code","备件编号","备件编号",false,false,true);
		...
		*/
		 ...
		 * 备件类型
		*/
		public static final DBField TYPE = new DBField(DBDataType.STRING , "type","type","备件类型","备件类型",false,false,true);
		
		/**
		 * 备件状态
		*/
		public static final DBField STATUS = new DBField(DBDataType.STRING , "status","status","备件状态","备件状态",false,false,true);
		
		/**
		 * 备件名称
		*/
		public static final DBField NAME = new DBField(DBDataType.STRING , "name","name","备件名称","备件名称",false,false,true);
		
		/**
		 * 所在仓库
		*/
		public static final DBField WAREHOUSE_ID = new DBField(DBDataType.STRING , "warehouse_id","warehouseId","所在仓库","所在仓库",false,false,true);
		...
		*/
		 ...
		 * 备件序列
		*/
		public static final DBField SN = new DBField(DBDataType.STRING , "sn","sn","备件序列","备件序列",false,false,true);
		
		/**
		 * 使用场景
		*/
		public static final DBField USAGE_RANGE = new DBField(DBDataType.STRING , "usage_range","usageRange","使用场景","使用场景",false,false,true);
		...
		*/
		 ...
		 * 适配信息
		*/
		public static final DBField ADAPTING_DEVICE = new DBField(DBDataType.STRING , "adapting_device","adaptingDevice","适配信息","适配信息",false,false,true);
		
		/**
		 * 来源描述
		*/
		public static final DBField SOURCE_DESC = new DBField(DBDataType.STRING , "source_desc","sourceDesc","来源描述","来源描述",false,false,true);
		
		/**
		 * 供应厂商
		*/
		public static final DBField SUPPLIER = new DBField(DBDataType.STRING , "supplier","supplier","供应厂商","供应厂商",false,false,true);
		
		/**
		 * 保管人员
		*/
		public static final DBField MANAGER_USER_ID = new DBField(DBDataType.STRING , "manager_user_id","managerUserId","保管人员","保管人员",false,false,true);
		...
		*/
		 ...
		 * 数量
		*/
		public static final DBField SP_NUMBER = new DBField(DBDataType.INTEGER , "sp_number","spNumber","数量","数量",false,false,true);
		
		/**
		 * 入库时间
		*/
		public static final DBField INSERT_TIME = new DBField(DBDataType.DATE , "insert_time","insertTime","入库时间","入库时间",false,false,true);
		...
		*/
		 ...
		 * 是否锁定
		*/
		public static final DBField LOCKED = new DBField(DBDataType.STRING , "locked","locked","是否锁定","是否锁定",false,false,true);
		...
		*/
		...
		public EAM_DEVICE_SP() {
			this.init($NAME,"备件清单" , ID , CODE , GOOD_ID , TYPE , STATUS , NAME , WAREHOUSE_ID , MODEL , SN , USAGE_RANGE , LOC_ID , ADAPTING_DEVICE , SOURCE_DESC , SUPPLIER , MANAGER_USER_ID , PICTURE_ID , SP_NUMBER , INSERT_TIME , NOTES , LOCKED , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_DEVICE_SP $TABLE=new EAM_DEVICE_SP();
	}
	
	/**
	 * 备件设备关联
	*/
	public static class EAM_DEVICE_SP_ASSOCIATE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_device_sp_associate";
		...
		*/
		 ...
		 * 设备
		*/
		public static final DBField DEVICE_ID = new DBField(DBDataType.STRING , "device_id","deviceId","设备","设备",false,false,true);
		...
		*/
		...
		public EAM_DEVICE_SP_ASSOCIATE() {
			this.init($NAME,"备件设备关联" , ID , SP_ID , DEVICE_ID , SELECTED_CODE , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_DEVICE_SP_ASSOCIATE $TABLE=new EAM_DEVICE_SP_ASSOCIATE();
	}
	
	/**
	 * 备件记录
	*/
	public static class EAM_DEVICE_SP_RCD extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_device_sp_rcd";
		...
		*/
		 ...
		 * 编号
		*/
		public static final DBField SP_CODE = new DBField(DBDataType.STRING , "sp_code","spCode","编号","编号",false,false,true);
		
		/**
		 * 使用人
		*/
		public static final DBField OPER_ID = new DBField(DBDataType.STRING , "oper_id","operId","使用人","使用人",false,false,true);
		...
		*/
		...
		public EAM_DEVICE_SP_RCD() {
			this.init($NAME,"备件记录" , ID , SP_ID , SP_CODE , OPER_ID , OPER_TIME , CONTENT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_DEVICE_SP_RCD $TABLE=new EAM_DEVICE_SP_RCD();
	}
	
	/**
	 * 修改状态
	*/
	public static class EAM_DEVICE_SP_STATUS extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_device_sp_status";
		...
		*/
		...
		public EAM_DEVICE_SP_STATUS() {
			this.init($NAME,"修改状态" , ID , SP_ID , STATUS , CONTENT , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_DEVICE_SP_STATUS $TABLE=new EAM_DEVICE_SP_STATUS();
	}
	
	/**
	 * 备件分类
	*/
	public static class EAM_DEVICE_SP_TYPE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_device_sp_type";
		...
		*/
		...
		public EAM_DEVICE_SP_TYPE() {
			this.init($NAME,"备件分类" , ID , STATUS , CATEGORY_NAME , CATEGORY_FULLNAME , CATEGORY_CODE , SERVICE_LIFE , PARENT_ID , SORT , HIERARCHY , HIERARCHY_NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_DEVICE_SP_TYPE $TABLE=new EAM_DEVICE_SP_TYPE();
	}
	...
	*/
	public static class EAM_GOODS_STOCK extends DBTable {
		...
		*/
		 ...
		 * 档案分类
		*/
		public static final DBField CATEGORY_ID = new DBField(DBDataType.STRING , "category_id","categoryId","档案分类","档案分类",false,false,true);
		
		/**
		 * 资产分类
		*/
		public static final DBField ASSET_CATEGORY_ID = new DBField(DBDataType.STRING , "asset_category_id","assetCategoryId","资产分类","资产分类",false,false,true);
		...
		*/
		 ...
		 * 保养建议
		*/
		public static final DBField MAINTENANCE_RECOMMENDATION = new DBField(DBDataType.STRING , "maintenance_recommendation","maintenanceRecommendation","保养建议","保养建议",false,false,true);
		
		/**
		 * 巡检建议
		*/
		public static final DBField INSPECTION_RECOMMENDATION = new DBField(DBDataType.STRING , "Inspection_recommendation","inspectionRecommendation","巡检建议","巡检建议",false,false,true);
		...
		*/
		 ...
		 * 价值类型
		*/
		public static final DBField COST_TYPE = new DBField(DBDataType.STRING , "cost_type","costType","价值类型","价值类型",false,false,true);
		...
		*/
		 ...
		 * 序列
		*/
		public static final DBField SN = new DBField(DBDataType.STRING , "sn","sn","序列","序列",false,false,true);
		...
		*/
		 ...
		 * 操作类型
		*/
		public static final DBField INTER_OPER_TYPE = new DBField(DBDataType.STRING , "inter_oper_type","interOperType","操作类型","操作类型",false,false,true);
	 ...
	 * 父子关联
	*/
	public static class EAM_GOODS_STOCK_RELATED extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_goods_stock_related";
		...
		*/
		 ...
		 * 父物品
		*/
		public static final DBField PARENT_GOODS_ID = new DBField(DBDataType.STRING , "parent_goods_id","parentGoodsId","父物品","父物品",false,false,true);
		
		/**
		 * 选择
		*/
		public static final DBField SELECT_CODE = new DBField(DBDataType.STRING , "select_code","selectCode","选择","选择",false,false,true);
		...
		*/
		...
		public EAM_GOODS_STOCK_RELATED() {
			this.init($NAME,"父子关联" , ID , GOODS_ID , PARENT_GOODS_ID , SELECT_CODE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_GOODS_STOCK_RELATED $TABLE=new EAM_GOODS_STOCK_RELATED();
	}
	...
	*/
	 ...
	 * 巡检项
	*/
	public static class EAM_INSPECT_POINT_ITEM extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inspect_point_item";
		...
		*/
		...
		public EAM_INSPECT_POINT_ITEM() {
			this.init($NAME,"巡检项" , ID , POINT_ID , NAME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_INSPECT_POINT_ITEM $TABLE=new EAM_INSPECT_POINT_ITEM();
	}
	...
	*/
	public static class EAM_INSPECTION_PLAN extends DBTable {
		...
		*/
		 ...
		 * 计划单据
		*/
		public static final DBField PLAN_CODE = new DBField(DBDataType.STRING , "plan_code","planCode","计划单据","计划单据",false,false,true);
		...
		*/
		 ...
		 * 计划状态
		*/
		public static final DBField PLAN_STATUS = new DBField(DBDataType.STRING , "plan_status","planStatus","计划状态","计划状态",false,false,true);
		...
		*/
		 ...
		 * 计划周期
		*/
		public static final DBField ACTION_CYCLE_ID = new DBField(DBDataType.STRING , "action_cycle_id","actionCycleId","计划周期","计划周期",false,false,true);
		...
		*/
		 ...
		 * 上次执行
		*/
		public static final DBField LAST_TIME = new DBField(DBDataType.DATE , "last_time","lastTime","上次执行","上次执行",false,false,true);
		
		/**
		 * 下次执行
		*/
		public static final DBField NEXT_TIME = new DBField(DBDataType.DATE , "next_time","nextTime","下次执行","下次执行",false,false,true);
	...
	public static class EAM_INSPECTION_PLAN_POINT extends DBTable {
		...
		*/
		...
		public EAM_INSPECTION_PLAN_POINT() {
			this.init($NAME,"巡检点" , ID , PLAN_ID , POINT_ID , SELECT_CODE , SORT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
	...
	*/
	public static class EAM_INSPECTION_POINT extends DBTable {
		...
		*/
		 ...
		 * 点位编码
		*/
		public static final DBField CODE = new DBField(DBDataType.STRING , "code","code","点位编码","点位编码",false,false,true);
		
		/**
		 * 点位名称
		*/
		public static final DBField NAME = new DBField(DBDataType.STRING , "name","name","点位名称","点位名称",false,false,true);
		...
		*/
		 ...
		 * 点位位置
		*/
		public static final DBField POS_ID = new DBField(DBDataType.STRING , "pos_id","posId","点位位置","点位位置",false,false,true);
		...
		*/
		 ...
		 * 位置经度
		*/
		public static final DBField POS_LONGITUDE = new DBField(DBDataType.DECIMAL , "pos_longitude","posLongitude","位置经度","位置经度",false,false,true);
		
		/**
		 * 位置纬度
		*/
		public static final DBField POS_LATITUDE = new DBField(DBDataType.DECIMAL , "pos_latitude","posLatitude","位置纬度","位置纬度",false,false,true);
		...
		*/
		 ...
		 * 关联设备
		*/
		public static final DBField ASSET_ID = new DBField(DBDataType.STRING , "asset_id","assetId","关联设备","关联设备",false,false,true);
		...
		*/
		...
		public EAM_INSPECTION_POINT() {
			this.init($NAME,"巡检点" , ID , CODE , NAME , STATUS , CONTENT , ROUTE_ID , RFID , POS_ID , POS , POS_LONGITUDE , POS_LATITUDE , PICTURE_ID , NOTES , ASSET_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
	 ...
	 * 巡检点项
	*/
	public static class EAM_INSPECTION_POINT_ITEM extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inspection_point_item";
		...
		*/
		 ...
		 * 巡检项
		*/
		public static final DBField ITEM_ID = new DBField(DBDataType.STRING , "item_id","itemId","巡检项","巡检项",false,false,true);
		...
		*/
		...
		public EAM_INSPECTION_POINT_ITEM() {
			this.init($NAME,"巡检点项" , ID , POINT_ID , ITEM_ID , SELECT_CODE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_INSPECTION_POINT_ITEM $TABLE=new EAM_INSPECTION_POINT_ITEM();
	}
	...
	*/
	public static class EAM_INSPECTION_POINT_POS extends DBTable {
		...
		*/
		 ...
		 * 位置编码
		*/
		public static final DBField CODE = new DBField(DBDataType.STRING , "code","code","位置编码","位置编码",false,false,true);
		
		/**
		 * 位置名称
		*/
		public static final DBField NAME = new DBField(DBDataType.STRING , "name","name","位置名称","位置名称",false,false,true);
	 ...
	 * 处理方式
	*/
	public static class EAM_INSPECTION_PROCESS_ACTION extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inspection_process_action";
		...
		*/
		 ...
		 * 方式
		*/
		public static final DBField NAME = new DBField(DBDataType.STRING , "name","name","方式","方式",false,false,true);
		
		/**
		 * 处理类
		*/
		public static final DBField CLASS_VALUE = new DBField(DBDataType.STRING , "class_value","classValue","处理类","处理类",false,false,true);
		...
		*/
		...
		public EAM_INSPECTION_PROCESS_ACTION() {
			this.init($NAME,"处理方式" , ID , CODE , NAME , CLASS_VALUE , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_INSPECTION_PROCESS_ACTION $TABLE=new EAM_INSPECTION_PROCESS_ACTION();
	}
	
	/**
	 * 巡检记录
	*/
	public static class EAM_INSPECTION_RCD extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inspection_rcd";
		...
		*/
		 ...
		 * 结果
		*/
		public static final DBField RESULT_CODE = new DBField(DBDataType.STRING , "result_code","resultCode","结果","结果",false,false,true);
		...
		*/
		 ...
		 * 操作日期
		*/
		public static final DBField RCD_TIME = new DBField(DBDataType.DATE , "rcd_time","rcdTime","操作日期","操作日期",false,false,true);
		...
		*/
		...
		public EAM_INSPECTION_RCD() {
			this.init($NAME,"巡检记录" , ID , BUSINESS_CODE , ASSET_ID , RESULT_CODE , CONTENT , RCD_TIME , OPER_USER_ID , OPER_USER_NAME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_INSPECTION_RCD $TABLE=new EAM_INSPECTION_RCD();
	}
	...
	*/
	public static class EAM_INSPECTION_TASK extends DBTable {
		...
		*/
		 ...
		 * 实际开始
		*/
		public static final DBField ACT_START_TIME = new DBField(DBDataType.DATE , "act_start_time","actStartTime","实际开始","实际开始",false,false,true);
		
		/**
		 * 实际完成
		*/
		public static final DBField ACT_FINISH_TIME = new DBField(DBDataType.DATE , "act_finish_time","actFinishTime","实际完成","实际完成",false,false,true);
		
		/**
		 * 实际用时
		*/
		public static final DBField ACT_TOTAL_COST = new DBField(DBDataType.DECIMAL , "act_total_cost","actTotalCost","实际用时","实际用时",false,false,true);
	 ...
	 * 异常巡检任务单
	*/
	public static class EAM_INSPECTION_TASK_ABNORMAL extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inspection_task_abnormal";
		...
		*/
		 ...
		 * 任务名称
		*/
		public static final DBField TASK_ID = new DBField(DBDataType.STRING , "task_id","taskId","任务名称","任务名称",false,false,true);
		
		/**
		 * 异常信息
		*/
		public static final DBField TASK_ABNORMAL_INFO = new DBField(DBDataType.STRING , "task_abnormal_info","taskAbnormalInfo","异常信息","异常信息",false,false,true);
		...
		*/
		 ...
		 * 处理人员
		*/
		public static final DBField OPER_ID = new DBField(DBDataType.STRING , "oper_id","operId","处理人员","处理人员",false,false,true);
		
		/**
		 * 处理方式
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","处理方式","处理方式",false,false,true);
		
		/**
		 * 处理时间
		*/
		public static final DBField OPER_TIME = new DBField(DBDataType.DATE , "oper_time","operTime","处理时间","处理时间",false,false,true);
		
		/**
		 * 图片
		*/
		public static final DBField FILE_IDS = new DBField(DBDataType.STRING , "file_ids","fileIds","图片","图片",false,false,true);
		...
		*/
		...
		public EAM_INSPECTION_TASK_ABNORMAL() {
			this.init($NAME,"异常巡检任务单" , ID , TASK_ID , TASK_ABNORMAL_INFO , STATUS , OPER_ID , CONTENT , OPER_TIME , FILE_IDS , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_INSPECTION_TASK_ABNORMAL $TABLE=new EAM_INSPECTION_TASK_ABNORMAL();
	}
	...
	*/
	public static class EAM_INSPECTION_TASK_POINT extends DBTable {
		...
		*/
		 ...
		 * 处理动作
		*/
		public static final DBField ACTION_LABEL = new DBField(DBDataType.STRING , "action_label","actionLabel","处理动作","处理动作",false,false,true);
		...
		*/
		 ...
		 * 位置经度
		*/
		public static final DBField POINT_POS_LONGITUDE = new DBField(DBDataType.DECIMAL , "point_pos_longitude","pointPosLongitude","位置经度","位置经度",false,false,true);
		
		/**
		 * 位置纬度
		*/
		public static final DBField POINT_POS_LATITUDE = new DBField(DBDataType.DECIMAL , "point_pos_latitude","pointPosLatitude","位置纬度","位置纬度",false,false,true);
		...
		*/
		 ...
		 * 巡检方式
		*/
		public static final DBField INSP_METHOD = new DBField(DBDataType.STRING , "insp_method","inspMethod","巡检方式","巡检方式",false,false,true);
	 ...
	 * 巡检点批量操作
	*/
	public static class EAM_INSPECTION_TASK_POINT_OPER extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_inspection_task_point_oper";
		...
		*/
		 ...
		 * 巡检状态
		*/
		public static final DBField IS_POINT_STATUS = new DBField(DBDataType.STRING , "is_point_status","isPointStatus","巡检状态","巡检状态",false,false,true);
		...
		*/
		 ...
		 * 处理动作
		*/
		public static final DBField IS_ACTION_LABEL = new DBField(DBDataType.STRING , "is_action_label","isActionLabel","处理动作","处理动作",false,false,true);
		...
		*/
		 ...
		 * 巡检人
		*/
		public static final DBField IS_INSPECTOR_ID = new DBField(DBDataType.STRING , "is_inspector_id","isInspectorId","巡检人","巡检人",false,false,true);
		
		/**
		 * 巡检人
		*/
		public static final DBField INSPECTOR_ID = new DBField(DBDataType.STRING , "inspector_id","inspectorId","巡检人","巡检人",false,false,true);
		
		/**
		 * 巡检结果
		*/
		public static final DBField IS_CONTENT = new DBField(DBDataType.STRING , "is_content","isContent","巡检结果","巡检结果",false,false,true);
		...
		*/
		...
		public EAM_INSPECTION_TASK_POINT_OPER() {
			this.init($NAME,"巡检点批量操作" , ID , TASK_ID , IS_POINT_STATUS , POINT_STATUS , IS_ACTION_LABEL , ACTION_LABEL , IS_INSPECTOR_ID , INSPECTOR_ID , IS_CONTENT , CONTENT , OPER_USER_ID , OPER_TIME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_INSPECTION_TASK_POINT_OPER $TABLE=new EAM_INSPECTION_TASK_POINT_OPER();
	}
	...
	*/
	public static class EAM_MAINTAIN_PLAN extends DBTable {
		...
		*/
		 ...
		 * 计划单据
		*/
		public static final DBField CODE = new DBField(DBDataType.STRING , "code","code","计划单据","计划单据",false,false,true);
		...
		*/
		 ...
		 * 计划状态
		*/
		public static final DBField STATUS = new DBField(DBDataType.STRING , "status","status","计划状态","计划状态",false,false,true);
		
		/**
		 * 保养设备
		*/
		public static final DBField ASSET_ID = new DBField(DBDataType.STRING , "asset_id","assetId","保养设备","保养设备",false,false,true);
		
		/**
		 * 保养设备
		*/
		public static final DBField ASSET_CODE = new DBField(DBDataType.STRING , "asset_code","assetCode","保养设备","保养设备",false,false,true);
		...
		*/
		 ...
		 * 设备序列
		*/
		public static final DBField ASSET_SN = new DBField(DBDataType.STRING , "asset_sn","assetSn","设备序列","设备序列",false,false,true);
		
		/**
		 * 保养班组
		*/
		public static final DBField GROUP_ID = new DBField(DBDataType.STRING , "group_id","groupId","保养班组","保养班组",false,false,true);
		...
		*/
		 ...
		 * 超时时间(分)
		*/
		public static final DBField TIMEOUT = new DBField(DBDataType.DECIMAL , "timeout","timeout","超时时间","分)",false,false,true);
		...
		*/
		...
		public EAM_MAINTAIN_PLAN() {
			this.init($NAME,"保养方案" , ID , CODE , NAME , STATUS , ASSET_ID , ASSET_CODE , ASSET_NAME , ASSET_MODEL , ASSET_SN , GROUP_ID , MAINTAIN_TYPE , CYCLE_METHOD , ACTION_CYCLE_ID , START_TIME , END_TIME , TOTAL_COST , TIMEOUT , INFO , NOTES , ORIGINATOR_ID , LAST_TIME , NEXT_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
	...
	*/
	 ...
	 * 保养记录
	*/
	public static class EAM_MAINTAIN_RCD extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_maintain_rcd";
		...
		*/
		...
		public EAM_MAINTAIN_RCD() {
			this.init($NAME,"保养记录" , ID , BUSINESS_CODE , ASSET_ID , CONTENT , RCD_TIME , OPER_USER_ID , OPER_USER_NAME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_MAINTAIN_RCD $TABLE=new EAM_MAINTAIN_RCD();
	}
	...
	*/
	public static class EAM_MAINTAIN_TASK extends DBTable {
		...
		*/
		 ...
		 * 保养班组
		*/
		public static final DBField GROUP_ID = new DBField(DBDataType.STRING , "group_id","groupId","保养班组","保养班组",false,false,false);
		...
		*/
		 ...
		 * 设备位置
		*/
		public static final DBField ASSET_POS = new DBField(DBDataType.STRING , "asset_pos","assetPos","设备位置","设备位置",false,false,true);
	...
	public static class EAM_MAINTAIN_TASK_PROJECT extends DBTable {
		...
		*/
		...
		public EAM_MAINTAIN_TASK_PROJECT() {
			this.init($NAME,"保养项目" , ID , PROJECT_ID , TASK_ID , STATUS , CONTENT , BASE_COST , START_TIME , END_TIME , OPER_USER_ID , OPER_TIME , PROJECT_CODE , PROJECT_NAME , PROJECT_MAINTAIN_TYPE , PROJECT_BASE_COST , PROJECT_ATTACH_ID , PROJECT_NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , SELECTED_CODE , VERSION);
		}
	...
	*/
	 ...
	 * 归属
	*/
	public static class EAM_MAPPING_OWNER extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_mapping_owner";
		...
		*/
		...
		public EAM_MAPPING_OWNER() {
			this.init($NAME,"归属" , ID , OWNER_ID , SELECTED_CODE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_MAPPING_OWNER $TABLE=new EAM_MAPPING_OWNER();
	}
	...
	*/
	public static class EAM_POSITION extends DBTable {
		...
		*/
		 ...
		 * RFID编码
		*/
		public static final DBField RFID = new DBField(DBDataType.STRING , "rfid","rfid","RFID编码","RFID编码",false,false,true);
		...
		*/
		...
		public EAM_POSITION() {
			this.init($NAME,"存放位置" , ID , CODE , NAME , STATUS , RFID , PARENT_ID , HIERARCHY , HIERARCHY_NAME , SORT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	 ...
	 * 位置记录
	*/
	public static class EAM_POSITION_RFID_RCD extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_position_rfid_rcd";
		...
		*/
		 ...
		 * 状态,sucess
		*/
		public static final DBField STATUS = new DBField(DBDataType.STRING , "status","status","状态","sucess",false,false,true);
		...
		*/
		...
		public EAM_POSITION_RFID_RCD() {
			this.init($NAME,"位置记录" , ID , RFID , RCD_TIME , STATUS , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_POSITION_RFID_RCD $TABLE=new EAM_POSITION_RFID_RCD();
	}
	...
	*/
	 ...
	 * 采购单导入资产
	*/
	public static class EAM_PURCHASE_IMPORT extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_purchase_import";
		...
		*/
		 ...
		 * 采购单
		*/
		public static final DBField ORDER_ID = new DBField(DBDataType.STRING , "order_id","orderId","采购单","采购单",false,false,true);
		
		/**
		 * 订单编号
		*/
		public static final DBField ORDER_CODE = new DBField(DBDataType.STRING , "order_code","orderCode","订单编号","订单编号",false,false,true);
		...
		*/
		 ...
		 * 采购日期
		*/
		public static final DBField PURCHASE_DATE = new DBField(DBDataType.STRING , "purchase_date","purchaseDate","采购日期","采购日期",false,false,true);
		...
		*/
		 ...
		 * 导入类型
		*/
		public static final DBField IMPORT_TO_TYPE = new DBField(DBDataType.STRING , "import_to_type","importToType","导入类型","导入类型",false,false,true);
		...
		*/
		...
		public EAM_PURCHASE_IMPORT() {
			this.init($NAME,"采购单导入资产" , ID , NAME , STATUS , ORDER_ID , ORDER_CODE , ORDER_NAME , OWN_COMPANY_ID , USE_ORG_ID , MANAGER_ID , USE_USER_ID , POSITION_ID , PURCHASE_DATE , ASSET_NOTES , NOTES , OPER_USER_ID , IMPORT_TO_TYPE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_PURCHASE_IMPORT $TABLE=new EAM_PURCHASE_IMPORT();
	}
	...
	*/
	 ...
	 * 关联项
	*/
	public static class EAM_RELATED_ITEMS extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_related_items";
		...
		*/
		 ...
		 * 名称
		*/
		public static final DBField OWNER_ID = new DBField(DBDataType.STRING , "owner_id","ownerId","名称","名称",false,false,true);
		
		/**
		 * 项目
		*/
		public static final DBField ITEM_ID = new DBField(DBDataType.STRING , "item_id","itemId","项目","项目",false,false,true);
		...
		*/
		...
		public EAM_RELATED_ITEMS() {
			this.init($NAME,"关联项" , ID , OWNER_ID , ITEM_ID , TYPE , SELECTED_CODE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_RELATED_ITEMS $TABLE=new EAM_RELATED_ITEMS();
	}
	...
	*/
	public static class EAM_REPAIR_ORDER extends DBTable {
		...
		*/
		 ...
		 * 报修人员
		*/
		public static final DBField REPORT_USER_ID = new DBField(DBDataType.STRING , "report_user_id","reportUserId","报修人员","报修人员",false,false,true);
		...
		*/
		 ...
		 * 制单人员
		*/
		public static final DBField ORIGINATOR_ID = new DBField(DBDataType.STRING , "originator_id","originatorId","制单人员","制单人员",false,false,true);
		...
		*/
		 ...
		 * 故障设备
		*/
		public static final DBField ASSET_ID = new DBField(DBDataType.STRING , "asset_id","assetId","故障设备","故障设备",false,false,true);
	...
	*/
	public static class EAM_REPAIR_ORDER_ACCEPTANCE extends DBTable {
		...
		*/
		 ...
		 * 验收人员
		*/
		public static final DBField ACCEPTER_ID = new DBField(DBDataType.STRING , "accepter_id","accepterId","验收人员","验收人员",false,false,true);
	...
	*/
	 ...
	 * 维修备件
	*/
	public static class EAM_REPAIR_ORDER_ACT_SP extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_repair_order_act_sp";
		...
		*/
		 ...
		 * 备件序列
		*/
		public static final DBField SP_SN = new DBField(DBDataType.STRING , "sp_sn","spSn","备件序列","备件序列",false,false,true);
	 ...
	 * 流转过程
	*/
	public static class EAM_REPAIR_ORDER_PROCESS extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_repair_order_process";
		...
		*/
		 ...
		 * 工单
		*/
		public static final DBField ORDER_ID = new DBField(DBDataType.STRING , "order_id","orderId","工单","工单",false,false,true);
		
		/**
		 * 维修单
		*/
		public static final DBField ACT_ID = new DBField(DBDataType.STRING , "act_id","actId","维修单","维修单",false,false,true);
	 ...
	 * 工单转派
	*/
	public static class EAM_REPAIR_ORDER_TRANSFER extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_repair_order_transfer";
	 ...
	 * 维修记录
	*/
	public static class EAM_REPAIR_RCD extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_repair_rcd";
		...
		*/
		...
		public EAM_REPAIR_RCD() {
			this.init($NAME,"维修记录" , ID , BUSINESS_CODE , ASSET_ID , CONTENT , RCD_TIME , OPER_USER_ID , OPER_USER_NAME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_REPAIR_RCD $TABLE=new EAM_REPAIR_RCD();
	}
	...
	*/
	 ...
	 * RFID标签
	*/
	public static class EAM_RFID_LABEL extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_rfid_label";
		...
		*/
		 ...
		 * RFID发卡
		*/
		public static final DBField RELEASE_ID = new DBField(DBDataType.STRING , "release_id","releaseId","RFID发卡","RFID发卡",false,false,true);
		...
		*/
		 ...
		 * 发卡时间
		*/
		public static final DBField OPER_TIME = new DBField(DBDataType.DATE , "oper_time","operTime","发卡时间","发卡时间",false,false,true);
		...
		*/
		 ...
		 * 发卡结果
		*/
		public static final DBField OPER_RESULT = new DBField(DBDataType.STRING , "oper_result","operResult","发卡结果","发卡结果",false,false,true);
		...
		*/
		...
		public EAM_RFID_LABEL() {
			this.init($NAME,"RFID标签" , ID , RELEASE_ID , STATUS , ASSET_ID , ASSET_CODE , LABEL , OPER_TIME , OPER_USER_ID , OPER_RESULT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_RFID_LABEL $TABLE=new EAM_RFID_LABEL();
	}
	
	/**
	 * RFID发卡
	*/
	public static class EAM_RFID_RELEASE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_rfid_release";
		...
		*/
		...
		public EAM_RFID_RELEASE() {
			this.init($NAME,"RFID发卡" , ID , NAME , STATUS , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_RFID_RELEASE $TABLE=new EAM_RFID_RELEASE();
	}
	...
	*/
	 ...
	 * 库存导入资产
	*/
	public static class EAM_STOCK_IMPORT extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_stock_import";
		...
		*/
		 ...
		 * 库存单
		*/
		public static final DBField ORDER_ID = new DBField(DBDataType.STRING , "order_id","orderId","库存单","库存单",false,false,true);
		...
		*/
		...
		public EAM_STOCK_IMPORT() {
			this.init($NAME,"库存导入资产" , ID , NAME , STATUS , ORDER_ID , ORDER_CODE , ORDER_NAME , OWN_COMPANY_ID , USE_ORG_ID , MANAGER_ID , USE_USER_ID , POSITION_ID , PURCHASE_DATE , ASSET_NOTES , NOTES , OPER_USER_ID , IMPORT_TO_TYPE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION);
		}
		public static final EAM_STOCK_IMPORT $TABLE=new EAM_STOCK_IMPORT();
	}
	
	/**
	 * 库存资产
	*/
	public static class EAM_STOCK_INVENTORY_ASSET extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_stock_inventory_asset";
		...
		*/
		 ...
		 * 盘点备注
		*/
		public static final DBField INVENTORY_NOTES = new DBField(DBDataType.STRING , "inventory_notes","inventoryNotes","盘点备注","盘点备注",false,false,true);
		
		/**
		 * 差异数量
		*/
		public static final DBField ASSET_NUMBER = new DBField(DBDataType.INTEGER , "asset_number","assetNumber","差异数量","差异数量",false,false,true);
		
		/**
		 * 盘点人员
		*/
		public static final DBField OPER_ID = new DBField(DBDataType.STRING , "oper_id","operId","盘点人员","盘点人员",false,false,true);
		
		/**
		 * 盘点时间
		*/
		public static final DBField OPER_TIME = new DBField(DBDataType.DATE , "oper_time","operTime","盘点时间","盘点时间",false,false,true);
		...
		*/
		...
		public EAM_STOCK_INVENTORY_ASSET() {
			this.init($NAME,"库存资产" , ID , TASK_ID , ASSET_ID , INVENTORY_STATUS , INVENTORY_NOTES , ASSET_NUMBER , OPER_ID , OPER_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_STOCK_INVENTORY_ASSET $TABLE=new EAM_STOCK_INVENTORY_ASSET();
	}
	
	/**
	 * 盘点计划2
	*/
	public static class EAM_STOCK_INVENTORY_PLAN extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_stock_inventory_plan";
		...
		*/
		...
		public EAM_STOCK_INVENTORY_PLAN() {
			this.init($NAME,"盘点计划2" , ID , NAME , OWNER_CODE , STATUS , PLAN_TYPE , TPL_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_STOCK_INVENTORY_PLAN $TABLE=new EAM_STOCK_INVENTORY_PLAN();
	}
	
	/**
	 * 盘点任务2
	*/
	public static class EAM_STOCK_INVENTORY_TASK extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_stock_inventory_task";
		...
		*/
		...
		public EAM_STOCK_INVENTORY_TASK() {
			this.init($NAME,"盘点任务2" , ID , TYPE , BUSINESS_CODE , STATUS , NAME , INVENTORY_STATUS , DATA_STATUS , START_TIME , FINISH_TIME , DIRECTOR_ID , ORIGINATOR_ID , BUSINESS_DATE , NOTES , PLAN_ID , OWNER_CODE , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final EAM_STOCK_INVENTORY_TASK $TABLE=new EAM_STOCK_INVENTORY_TASK();
	}
	...
	public static class EAM_WAREHOUSE extends DBTable {
		...
		*/
		...
		public EAM_WAREHOUSE() {
			this.init($NAME,"仓库" , ID , CODE , STATUS , WAREHOUSE_NAME , MANAGER_ID , WAREHOUSE_NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	*/
	public static class EAM_WAREHOUSE_POSITION extends DBTable {
		...
		*/
		 ...
		 * 状态
		*/
		public static final DBField STAUTS = new DBField(DBDataType.STRING , "stauts","stauts","状态","状态",false,false,true);
		...
		*/
		 ...
		 * 最大容量
		*/
		public static final DBField MAXIMUM_CAPACITY = new DBField(DBDataType.INTEGER , "maximum_capacity","maximumCapacity","最大容量","最大容量",false,false,true);
		...
		*/
		...
		public EAM_WAREHOUSE_POSITION() {
			this.init($NAME,"仓库库位" , ID , WAREHOUSE_ID , CODE , FULL_NAME , STAUTS , NAME , MAXIMUM_CAPACITY , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	 ...
	 * 问题工单
	*/
	public static class EAM_WORK_ORDER extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_work_order";
		...
		*/
		 ...
		 * 问题
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","问题","问题",false,false,true);
		...
		*/
		 ...
		 * 操作人
		*/
		public static final DBField RCD_USER_ID = new DBField(DBDataType.STRING , "rcd_user_id","rcdUserId","操作人","操作人",false,false,true);
		...
		*/
		 ...
		 * 回复时间
		*/
		public static final DBField LAST_TIME = new DBField(DBDataType.DATE , "last_time","lastTime","回复时间","回复时间",false,false,true);
		...
		*/
		...
		public EAM_WORK_ORDER() {
			this.init($NAME,"问题工单" , ID , STATUS , TITLE , CONTENT , FILE_IDS , CONTACT_INFORMATION , RCD_USER_ID , RCD_TIME , LAST_TIME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_WORK_ORDER $TABLE=new EAM_WORK_ORDER();
	}
	
	/**
	 * 工单消息
	*/
	public static class EAM_WORK_ORDER_MSG extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "eam_work_order_msg";
		...
		*/
		...
		public EAM_WORK_ORDER_MSG() {
			this.init($NAME,"工单消息" , ID , STATUS , ORDER_ID , CONTENT , FILE_IDS , USER_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final EAM_WORK_ORDER_MSG $TABLE=new EAM_WORK_ORDER_MSG();
	}
