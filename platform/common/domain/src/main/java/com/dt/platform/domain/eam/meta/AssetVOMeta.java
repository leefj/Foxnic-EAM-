...
public class AssetVOMeta extends AssetMeta {
	...
	*/
	 ...
	 * 数据来源 , 前端指定不同的来源，后端可按来源执行不同的逻辑 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.lang.String> DATA_ORIGIN_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,DATA_ORIGIN, java.lang.String.class, "数据来源", "前端指定不同的来源，后端可按来源执行不同的逻辑", java.lang.String.class, null);
	...
	*/
	 ...
	 * 查询逻辑 , 默认and，可指定 or  , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.lang.String> QUERY_LOGIC_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,QUERY_LOGIC, java.lang.String.class, "查询逻辑", "默认and，可指定 or ", java.lang.String.class, null);
	...
	*/
	 ...
	 * 请求动作 , 前端指定不同的Action，后端可Action执行不同的逻辑 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.lang.String> REQUEST_ACTION_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,REQUEST_ACTION, java.lang.String.class, "请求动作", "前端指定不同的Action，后端可Action执行不同的逻辑", java.lang.String.class, null);
	...
	*/
	 ...
	 * 启停状态 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.lang.String> EQUIPMENT_STATUS_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,EQUIPMENT_STATUS, java.lang.String.class, "启停状态", "启停状态", java.lang.String.class, null);
	...
	*/
	...
	/**
	 * 巡检时间 , 类型: java.util.Date
	*/
	public static final String LAST_INSPECT_TIME="lastInspectTime";
	
	/**
	 * 巡检时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.util.Date> LAST_INSPECT_TIME_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,LAST_INSPECT_TIME, java.util.Date.class, "巡检时间", "巡检时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 经度数据 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.math.BigDecimal> LONGITUDE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,LONGITUDE, java.math.BigDecimal.class, "经度数据", "经度数据", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 维度数据 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.math.BigDecimal> DIMENSION_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,DIMENSION, java.math.BigDecimal.class, "维度数据", "维度数据", java.math.BigDecimal.class, null);
	...
	*/
	...
	/**
	 * catalogCodeValue , 类型: java.lang.String
	*/
	public static final String CATALOG_CODE_VALUE="catalogCodeValue";
	
	/**
	 * catalogCodeValue , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,java.lang.String> CATALOG_CODE_VALUE_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,CATALOG_CODE_VALUE, java.lang.String.class, "catalogCodeValue", "catalogCodeValue", java.lang.String.class, null);
	...
	*/
	...
	/**
	 * 物品档案 , 类型: com.dt.platform.domain.eam.GoodsStock
	*/
	 ...
	 * 物品档案 , 类型: com.dt.platform.domain.eam.GoodsStock
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.AssetVO,com.dt.platform.domain.eam.GoodsStock> GOODS_PROP = new BeanProperty(com.dt.platform.domain.eam.AssetVO.class ,GOODS, com.dt.platform.domain.eam.GoodsStock.class, "物品档案", "物品档案", com.dt.platform.domain.eam.GoodsStock.class, null);
	...
	*/
	public static class $$proxy$$ extends com.dt.platform.domain.eam.AssetVO {
		...
		*/
		 ...
		 * @return 当前对象
		*/
		public AssetVO setDataOrigin(String dataOrigin) {
		 ...
		 * @return 当前对象
		*/
		public AssetVO setQueryLogic(String queryLogic) {
		 ...
		 * @return 当前对象
		*/
		public AssetVO setRequestAction(String requestAction) {
		...
		*/
		public Asset setLastInspectTime(Date lastInspectTime) {
			super.change(LAST_INSPECT_TIME,super.getLastInspectTime(),lastInspectTime);
			super.setLastInspectTime(lastInspectTime);
			return this;
		}
		...
		*/
		public Asset setCatalogCodeValue(String catalogCodeValue) {
			super.change(CATALOG_CODE_VALUE,super.getCatalogCodeValue(),catalogCodeValue);
			super.setCatalogCodeValue(catalogCodeValue);
			return this;
		}
