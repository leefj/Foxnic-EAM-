...
@ApiModel(description = "考勤模版VO类型 ; 考勤模版 , 数据表 hr_attendance_tpl 的通用VO类型" , parent = AttendanceTpl.class)
public class AttendanceTplVO extends AttendanceTpl {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AttendanceTplVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AttendanceTplVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return AttendanceTplVO , 转换好的 AttendanceTplVO 对象
	*/
	@Transient
	 ...
	 * @return AttendanceTplVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	@Transient
	public AttendanceTplVO clone(boolean deep) {
		return EntityContext.clone(AttendanceTplVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 AttendanceTplVO
	 * @param attendanceTplMap 包含实体信息的 Map 对象
	 * @return AttendanceTplVO , 转换好的的 AttendanceTpl 对象
	*/
	@Transient
	public static AttendanceTplVO createFrom(Map<String,Object> attendanceTplMap) {
		if(attendanceTplMap==null) return null;
		AttendanceTplVO vo = create();
		EntityContext.copyProperties(vo,attendanceTplMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 AttendanceTplVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return AttendanceTplVO , 转换好的的 AttendanceTpl 对象
	*/
	@Transient
	public static AttendanceTplVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 AttendanceTplVO，等同于 new
	 * @return AttendanceTplVO 对象
	*/
	@Transient
	public static AttendanceTplVO create() {
		return new com.dt.platform.domain.hr.meta.AttendanceTplVOMeta.$$proxy$$();
	}
	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setDeleteTime(DataParser.parse(Date.class, map.get(AttendanceTplVOMeta.DELETE_TIME)));
			this.setName(DataParser.parse(String.class, map.get(AttendanceTplVOMeta.NAME)));
			this.setTenantId(DataParser.parse(String.class, map.get(AttendanceTplVOMeta.TENANT_ID)));
			this.setDeleteBy(DataParser.parse(String.class, map.get(AttendanceTplVOMeta.DELETE_BY)));
			this.setId(DataParser.parse(String.class, map.get(AttendanceTplVOMeta.ID)));
			// others
			this.setSearchField(DataParser.parse(String.class, map.get(AttendanceTplVOMeta.SEARCH_FIELD)));
			...
			this.setDataOrigin(DataParser.parse(String.class, map.get(AttendanceTplVOMeta.DATA_ORIGIN)));
			this.setQueryLogic(DataParser.parse(String.class, map.get(AttendanceTplVOMeta.QUERY_LOGIC)));
			this.setSearchValue(DataParser.parse(String.class, map.get(AttendanceTplVOMeta.SEARCH_VALUE)));
			return true;
		} else {
			try {
				...
				this.setDeleteTime( (Date)map.get(AttendanceTplVOMeta.DELETE_TIME));
				this.setName( (String)map.get(AttendanceTplVOMeta.NAME));
				this.setTenantId( (String)map.get(AttendanceTplVOMeta.TENANT_ID));
				this.setDeleteBy( (String)map.get(AttendanceTplVOMeta.DELETE_BY));
				this.setId( (String)map.get(AttendanceTplVOMeta.ID));
				// others
				this.setSearchField( (String)map.get(AttendanceTplVOMeta.SEARCH_FIELD));
				...
				this.setDataOrigin( (String)map.get(AttendanceTplVOMeta.DATA_ORIGIN));
				this.setQueryLogic( (String)map.get(AttendanceTplVOMeta.QUERY_LOGIC));
				this.setSearchValue( (String)map.get(AttendanceTplVOMeta.SEARCH_VALUE));
				return true;
			} catch (Exception e) {
				return false;
			}
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setDeleteTime(DataParser.parse(Date.class, r.getValue(AttendanceTplVOMeta.DELETE_TIME)));
			this.setName(DataParser.parse(String.class, r.getValue(AttendanceTplVOMeta.NAME)));
			this.setTenantId(DataParser.parse(String.class, r.getValue(AttendanceTplVOMeta.TENANT_ID)));
			this.setDeleteBy(DataParser.parse(String.class, r.getValue(AttendanceTplVOMeta.DELETE_BY)));
			this.setId(DataParser.parse(String.class, r.getValue(AttendanceTplVOMeta.ID)));
			return true;
		} else {
			try {
				...
				this.setDeleteTime( (Date)r.getValue(AttendanceTplVOMeta.DELETE_TIME));
				this.setName( (String)r.getValue(AttendanceTplVOMeta.NAME));
				this.setTenantId( (String)r.getValue(AttendanceTplVOMeta.TENANT_ID));
				this.setDeleteBy( (String)r.getValue(AttendanceTplVOMeta.DELETE_BY));
				this.setId( (String)r.getValue(AttendanceTplVOMeta.ID));
				return true;
			} catch (Exception e) {
				return false;
			}
