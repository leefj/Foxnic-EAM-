	...
	*/
	public static class HR_SALARY extends DBTable {
		...
		*/
		 ...
		 * 是否发放
		*/
		public static final DBField STATUS = new DBField(DBDataType.STRING , "status","status","是否发放","是否发放",false,false,true);
