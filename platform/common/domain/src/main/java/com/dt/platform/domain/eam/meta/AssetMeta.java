...
public class AssetMeta {
	...
	*/
	 ...
	 * 流程ID , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.lang.String> PROC_ID_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,PROC_ID, java.lang.String.class, "流程ID", "流程ID", java.lang.String.class, null);
	...
	*/
	 ...
	 * 清理类型 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.lang.String> CLEAN_OUT_TYPE_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,CLEAN_OUT_TYPE, java.lang.String.class, "清理类型", "清理类型", java.lang.String.class, null);
	...
	*/
	 ...
	 * 清理时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.util.Date> CLEAN_TIME_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,CLEAN_TIME, java.util.Date.class, "清理时间", "清理时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 巡检时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.util.Date> LAST_INSPECT_TIME_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,LAST_INSPECT_TIME, java.util.Date.class, "巡检时间", "巡检时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 处置ID , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.lang.String> HANDLE_ID_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,HANDLE_ID, java.lang.String.class, "处置ID", "处置ID", java.lang.String.class, null);
	...
	*/
	 ...
	 * catalogCodeValue , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,java.lang.String> CATALOG_CODE_VALUE_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,CATALOG_CODE_VALUE, java.lang.String.class, "catalogCodeValue", "catalogCodeValue", java.lang.String.class, null);
	...
	*/
	 ...
	 * 物品档案 , 类型: com.dt.platform.domain.eam.GoodsStock
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,com.dt.platform.domain.eam.GoodsStock> GOODS_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,GOODS, com.dt.platform.domain.eam.GoodsStock.class, "物品档案", "物品档案", com.dt.platform.domain.eam.GoodsStock.class, null);
	...
	*/
	 ...
	 * partAssetList , 集合类型: LIST , 类型: com.dt.platform.domain.eam.Asset
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,com.dt.platform.domain.eam.Asset> PART_ASSET_LIST_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,PART_ASSET_LIST, java.util.List.class, "partAssetList", "partAssetList", com.dt.platform.domain.eam.Asset.class, null);
	...
	*/
	 ...
	 * partGoodsStockList , 集合类型: LIST , 类型: com.dt.platform.domain.eam.Asset
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.Asset,com.dt.platform.domain.eam.Asset> PART_GOODS_STOCK_LIST_PROP = new BeanProperty(com.dt.platform.domain.eam.Asset.class ,PART_GOODS_STOCK_LIST, java.util.List.class, "partGoodsStockList", "partGoodsStockList", com.dt.platform.domain.eam.Asset.class, null);
