	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setRequestAction(DataParser.parse(String.class, map.get(AssetLabelVOMeta.REQUEST_ACTION)));
			...
			this.setDataOrigin(DataParser.parse(String.class, map.get(AssetLabelVOMeta.DATA_ORIGIN)));
			this.setQueryLogic(DataParser.parse(String.class, map.get(AssetLabelVOMeta.QUERY_LOGIC)));
			...
			try {
				...
				this.setRequestAction( (String)map.get(AssetLabelVOMeta.REQUEST_ACTION));
				...
				this.setDataOrigin( (String)map.get(AssetLabelVOMeta.DATA_ORIGIN));
				this.setQueryLogic( (String)map.get(AssetLabelVOMeta.QUERY_LOGIC));
