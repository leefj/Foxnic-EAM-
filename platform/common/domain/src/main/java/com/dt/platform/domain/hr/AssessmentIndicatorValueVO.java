...
@ApiModel(description = "考核结果VO类型 ; 考核结果 , 数据表 hr_assessment_indicator_value 的通用VO类型" , parent = AssessmentIndicatorValue.class)
public class AssessmentIndicatorValueVO extends AssessmentIndicatorValue {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssessmentIndicatorValueVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssessmentIndicatorValueVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return AssessmentIndicatorValueVO , 转换好的 AssessmentIndicatorValueVO 对象
	*/
	@Transient
	 ...
	 * @return AssessmentIndicatorValueVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	@Transient
	public AssessmentIndicatorValueVO clone(boolean deep) {
		return EntityContext.clone(AssessmentIndicatorValueVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 AssessmentIndicatorValueVO
	 * @param assessmentIndicatorValueMap 包含实体信息的 Map 对象
	 * @return AssessmentIndicatorValueVO , 转换好的的 AssessmentIndicatorValue 对象
	*/
	@Transient
	public static AssessmentIndicatorValueVO createFrom(Map<String,Object> assessmentIndicatorValueMap) {
		if(assessmentIndicatorValueMap==null) return null;
		AssessmentIndicatorValueVO vo = create();
		EntityContext.copyProperties(vo,assessmentIndicatorValueMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 AssessmentIndicatorValueVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return AssessmentIndicatorValueVO , 转换好的的 AssessmentIndicatorValue 对象
	*/
	@Transient
	public static AssessmentIndicatorValueVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 AssessmentIndicatorValueVO，等同于 new
	 * @return AssessmentIndicatorValueVO 对象
	*/
	@Transient
	public static AssessmentIndicatorValueVO create() {
		return new com.dt.platform.domain.hr.meta.AssessmentIndicatorValueVOMeta.$$proxy$$();
	}
	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setCreateBy(DataParser.parse(String.class, map.get(AssessmentIndicatorValueVOMeta.CREATE_BY)));
			this.setDeleted(DataParser.parse(Integer.class, map.get(AssessmentIndicatorValueVOMeta.DELETED)));
			this.setCreateTime(DataParser.parse(Date.class, map.get(AssessmentIndicatorValueVOMeta.CREATE_TIME)));
			this.setUpdateBy(DataParser.parse(String.class, map.get(AssessmentIndicatorValueVOMeta.UPDATE_BY)));
			this.setDeleteTime(DataParser.parse(Date.class, map.get(AssessmentIndicatorValueVOMeta.DELETE_TIME)));
			...
			try {
				...
				this.setCreateBy( (String)map.get(AssessmentIndicatorValueVOMeta.CREATE_BY));
				this.setDeleted( (Integer)map.get(AssessmentIndicatorValueVOMeta.DELETED));
				this.setCreateTime( (Date)map.get(AssessmentIndicatorValueVOMeta.CREATE_TIME));
				this.setUpdateBy( (String)map.get(AssessmentIndicatorValueVOMeta.UPDATE_BY));
				this.setDeleteTime( (Date)map.get(AssessmentIndicatorValueVOMeta.DELETE_TIME));
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setCreateBy(DataParser.parse(String.class, r.getValue(AssessmentIndicatorValueVOMeta.CREATE_BY)));
			this.setDeleted(DataParser.parse(Integer.class, r.getValue(AssessmentIndicatorValueVOMeta.DELETED)));
			this.setCreateTime(DataParser.parse(Date.class, r.getValue(AssessmentIndicatorValueVOMeta.CREATE_TIME)));
			this.setUpdateBy(DataParser.parse(String.class, r.getValue(AssessmentIndicatorValueVOMeta.UPDATE_BY)));
			this.setDeleteTime(DataParser.parse(Date.class, r.getValue(AssessmentIndicatorValueVOMeta.DELETE_TIME)));
			...
			try {
				...
				this.setCreateBy( (String)r.getValue(AssessmentIndicatorValueVOMeta.CREATE_BY));
				this.setDeleted( (Integer)r.getValue(AssessmentIndicatorValueVOMeta.DELETED));
				this.setCreateTime( (Date)r.getValue(AssessmentIndicatorValueVOMeta.CREATE_TIME));
				this.setUpdateBy( (String)r.getValue(AssessmentIndicatorValueVOMeta.UPDATE_BY));
				this.setDeleteTime( (Date)r.getValue(AssessmentIndicatorValueVOMeta.DELETE_TIME));
