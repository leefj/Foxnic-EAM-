package com.foxnicweb.web.constants.db;
...
public class ContractTables {
	...
	public static class CONT_CONTRACT extends DBTable {
		...
		public CONT_CONTRACT() {
			this.init($NAME,"合同表" , ID , TYPE , CONTRACT_NO , TITLE , ENTITY , SIGNATORY_ID , HANDLER_ID , DELIVERABLES , DELIVERY_LOCATION , AMOUNT , CONTRACT_STATUS , PARENT_ID , SUMMARY , SIGNING_DATE , EFFECTIVE_DATE , END_DATE , EXPIRATION_DATE , DEPARTMENT_ID , FUNDING_STATUS , FUNDING_DIRECTION , CATALOG_CODE , ARCH , ATTACH , OTHER_ATTACH , OWNER_ID , TENANT_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	public static class CONT_CONTRACT_PAYMENT_LABEL extends DBTable {
		...
		public CONT_CONTRACT_PAYMENT_LABEL() {
			this.init($NAME,"合同款项" , ID , NAME , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	public static class CONT_CONTRACT_PERFORMANCE extends DBTable {
		...
		public CONT_CONTRACT_PERFORMANCE() {
			this.init($NAME,"履行情况表" , ID , CONTRACT_ID , CONTRACT_NO , TITLE , ACTION , STATUS , PLAN_DATE , ACT_DATE , DETAIL , ATTACH , TENANT_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	public static class CONT_INVOICE_OUT extends DBTable {
		...
		public CONT_INVOICE_OUT() {
			this.init($NAME,"开票" , ID , NAME , STATUS , OWNER_ID , ORG_ID , INVOICE_TYPE , LABEL , FILE_ID , TAX_PRICE , CONTRACT_ID , CODE , INVOICE_DATE , CURRENCY_TYPE , NOTES , TENANT_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	public static class CONT_INVOICE_RECEIVE extends DBTable {
		...
		public CONT_INVOICE_RECEIVE() {
			this.init($NAME,"收票" , ID , NAME , STATUS , OWNER_ID , ORG_ID , INVOICE_TYPE , LABEL , FILE_ID , TAX_PRICE , CONTRACT_ID , CODE , INVOICE_DATE , CURRENCY_TYPE , NOTES , TENANT_ID , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
