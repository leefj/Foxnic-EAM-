...
public class InspectionTaskPointMeta {
	...
	*/
	 ...
	 * 图片 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTaskPoint,java.lang.String> IMAGE_ID_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTaskPoint.class ,IMAGE_ID, java.lang.String.class, "图片", "图片", java.lang.String.class, null);
	...
	*/
	 ...
	 * 巡检点 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTaskPoint,java.lang.String> POINT_NAME_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTaskPoint.class ,POINT_NAME, java.lang.String.class, "巡检点", "巡检点", java.lang.String.class, null);
	...
	*/
	 ...
	 * 位置经度 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTaskPoint,java.math.BigDecimal> POINT_POS_LONGITUDE_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTaskPoint.class ,POINT_POS_LONGITUDE, java.math.BigDecimal.class, "位置经度", "位置经度", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * 位置纬度 , 类型: java.math.BigDecimal
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTaskPoint,java.math.BigDecimal> POINT_POS_LATITUDE_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTaskPoint.class ,POINT_POS_LATITUDE, java.math.BigDecimal.class, "位置纬度", "位置纬度", java.math.BigDecimal.class, null);
	...
	*/
	 ...
	 * checkItemList , 集合类型: LIST , 类型: com.dt.platform.domain.eam.CheckItem
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTaskPoint,com.dt.platform.domain.eam.CheckItem> CHECK_ITEM_LIST_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTaskPoint.class ,CHECK_ITEM_LIST, java.util.List.class, "checkItemList", "checkItemList", com.dt.platform.domain.eam.CheckItem.class, null);
	...
	*/
	 ...
	 * checkSelectList , 集合类型: LIST , 类型: com.dt.platform.domain.eam.CheckSelect
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.InspectionTaskPoint,com.dt.platform.domain.eam.CheckSelect> CHECK_SELECT_LIST_PROP = new BeanProperty(com.dt.platform.domain.eam.InspectionTaskPoint.class ,CHECK_SELECT_LIST, java.util.List.class, "checkSelectList", "checkSelectList", com.dt.platform.domain.eam.CheckSelect.class, null);
