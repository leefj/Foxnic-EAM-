	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setFlowConf(DataParser.parse(String.class, map.get(AssetDepreciationVOMeta.FLOW_CONF)));
			...
			this.setRequestAction(DataParser.parse(String.class, map.get(AssetDepreciationVOMeta.REQUEST_ACTION)));
			...
			this.setDataOrigin(DataParser.parse(String.class, map.get(AssetDepreciationVOMeta.DATA_ORIGIN)));
			this.setQueryLogic(DataParser.parse(String.class, map.get(AssetDepreciationVOMeta.QUERY_LOGIC)));
			...
			try {
				...
				this.setFlowConf( (String)map.get(AssetDepreciationVOMeta.FLOW_CONF));
				...
				this.setRequestAction( (String)map.get(AssetDepreciationVOMeta.REQUEST_ACTION));
				...
				this.setDataOrigin( (String)map.get(AssetDepreciationVOMeta.DATA_ORIGIN));
				this.setQueryLogic( (String)map.get(AssetDepreciationVOMeta.QUERY_LOGIC));
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setFlowConf(DataParser.parse(String.class, r.getValue(AssetDepreciationVOMeta.FLOW_CONF)));
			...
			try {
				...
				this.setFlowConf( (String)r.getValue(AssetDepreciationVOMeta.FLOW_CONF));
