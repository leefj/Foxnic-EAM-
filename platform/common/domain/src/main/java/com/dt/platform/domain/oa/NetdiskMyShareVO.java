...
@ApiModel(description = "我的分享VO类型 ; 我的分享 , 数据表 oa_netdisk_my_share 的通用VO类型" , parent = NetdiskMyShare.class)
public class NetdiskMyShareVO extends NetdiskMyShare {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public NetdiskMyShareVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public NetdiskMyShareVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return NetdiskMyShareVO , 转换好的 NetdiskMyShareVO 对象
	*/
	@Transient
	 ...
	 * @return NetdiskMyShareVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	public NetdiskMyShareVO duplicate(boolean all) {
		com.dt.platform.domain.oa.meta.NetdiskMyShareVOMeta.$$proxy$$ inst = new com.dt.platform.domain.oa.meta.NetdiskMyShareVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public NetdiskMyShareVO clone(boolean deep) {
		return EntityContext.clone(NetdiskMyShareVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 NetdiskMyShareVO
	 * @param netdiskMyShareMap 包含实体信息的 Map 对象
	 * @return NetdiskMyShareVO , 转换好的的 NetdiskMyShare 对象
	*/
	@Transient
	public static NetdiskMyShareVO createFrom(Map<String,Object> netdiskMyShareMap) {
		if(netdiskMyShareMap==null) return null;
		NetdiskMyShareVO vo = create();
		EntityContext.copyProperties(vo,netdiskMyShareMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 NetdiskMyShareVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return NetdiskMyShareVO , 转换好的的 NetdiskMyShare 对象
	*/
	@Transient
	public static NetdiskMyShareVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 NetdiskMyShareVO，等同于 new
	 * @return NetdiskMyShareVO 对象
	*/
	@Transient
	public static NetdiskMyShareVO create() {
		return new com.dt.platform.domain.oa.meta.NetdiskMyShareVOMeta.$$proxy$$();
	}
	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			this.setUpdateTime(DataParser.parse(Date.class, map.get(NetdiskMyShareVOMeta.UPDATE_TIME)));
			...
			this.setFileUrl(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.FILE_URL)));
			this.setId(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.ID)));
			this.setFileId(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.FILE_ID)));
			this.setStatus(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.STATUS)));
			// others
			this.setSearchField(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.SEARCH_FIELD)));
			this.setRequestAction(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.REQUEST_ACTION)));
			this.setFuzzyField(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.FUZZY_FIELD)));
			this.setPageSize(DataParser.parse(Integer.class, map.get(NetdiskMyShareVOMeta.PAGE_SIZE)));
			this.setNetdiskOriginFile(DataParser.parse(NetdiskOriginFile.class, map.get(NetdiskMyShareVOMeta.NETDISK_ORIGIN_FILE)));
			this.setNetdiskFile(DataParser.parse(NetdiskFile.class, map.get(NetdiskMyShareVOMeta.NETDISK_FILE)));
			this.setOwnerUser(DataParser.parse(Employee.class, map.get(NetdiskMyShareVOMeta.OWNER_USER)));
			this.setPageIndex(DataParser.parse(Integer.class, map.get(NetdiskMyShareVOMeta.PAGE_INDEX)));
			this.setSortType(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.SORT_TYPE)));
			this.setSortField(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.SORT_FIELD)));
			this.setDataOrigin(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.DATA_ORIGIN)));
			this.setQueryLogic(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.QUERY_LOGIC)));
			this.setSearchValue(DataParser.parse(String.class, map.get(NetdiskMyShareVOMeta.SEARCH_VALUE)));
			return true;
		} else {
			try {
				this.setUpdateTime( (Date)map.get(NetdiskMyShareVOMeta.UPDATE_TIME));
				...
				this.setFileUrl( (String)map.get(NetdiskMyShareVOMeta.FILE_URL));
				this.setId( (String)map.get(NetdiskMyShareVOMeta.ID));
				this.setFileId( (String)map.get(NetdiskMyShareVOMeta.FILE_ID));
				this.setStatus( (String)map.get(NetdiskMyShareVOMeta.STATUS));
				// others
				this.setSearchField( (String)map.get(NetdiskMyShareVOMeta.SEARCH_FIELD));
				this.setRequestAction( (String)map.get(NetdiskMyShareVOMeta.REQUEST_ACTION));
				this.setFuzzyField( (String)map.get(NetdiskMyShareVOMeta.FUZZY_FIELD));
				this.setPageSize( (Integer)map.get(NetdiskMyShareVOMeta.PAGE_SIZE));
				this.setNetdiskOriginFile( (NetdiskOriginFile)map.get(NetdiskMyShareVOMeta.NETDISK_ORIGIN_FILE));
				this.setNetdiskFile( (NetdiskFile)map.get(NetdiskMyShareVOMeta.NETDISK_FILE));
				this.setOwnerUser( (Employee)map.get(NetdiskMyShareVOMeta.OWNER_USER));
				this.setPageIndex( (Integer)map.get(NetdiskMyShareVOMeta.PAGE_INDEX));
				this.setSortType( (String)map.get(NetdiskMyShareVOMeta.SORT_TYPE));
				this.setSortField( (String)map.get(NetdiskMyShareVOMeta.SORT_FIELD));
				this.setDataOrigin( (String)map.get(NetdiskMyShareVOMeta.DATA_ORIGIN));
				this.setQueryLogic( (String)map.get(NetdiskMyShareVOMeta.QUERY_LOGIC));
				this.setSearchValue( (String)map.get(NetdiskMyShareVOMeta.SEARCH_VALUE));
				return true;
			} catch (Exception e) {
				return false;
			}
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			this.setUpdateTime(DataParser.parse(Date.class, r.getValue(NetdiskMyShareVOMeta.UPDATE_TIME)));
			...
			this.setFileUrl(DataParser.parse(String.class, r.getValue(NetdiskMyShareVOMeta.FILE_URL)));
			this.setId(DataParser.parse(String.class, r.getValue(NetdiskMyShareVOMeta.ID)));
			this.setFileId(DataParser.parse(String.class, r.getValue(NetdiskMyShareVOMeta.FILE_ID)));
			this.setStatus(DataParser.parse(String.class, r.getValue(NetdiskMyShareVOMeta.STATUS)));
			return true;
		} else {
			try {
				this.setUpdateTime( (Date)r.getValue(NetdiskMyShareVOMeta.UPDATE_TIME));
				...
				this.setFileUrl( (String)r.getValue(NetdiskMyShareVOMeta.FILE_URL));
				this.setId( (String)r.getValue(NetdiskMyShareVOMeta.ID));
				this.setFileId( (String)r.getValue(NetdiskMyShareVOMeta.FILE_ID));
				this.setStatus( (String)r.getValue(NetdiskMyShareVOMeta.STATUS));
				return true;
			} catch (Exception e) {
				return false;
			}
