	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setStatus(DataParser.parse(String.class, r.getValue(RepairOrderActVOMeta.STATUS)));
			return true;
		} else {
			try {
				...
				this.setStatus( (String)r.getValue(RepairOrderActVOMeta.STATUS));
				return true;
			} catch (Exception e) {
				return false;
			}
