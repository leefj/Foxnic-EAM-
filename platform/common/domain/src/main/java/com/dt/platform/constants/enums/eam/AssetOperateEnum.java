...
public enum AssetOperateEnum implements CodeTextEnum {
    ...
    DIRECT_UPDATE_ASSET("direct_update_asset" , "EAM_资产更新"),
    ...
    EAM_ASSET_STOCK_GOODS_USE(CodeModuleEnum.EAM_ASSET_STOCK_GOODS_USE.code(), CodeModuleEnum.EAM_ASSET_STOCK_GOODS_USE.text()),
    ...
    EAM_ASSET_PART_GOODS_USE(CodeModuleEnum.EAM_ASSET_PART_GOODS_USE.code(), CodeModuleEnum.EAM_ASSET_PART_GOODS_USE.text()),
    //备件维修调出
    ...
    EAM_ASSET_CONSUMABLES_GOODS_USE(CodeModuleEnum.EAM_ASSET_CONSUMABLES_GOODS_USE.code(), CodeModuleEnum.EAM_ASSET_CONSUMABLES_GOODS_USE.text()),
