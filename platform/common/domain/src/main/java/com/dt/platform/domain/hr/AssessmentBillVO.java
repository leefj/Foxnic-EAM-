...
@ApiModel(description = "考核单据VO类型 ; 考核单据 , 数据表 hr_assessment_bill 的通用VO类型" , parent = AssessmentBill.class)
public class AssessmentBillVO extends AssessmentBill {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssessmentBillVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public AssessmentBillVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return AssessmentBillVO , 转换好的 AssessmentBillVO 对象
	*/
	@Transient
	 ...
	 * @return AssessmentBillVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	@Transient
	public AssessmentBillVO clone(boolean deep) {
		return EntityContext.clone(AssessmentBillVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 AssessmentBillVO
	 * @param assessmentBillMap 包含实体信息的 Map 对象
	 * @return AssessmentBillVO , 转换好的的 AssessmentBill 对象
	*/
	@Transient
	public static AssessmentBillVO createFrom(Map<String,Object> assessmentBillMap) {
		if(assessmentBillMap==null) return null;
		AssessmentBillVO vo = create();
		EntityContext.copyProperties(vo,assessmentBillMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 AssessmentBillVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return AssessmentBillVO , 转换好的的 AssessmentBill 对象
	*/
	@Transient
	public static AssessmentBillVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 AssessmentBillVO，等同于 new
	 * @return AssessmentBillVO 对象
	*/
	@Transient
	public static AssessmentBillVO create() {
		return new com.dt.platform.domain.hr.meta.AssessmentBillVOMeta.$$proxy$$();
	}
