...
public class SalaryDetail extends Entity {
	...
	*/
	@Id
	@ApiModelProperty(required = true,value="主键" , notes = "主键" , example = "803810022965379072")
	private String id;
	...
	*/
	 ...
	 * 银行名称：银行名称
	*/
	@ApiModelProperty(required = false,value="银行名称" , notes = "银行名称" , example = "中国银行")
	private String bank;
	
	/**
	 * 银行账户：银行账户
	*/
	@ApiModelProperty(required = false,value="银行账户" , notes = "银行账户" , example = "123456789098765")
	...
	*/
	 ...
	 * 动作：动作
	*/
	@ApiModelProperty(required = false,value="动作" , notes = "动作" , example = "803739844835540992")
	private String actionId;
	
	/**
	 * 状态：状态
	*/
	@ApiModelProperty(required = false,value="状态" , notes = "状态" , example = "cal_finish")
	private String status;
	
	/**
	 * 工资：工资
	*/
	@ApiModelProperty(required = false,value="工资" , notes = "工资" , example = "13800.00")
	private BigDecimal totalAmount;
	
	/**
	 * 应发金额：应发金额
	*/
	@ApiModelProperty(required = false,value="应发金额" , notes = "应发金额" , example = "13800.00")
	private BigDecimal payAmount;
	
	/**
	 * 实发金额：员工
	*/
	@ApiModelProperty(required = false,value="实发金额" , notes = "员工" , example = "10930.13")
	private BigDecimal issuedAmount;
	
	/**
	 * 基本工资：基本工资
	*/
	@ApiModelProperty(required = false,value="基本工资" , notes = "基本工资" , example = "6000.00")
	private BigDecimal baseSalary;
	
	/**
	 * 岗位工资：岗位工资
	*/
	@ApiModelProperty(required = false,value="岗位工资" , notes = "岗位工资" , example = "5000.00")
	private BigDecimal postSalary;
	
	/**
	 * 工龄工资：工龄工资
	*/
	@ApiModelProperty(required = false,value="工龄工资" , notes = "工龄工资" , example = "2000.00")
	private BigDecimal workingYearsSalary;
	
	/**
	 * 固定补贴：固定补贴
	*/
	@ApiModelProperty(required = false,value="固定补贴" , notes = "固定补贴" , example = "200.00")
	private BigDecimal fixedSalary;
	
	/**
	 * 绩效补贴：绩效补贴
	*/
	@ApiModelProperty(required = false,value="绩效补贴" , notes = "绩效补贴" , example = "100.00")
	...
	*/
	 ...
	 * 通讯补贴：通讯补贴
	*/
	@ApiModelProperty(required = false,value="通讯补贴" , notes = "通讯补贴" , example = "100.00")
	private BigDecimal communicationSalary;
	
	/**
	 * 交通补贴：交通补贴
	*/
	@ApiModelProperty(required = false,value="交通补贴" , notes = "交通补贴" , example = "100.00")
	private BigDecimal trafficSalary;
	
	/**
	 * 住房补贴：住房补贴
	*/
	@ApiModelProperty(required = false,value="住房补贴" , notes = "住房补贴" , example = "100.00")
	...
	*/
	 ...
	 * 其他补贴：其他补贴
	*/
	@ApiModelProperty(required = false,value="其他补贴" , notes = "其他补贴" , example = "100.00")
	private BigDecimal otherSalary;
	
	/**
	 * 提成工资：提成工资
	*/
	@ApiModelProperty(required = false,value="提成工资" , notes = "提成工资" , example = "100.00")
	private BigDecimal commissionSalary;
	
	/**
	 * 计时工资：计时工资
	*/
	@ApiModelProperty(required = false,value="计时工资" , notes = "计时工资")
	private BigDecimal unitTimeSalary;
	
	/**
	 * 计件工资：计件工资
	*/
	@ApiModelProperty(required = false,value="计件工资" , notes = "计件工资")
	private BigDecimal unitNumberSalary;
	
	/**
	 * 处罚金额：处罚金额
	*/
	@ApiModelProperty(required = false,value="处罚金额" , notes = "处罚金额" , example = "0.00")
	private BigDecimal punishSalary;
	
	/**
	 * 每日工资：每日工资
	*/
	@ApiModelProperty(required = false,value="每日工资" , notes = "每日工资" , example = "634.48")
	...
	*/
	 ...
	 * 个人所得税：个人所得税
	*/
	@ApiModelProperty(required = false,value="个人所得税" , notes = "个人所得税" , example = "92.24")
	private BigDecimal ptGrsds;
	
	/**
	 * 抵扣基数：抵扣基数
	*/
	@ApiModelProperty(required = false,value="抵扣基数" , notes = "抵扣基数" , example = "5000.00")
	private BigDecimal ptDkjs;
	
	/**
	 * 绩效评级：绩效评级
	*/
	@ApiModelProperty(required = false,value="绩效评级" , notes = "绩效评级")
	private String jxpjLevel;
	
	/**
	 * 加班时长：加班时长
	*/
	@ApiModelProperty(required = false,value="加班时长" , notes = "加班时长" , example = "0.00")
	private BigDecimal workOvertimeHCnt;
	
	/**
	 * 迟到次数：迟到次数
	*/
	@ApiModelProperty(required = false,value="迟到次数" , notes = "迟到次数" , example = "0.00")
	private BigDecimal lateCnt;
	
	/**
	 * 出差次数：出差次数
	*/
	@ApiModelProperty(required = false,value="出差次数" , notes = "出差次数" , example = "0.00")
	private BigDecimal businessTripsCnt;
	
	/**
	 * 事假天数：事假天数
	*/
	@ApiModelProperty(required = false,value="事假天数" , notes = "事假天数" , example = "0.50")
	private BigDecimal personalLeaveCnt;
	
	/**
	 * 年假天数：年假天数
	*/
	@ApiModelProperty(required = false,value="年假天数" , notes = "年假天数" , example = "0.00")
	private BigDecimal annualLeaveCnt;
	
	/**
	 * 工作天数：工作天数
	*/
	@ApiModelProperty(required = false,value="工作天数" , notes = "工作天数" , example = "0.00")
	private BigDecimal workDayCnt;
	
	/**
	 * 税率：税率
	*/
	@ApiModelProperty(required = false,value="税率" , notes = "税率" , example = "0.10")
	private BigDecimal ptSlPct;
	
	/**
	 * 住房公积金基数：住房公积金基数
	*/
	@ApiModelProperty(required = false,value="住房公积金基数" , notes = "住房公积金基数" , example = "12345.00")
	private BigDecimal welfareZfgjjBase;
	
	/**
	 * 住房公积金个人：住房公积金个人
	*/
	@ApiModelProperty(required = false,value="住房公积金个人" , notes = "住房公积金个人" , example = "12.00")
	private BigDecimal welfareZfgjjPerson;
	
	/**
	 * 住房公积金公司：住房公积金公司
	*/
	@ApiModelProperty(required = false,value="住房公积金公司" , notes = "住房公积金公司" , example = "12.00")
	private BigDecimal welfareZfgjjCompany;
	
	/**
	 * 住房缴费：住房缴费
	*/
	@ApiModelProperty(required = false,value="住房缴费" , notes = "住房缴费" , example = "1481.40")
	private BigDecimal welfareZfgjjValue;
	
	/**
	 * 养老保险基数：养老保险基数
	*/
	@ApiModelProperty(required = false,value="养老保险基数" , notes = "养老保险基数" , example = "12345.00")
	private BigDecimal welfaerYlbxBase;
	
	/**
	 * 养老保险个人：养老保险个人
	*/
	@ApiModelProperty(required = false,value="养老保险个人" , notes = "养老保险个人" , example = "8.00")
	private BigDecimal welfaerYlbxPerson;
	
	/**
	 * 养老保险公司：养老保险公司
	*/
	@ApiModelProperty(required = false,value="养老保险公司" , notes = "养老保险公司" , example = "14.00")
	private BigDecimal welfaerYlbxCompany;
	
	/**
	 * 养老缴费：养老缴费
	*/
	@ApiModelProperty(required = false,value="养老缴费" , notes = "养老缴费" , example = "987.60")
	private BigDecimal welfaerYlbxValue;
	
	/**
	 * 工伤保险基数：工伤保险基数
	*/
	@ApiModelProperty(required = false,value="工伤保险基数" , notes = "工伤保险基数" , example = "12345.00")
	...
	*/
	 ...
	 * 工伤保险公司：工伤保险公司
	*/
	@ApiModelProperty(required = false,value="工伤保险公司" , notes = "工伤保险公司" , example = "0.25")
	private BigDecimal welfaerGsbxCompany;
	
	/**
	 * 工伤缴费：工伤缴费
	*/
	@ApiModelProperty(required = false,value="工伤缴费" , notes = "工伤缴费" , example = "0.00")
	private BigDecimal welfaerGsbxValue;
	
	/**
	 * 医疗保险基数：医疗保险基数
	*/
	@ApiModelProperty(required = false,value="医疗保险基数" , notes = "医疗保险基数" , example = "12345.00")
	private BigDecimal welfaerYrbxBase;
	
	/**
	 * 医疗保险个人：医疗保险个人
	*/
	@ApiModelProperty(required = false,value="医疗保险个人" , notes = "医疗保险个人" , example = "2.00")
	private BigDecimal welfaerYrbxPerson;
	
	/**
	 * 医疗保险公司：医疗保险公司
	*/
	@ApiModelProperty(required = false,value="医疗保险公司" , notes = "医疗保险公司" , example = "11.70")
	private BigDecimal welfaerYrbxCompany;
	
	/**
	 * 医疗缴费：医疗缴费
	*/
	@ApiModelProperty(required = false,value="医疗缴费" , notes = "医疗缴费" , example = "246.90")
	private BigDecimal welfaerYrbxValue;
	
	/**
	 * 生育保险基数：生育保险基数
	*/
	@ApiModelProperty(required = false,value="生育保险基数" , notes = "生育保险基数" , example = "12345.00")
	...
	*/
	 ...
	 * 生育缴费：生育缴费
	*/
	@ApiModelProperty(required = false,value="生育缴费" , notes = "生育缴费" , example = "0.00")
	private BigDecimal welfaerSybxValue;
	
	/**
	 * 失业保险基数：失业保险基数
	*/
	@ApiModelProperty(required = false,value="失业保险基数" , notes = "失业保险基数" , example = "12345.00")
	private BigDecimal welfaerSyebxBase;
	
	/**
	 * 失业保险个人：失业保险个人
	*/
	@ApiModelProperty(required = false,value="失业保险个人" , notes = "失业保险个人" , example = "0.50")
	private BigDecimal welfaerSyebxPerson;
	
	/**
	 * 失业保险公司：失业保险公司
	*/
	@ApiModelProperty(required = false,value="失业保险公司" , notes = "失业保险公司" , example = "0.50")
	private BigDecimal welfaerSyebxCompany;
	
	/**
	 * 失业缴费：失业缴费
	*/
	@ApiModelProperty(required = false,value="失业缴费" , notes = "失业缴费" , example = "61.73")
	private BigDecimal welfaerSyebxValue;
	
	/**
	 * 个人缴费总计：个人缴费总计
	*/
	@ApiModelProperty(required = false,value="个人缴费总计" , notes = "个人缴费总计" , example = "3000.00")
	private BigDecimal welfaerPersonValueTotal;
	
	/**
	 * 专项抵扣启用：专项抵扣启用
	*/
	@ApiModelProperty(required = false,value="专项抵扣启用" , notes = "专项抵扣启用")
	private String personalStatus;
	
	/**
	 * 子女教育：子女教育
	*/
	@ApiModelProperty(required = false,value="子女教育" , notes = "子女教育" , example = "1000.00")
	...
	*/
	 ...
	 * 大病医疗：大病医疗
	*/
	@ApiModelProperty(required = false,value="大病医疗" , notes = "大病医疗" , example = "0.00")
	...
	*/
	 ...
	 * 赡养老人：赡养老人
	*/
	@ApiModelProperty(required = false,value="赡养老人" , notes = "赡养老人" , example = "2000.00")
	...
	*/
	 ...
	 * 专项扣除总计：专项扣除总计
	*/
	@ApiModelProperty(required = false,value="专项扣除总计" , notes = "专项扣除总计" , example = "2777.63")
	private BigDecimal personalTaxTotal;
	...
	*/
	 ...
	 * 操作说明：操作说明
	*/
	@ApiModelProperty(required = false,value="操作说明" , notes = "操作说明" , example = "计算完成")
	...
	*/
	 ...
	 * 创建时间：创建时间
	*/
	@ApiModelProperty(required = false,value="创建时间" , notes = "创建时间" , example = "2024-01-28 02:14:04")
	...
	*/
	 ...
	 * 修改时间：修改时间
	*/
	@ApiModelProperty(required = false,value="修改时间" , notes = "修改时间" , example = "2024-01-28 02:14:04")
	...
	*/
	@ApiModelProperty(required = false,value="salaryAction" , notes = "salaryAction")
	private SalaryAction salaryAction;
	
	/**
	 * extBank：extBank
	*/
	@ApiModelProperty(required = false,value="extBank" , notes = "extBank")
	private String extBank;
	
	/**
	 * extBankAccount：extBankAccount
	*/
	@ApiModelProperty(required = false,value="extBankAccount" , notes = "extBankAccount")
	...
	*/
	 ...
	 * @return 计时工资
	*/
	public BigDecimal getUnitTimeSalary() {
		return unitTimeSalary;
	}
	...
	*/
	public SalaryDetail setUnitTimeSalary(BigDecimal unitTimeSalary) {
		this.unitTimeSalary=unitTimeSalary;
		return this;
	}
	 ...
	 * @return 计件工资
	*/
	public BigDecimal getUnitNumberSalary() {
		return unitNumberSalary;
	}
	...
	*/
	public SalaryDetail setUnitNumberSalary(BigDecimal unitNumberSalary) {
		this.unitNumberSalary=unitNumberSalary;
		return this;
	}
	 ...
	 * @return 处罚金额
	*/
	public BigDecimal getPunishSalary() {
		return punishSalary;
	}
	...
	*/
	 ...
	 * @return 加班时长
	*/
	public BigDecimal getWorkOvertimeHCnt() {
		return workOvertimeHCnt;
	}
	...
	*/
	public SalaryDetail setWorkOvertimeHCnt(BigDecimal workOvertimeHCnt) {
		this.workOvertimeHCnt=workOvertimeHCnt;
		return this;
	}
	...
	*/
	 ...
	 * @return 出差次数
	*/
	public BigDecimal getBusinessTripsCnt() {
		return businessTripsCnt;
	}
	...
	*/
	public SalaryDetail setBusinessTripsCnt(BigDecimal businessTripsCnt) {
		this.businessTripsCnt=businessTripsCnt;
		return this;
	}
	 ...
	 * @return 事假天数
	*/
	public BigDecimal getPersonalLeaveCnt() {
		return personalLeaveCnt;
	}
	...
	*/
	public SalaryDetail setPersonalLeaveCnt(BigDecimal personalLeaveCnt) {
		this.personalLeaveCnt=personalLeaveCnt;
		return this;
	}
	 ...
	 * @return 年假天数
	*/
	public BigDecimal getAnnualLeaveCnt() {
	...
	*/
	 ...
	 * @return 工作天数
	*/
	public BigDecimal getWorkDayCnt() {
		return workDayCnt;
	}
	...
	*/
	 ...
	 * @return 住房缴费
	*/
	public BigDecimal getWelfareZfgjjValue() {
		return welfareZfgjjValue;
	}
	...
	*/
	public SalaryDetail setWelfareZfgjjValue(BigDecimal welfareZfgjjValue) {
		this.welfareZfgjjValue=welfareZfgjjValue;
		return this;
	}
	...
	*/
	 ...
	 * @return 养老缴费
	*/
	public BigDecimal getWelfaerYlbxValue() {
		return welfaerYlbxValue;
	}
	...
	*/
	public SalaryDetail setWelfaerYlbxValue(BigDecimal welfaerYlbxValue) {
		this.welfaerYlbxValue=welfaerYlbxValue;
		return this;
	}
	...
	*/
	 ...
	 * @return 工伤缴费
	*/
	public BigDecimal getWelfaerGsbxValue() {
		return welfaerGsbxValue;
	}
	...
	*/
	public SalaryDetail setWelfaerGsbxValue(BigDecimal welfaerGsbxValue) {
		this.welfaerGsbxValue=welfaerGsbxValue;
		return this;
	}
	...
	*/
	 ...
	 * @return 医疗缴费
	*/
	public BigDecimal getWelfaerYrbxValue() {
		return welfaerYrbxValue;
	}
	...
	*/
	public SalaryDetail setWelfaerYrbxValue(BigDecimal welfaerYrbxValue) {
		this.welfaerYrbxValue=welfaerYrbxValue;
		return this;
	}
	...
	*/
	 ...
	 * @return 生育缴费
	*/
	public BigDecimal getWelfaerSybxValue() {
		return welfaerSybxValue;
	}
	...
	*/
	public SalaryDetail setWelfaerSybxValue(BigDecimal welfaerSybxValue) {
		this.welfaerSybxValue=welfaerSybxValue;
		return this;
	}
	...
	*/
	 ...
	 * @return 失业缴费
	*/
	public BigDecimal getWelfaerSyebxValue() {
		return welfaerSyebxValue;
	}
	...
	*/
	public SalaryDetail setWelfaerSyebxValue(BigDecimal welfaerSyebxValue) {
		this.welfaerSyebxValue=welfaerSyebxValue;
		return this;
	}
	 ...
	 * @return 个人缴费总计
	*/
	public BigDecimal getWelfaerPersonValueTotal() {
		return welfaerPersonValueTotal;
	}
	...
	*/
	public SalaryDetail setWelfaerPersonValueTotal(BigDecimal welfaerPersonValueTotal) {
		this.welfaerPersonValueTotal=welfaerPersonValueTotal;
		return this;
	}
	...
	*/
	 ...
	 * @return salaryAction
	*/
	public SalaryAction getSalaryAction() {
		return salaryAction;
	}
	...
	*/
	...
	/**
	 * 获得 extBankAccount<br>
	 * extBankAccount
	 * @return extBankAccount
	*/
	public String getExtBankAccount() {
		return extBankAccount;
	}
	...
	*/
	public SalaryDetail setExtBankAccount(String extBankAccount) {
		this.extBankAccount=extBankAccount;
		return this;
	}
	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setPersonalTaxTotal(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.PERSONAL_TAX_TOTAL)));
			this.setWorkOvertimeHCnt(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WORK_OVERTIME_H_CNT)));
			...
			this.setWelfaerPersonValueTotal(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_PERSON_VALUE_TOTAL)));
			...
			this.setDaySalary(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.DAY_SALARY)));
			...
			this.setBank(DataParser.parse(String.class, map.get(SalaryDetailMeta.BANK)));
			...
			this.setWelfaerSyebxValue(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_SYEBX_VALUE)));
			...
			this.setWelfaerYlbxValue(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_YLBX_VALUE)));
			this.setTrafficSalary(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.TRAFFIC_SALARY)));
			this.setWelfareZfgjjValue(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFARE_ZFGJJ_VALUE)));
			this.setWelfaerYrbxCompany(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_YRBX_COMPANY)));
			this.setBankAccount(DataParser.parse(String.class, map.get(SalaryDetailMeta.BANK_ACCOUNT)));
			...
			this.setPersonalStatus(DataParser.parse(String.class, map.get(SalaryDetailMeta.PERSONAL_STATUS)));
			this.setWelfaerSybxCompany(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_SYBX_COMPANY)));
			this.setUnitTimeSalary(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.UNIT_TIME_SALARY)));
			this.setWelfaerYrbxBase(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_YRBX_BASE)));
			this.setWelfaerSyebxBase(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_SYEBX_BASE)));
			...
			this.setActionId(DataParser.parse(String.class, map.get(SalaryDetailMeta.ACTION_ID)));
			...
			this.setTplId(DataParser.parse(String.class, map.get(SalaryDetailMeta.TPL_ID)));
			this.setOtherSalary(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.OTHER_SALARY)));
			this.setDeductPersonalTaxRed(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.DEDUCT_PERSONAL_TAX_RED)));
			this.setCommissionSalary(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.COMMISSION_SALARY)));
			this.setJobNumber(DataParser.parse(String.class, map.get(SalaryDetailMeta.JOB_NUMBER)));
			this.setWelfaerGsbxValue(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_GSBX_VALUE)));
			...
			this.setWelfaerSyebxPerson(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_SYEBX_PERSON)));
			this.setJxpjLevel(DataParser.parse(String.class, map.get(SalaryDetailMeta.JXPJ_LEVEL)));
			this.setWelfaerSybxPerson(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_SYBX_PERSON)));
			this.setBusinessTripsCnt(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.BUSINESS_TRIPS_CNT)));
			this.setPunishSalary(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.PUNISH_SALARY)));
			...
			this.setOrgId(DataParser.parse(String.class, map.get(SalaryDetailMeta.ORG_ID)));
			...
			this.setWelfaerYrbxValue(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_YRBX_VALUE)));
			this.setWelfareZfgjjCompany(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFARE_ZFGJJ_COMPANY)));
			this.setLateCnt(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.LATE_CNT)));
			this.setWelfaerGsbxCompany(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_GSBX_COMPANY)));
			this.setWelfaerSyebxCompany(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_SYEBX_COMPANY)));
			...
			this.setOperMsg(DataParser.parse(String.class, map.get(SalaryDetailMeta.OPER_MSG)));
			this.setPersonalTaxZfzj(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.PERSONAL_TAX_ZFZJ)));
			this.setBatchCode(DataParser.parse(String.class, map.get(SalaryDetailMeta.BATCH_CODE)));
			...
			this.setPersonalLeaveCnt(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.PERSONAL_LEAVE_CNT)));
			...
			this.setWorkDayCnt(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WORK_DAY_CNT)));
			this.setAnnualLeaveCnt(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.ANNUAL_LEAVE_CNT)));
			this.setUnitNumberSalary(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.UNIT_NUMBER_SALARY)));
			...
			this.setWelfaerSybxValue(DataParser.parse(BigDecimal.class, map.get(SalaryDetailMeta.WELFAER_SYBX_VALUE)));
			// others
			this.setExtBank(DataParser.parse(String.class, map.get(SalaryDetailMeta.EXT_BANK)));
			this.setSalaryTpl(DataParser.parse(SalaryTpl.class, map.get(SalaryDetailMeta.SALARY_TPL)));
			...
			try {
				...
				this.setPersonalTaxTotal( (BigDecimal)map.get(SalaryDetailMeta.PERSONAL_TAX_TOTAL));
				this.setWorkOvertimeHCnt( (BigDecimal)map.get(SalaryDetailMeta.WORK_OVERTIME_H_CNT));
				...
				this.setWelfaerPersonValueTotal( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_PERSON_VALUE_TOTAL));
				...
				this.setDaySalary( (BigDecimal)map.get(SalaryDetailMeta.DAY_SALARY));
				...
				this.setBank( (String)map.get(SalaryDetailMeta.BANK));
				...
				this.setWelfaerSyebxValue( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_SYEBX_VALUE));
				...
				this.setWelfaerYlbxValue( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_YLBX_VALUE));
				this.setTrafficSalary( (BigDecimal)map.get(SalaryDetailMeta.TRAFFIC_SALARY));
				this.setWelfareZfgjjValue( (BigDecimal)map.get(SalaryDetailMeta.WELFARE_ZFGJJ_VALUE));
				this.setWelfaerYrbxCompany( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_YRBX_COMPANY));
				this.setBankAccount( (String)map.get(SalaryDetailMeta.BANK_ACCOUNT));
				...
				this.setPersonalStatus( (String)map.get(SalaryDetailMeta.PERSONAL_STATUS));
				this.setWelfaerSybxCompany( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_SYBX_COMPANY));
				this.setUnitTimeSalary( (BigDecimal)map.get(SalaryDetailMeta.UNIT_TIME_SALARY));
				this.setWelfaerYrbxBase( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_YRBX_BASE));
				this.setWelfaerSyebxBase( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_SYEBX_BASE));
				...
				this.setActionId( (String)map.get(SalaryDetailMeta.ACTION_ID));
				...
				this.setTplId( (String)map.get(SalaryDetailMeta.TPL_ID));
				this.setOtherSalary( (BigDecimal)map.get(SalaryDetailMeta.OTHER_SALARY));
				this.setDeductPersonalTaxRed( (BigDecimal)map.get(SalaryDetailMeta.DEDUCT_PERSONAL_TAX_RED));
				this.setCommissionSalary( (BigDecimal)map.get(SalaryDetailMeta.COMMISSION_SALARY));
				this.setJobNumber( (String)map.get(SalaryDetailMeta.JOB_NUMBER));
				this.setWelfaerGsbxValue( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_GSBX_VALUE));
				...
				this.setWelfaerSyebxPerson( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_SYEBX_PERSON));
				this.setJxpjLevel( (String)map.get(SalaryDetailMeta.JXPJ_LEVEL));
				this.setWelfaerSybxPerson( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_SYBX_PERSON));
				this.setBusinessTripsCnt( (BigDecimal)map.get(SalaryDetailMeta.BUSINESS_TRIPS_CNT));
				this.setPunishSalary( (BigDecimal)map.get(SalaryDetailMeta.PUNISH_SALARY));
				...
				this.setOrgId( (String)map.get(SalaryDetailMeta.ORG_ID));
				...
				this.setWelfaerYrbxValue( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_YRBX_VALUE));
				this.setWelfareZfgjjCompany( (BigDecimal)map.get(SalaryDetailMeta.WELFARE_ZFGJJ_COMPANY));
				this.setLateCnt( (BigDecimal)map.get(SalaryDetailMeta.LATE_CNT));
				this.setWelfaerGsbxCompany( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_GSBX_COMPANY));
				this.setWelfaerSyebxCompany( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_SYEBX_COMPANY));
				...
				this.setOperMsg( (String)map.get(SalaryDetailMeta.OPER_MSG));
				this.setPersonalTaxZfzj( (BigDecimal)map.get(SalaryDetailMeta.PERSONAL_TAX_ZFZJ));
				this.setBatchCode( (String)map.get(SalaryDetailMeta.BATCH_CODE));
				...
				this.setPersonalLeaveCnt( (BigDecimal)map.get(SalaryDetailMeta.PERSONAL_LEAVE_CNT));
				...
				this.setWorkDayCnt( (BigDecimal)map.get(SalaryDetailMeta.WORK_DAY_CNT));
				this.setAnnualLeaveCnt( (BigDecimal)map.get(SalaryDetailMeta.ANNUAL_LEAVE_CNT));
				this.setUnitNumberSalary( (BigDecimal)map.get(SalaryDetailMeta.UNIT_NUMBER_SALARY));
				...
				this.setWelfaerSybxValue( (BigDecimal)map.get(SalaryDetailMeta.WELFAER_SYBX_VALUE));
				// others
				this.setExtBank( (String)map.get(SalaryDetailMeta.EXT_BANK));
				this.setSalaryTpl( (SalaryTpl)map.get(SalaryDetailMeta.SALARY_TPL));
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setPersonalTaxTotal(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.PERSONAL_TAX_TOTAL)));
			this.setWorkOvertimeHCnt(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WORK_OVERTIME_H_CNT)));
			...
			this.setWelfaerPersonValueTotal(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_PERSON_VALUE_TOTAL)));
			...
			this.setDaySalary(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.DAY_SALARY)));
			...
			this.setBank(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.BANK)));
			...
			this.setWelfaerSyebxValue(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_SYEBX_VALUE)));
			...
			this.setWelfaerYlbxValue(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_YLBX_VALUE)));
			this.setTrafficSalary(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.TRAFFIC_SALARY)));
			this.setWelfareZfgjjValue(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFARE_ZFGJJ_VALUE)));
			this.setWelfaerYrbxCompany(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_YRBX_COMPANY)));
			this.setBankAccount(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.BANK_ACCOUNT)));
			...
			this.setPersonalStatus(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.PERSONAL_STATUS)));
			this.setWelfaerSybxCompany(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_SYBX_COMPANY)));
			this.setUnitTimeSalary(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.UNIT_TIME_SALARY)));
			this.setWelfaerYrbxBase(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_YRBX_BASE)));
			this.setWelfaerSyebxBase(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_SYEBX_BASE)));
			...
			this.setActionId(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.ACTION_ID)));
			...
			this.setTplId(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.TPL_ID)));
			this.setOtherSalary(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.OTHER_SALARY)));
			this.setDeductPersonalTaxRed(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.DEDUCT_PERSONAL_TAX_RED)));
			this.setCommissionSalary(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.COMMISSION_SALARY)));
			this.setJobNumber(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.JOB_NUMBER)));
			this.setWelfaerGsbxValue(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_GSBX_VALUE)));
			...
			this.setWelfaerSyebxPerson(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_SYEBX_PERSON)));
			this.setJxpjLevel(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.JXPJ_LEVEL)));
			this.setWelfaerSybxPerson(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_SYBX_PERSON)));
			this.setBusinessTripsCnt(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.BUSINESS_TRIPS_CNT)));
			this.setPunishSalary(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.PUNISH_SALARY)));
			...
			this.setOrgId(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.ORG_ID)));
			...
			this.setWelfaerYrbxValue(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_YRBX_VALUE)));
			this.setWelfareZfgjjCompany(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFARE_ZFGJJ_COMPANY)));
			this.setLateCnt(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.LATE_CNT)));
			this.setWelfaerGsbxCompany(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_GSBX_COMPANY)));
			this.setWelfaerSyebxCompany(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_SYEBX_COMPANY)));
			...
			this.setOperMsg(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.OPER_MSG)));
			this.setPersonalTaxZfzj(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.PERSONAL_TAX_ZFZJ)));
			this.setBatchCode(DataParser.parse(String.class, r.getValue(SalaryDetailMeta.BATCH_CODE)));
			...
			this.setPersonalLeaveCnt(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.PERSONAL_LEAVE_CNT)));
			...
			this.setWorkDayCnt(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WORK_DAY_CNT)));
			this.setAnnualLeaveCnt(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.ANNUAL_LEAVE_CNT)));
			this.setUnitNumberSalary(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.UNIT_NUMBER_SALARY)));
			...
			this.setWelfaerSybxValue(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailMeta.WELFAER_SYBX_VALUE)));
			return true;
		} else {
			try {
				this.setHighTemperatureSalary( (BigDecimal)r.getValue(SalaryDetailMeta.HIGH_TEMPERATURE_SALARY));
				this.setPersonalTaxTotal( (BigDecimal)r.getValue(SalaryDetailMeta.PERSONAL_TAX_TOTAL));
				this.setWorkOvertimeHCnt( (BigDecimal)r.getValue(SalaryDetailMeta.WORK_OVERTIME_H_CNT));
				...
				this.setWelfaerPersonValueTotal( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_PERSON_VALUE_TOTAL));
				...
				this.setDaySalary( (BigDecimal)r.getValue(SalaryDetailMeta.DAY_SALARY));
				...
				this.setBank( (String)r.getValue(SalaryDetailMeta.BANK));
				...
				this.setWelfaerSyebxValue( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_SYEBX_VALUE));
				...
				this.setWelfaerYlbxValue( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_YLBX_VALUE));
				this.setTrafficSalary( (BigDecimal)r.getValue(SalaryDetailMeta.TRAFFIC_SALARY));
				this.setWelfareZfgjjValue( (BigDecimal)r.getValue(SalaryDetailMeta.WELFARE_ZFGJJ_VALUE));
				this.setWelfaerYrbxCompany( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_YRBX_COMPANY));
				this.setBankAccount( (String)r.getValue(SalaryDetailMeta.BANK_ACCOUNT));
				...
				this.setPersonalStatus( (String)r.getValue(SalaryDetailMeta.PERSONAL_STATUS));
				this.setWelfaerSybxCompany( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_SYBX_COMPANY));
				this.setUnitTimeSalary( (BigDecimal)r.getValue(SalaryDetailMeta.UNIT_TIME_SALARY));
				this.setWelfaerYrbxBase( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_YRBX_BASE));
				this.setWelfaerSyebxBase( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_SYEBX_BASE));
				...
				this.setActionId( (String)r.getValue(SalaryDetailMeta.ACTION_ID));
				...
				this.setTplId( (String)r.getValue(SalaryDetailMeta.TPL_ID));
				this.setOtherSalary( (BigDecimal)r.getValue(SalaryDetailMeta.OTHER_SALARY));
				this.setDeductPersonalTaxRed( (BigDecimal)r.getValue(SalaryDetailMeta.DEDUCT_PERSONAL_TAX_RED));
				this.setCommissionSalary( (BigDecimal)r.getValue(SalaryDetailMeta.COMMISSION_SALARY));
				this.setJobNumber( (String)r.getValue(SalaryDetailMeta.JOB_NUMBER));
				this.setWelfaerGsbxValue( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_GSBX_VALUE));
				...
				this.setWelfaerSyebxPerson( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_SYEBX_PERSON));
				this.setJxpjLevel( (String)r.getValue(SalaryDetailMeta.JXPJ_LEVEL));
				this.setWelfaerSybxPerson( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_SYBX_PERSON));
				this.setBusinessTripsCnt( (BigDecimal)r.getValue(SalaryDetailMeta.BUSINESS_TRIPS_CNT));
				this.setPunishSalary( (BigDecimal)r.getValue(SalaryDetailMeta.PUNISH_SALARY));
				...
				this.setOrgId( (String)r.getValue(SalaryDetailMeta.ORG_ID));
				...
				this.setWelfaerYrbxValue( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_YRBX_VALUE));
				this.setWelfareZfgjjCompany( (BigDecimal)r.getValue(SalaryDetailMeta.WELFARE_ZFGJJ_COMPANY));
				this.setLateCnt( (BigDecimal)r.getValue(SalaryDetailMeta.LATE_CNT));
				this.setWelfaerGsbxCompany( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_GSBX_COMPANY));
				this.setWelfaerSyebxCompany( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_SYEBX_COMPANY));
				...
				this.setOperMsg( (String)r.getValue(SalaryDetailMeta.OPER_MSG));
				this.setPersonalTaxZfzj( (BigDecimal)r.getValue(SalaryDetailMeta.PERSONAL_TAX_ZFZJ));
				this.setBatchCode( (String)r.getValue(SalaryDetailMeta.BATCH_CODE));
				...
				this.setPersonalLeaveCnt( (BigDecimal)r.getValue(SalaryDetailMeta.PERSONAL_LEAVE_CNT));
				...
				this.setWorkDayCnt( (BigDecimal)r.getValue(SalaryDetailMeta.WORK_DAY_CNT));
				this.setAnnualLeaveCnt( (BigDecimal)r.getValue(SalaryDetailMeta.ANNUAL_LEAVE_CNT));
				this.setUnitNumberSalary( (BigDecimal)r.getValue(SalaryDetailMeta.UNIT_NUMBER_SALARY));
				...
				this.setWelfaerSybxValue( (BigDecimal)r.getValue(SalaryDetailMeta.WELFAER_SYBX_VALUE));
				return true;
			} catch (Exception e) {
				return false;
			}
