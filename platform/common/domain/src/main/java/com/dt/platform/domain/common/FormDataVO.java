...
@ApiModel(description = "表单数据VO类型 ; 表单数据 , 数据表 sys_form_data 的通用VO类型" , parent = FormData.class)
public class FormDataVO extends FormData {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public FormDataVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public FormDataVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return FormDataVO , 转换好的 FormDataVO 对象
	*/
	@Transient
	 ...
	 * @return FormDataVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	...
	public FormDataVO duplicate(boolean all) {
		com.dt.platform.domain.common.meta.FormDataVOMeta.$$proxy$$ inst = new com.dt.platform.domain.common.meta.FormDataVOMeta.$$proxy$$();
	...
	*/
	@Transient
	public FormDataVO clone(boolean deep) {
		return EntityContext.clone(FormDataVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 FormDataVO
	 * @param formDataMap 包含实体信息的 Map 对象
	 * @return FormDataVO , 转换好的的 FormData 对象
	*/
	@Transient
	public static FormDataVO createFrom(Map<String,Object> formDataMap) {
		if(formDataMap==null) return null;
		FormDataVO vo = create();
		EntityContext.copyProperties(vo,formDataMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 FormDataVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return FormDataVO , 转换好的的 FormData 对象
	*/
	@Transient
	public static FormDataVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 FormDataVO，等同于 new
	 * @return FormDataVO 对象
	*/
	@Transient
	public static FormDataVO create() {
		return new com.dt.platform.domain.common.meta.FormDataVOMeta.$$proxy$$();
	}
	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			this.setFormId(DataParser.parse(String.class, map.get(FormDataVOMeta.FORM_ID)));
			...
			this.setDeleted(DataParser.parse(Integer.class, map.get(FormDataVOMeta.DELETED)));
			...
			try {
				this.setFormId( (String)map.get(FormDataVOMeta.FORM_ID));
				...
				this.setDeleted( (Integer)map.get(FormDataVOMeta.DELETED));
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			this.setFormId(DataParser.parse(String.class, r.getValue(FormDataVOMeta.FORM_ID)));
			...
			this.setDeleted(DataParser.parse(Integer.class, r.getValue(FormDataVOMeta.DELETED)));
			...
			try {
				this.setFormId( (String)r.getValue(FormDataVOMeta.FORM_ID));
				...
				this.setDeleted( (Integer)r.getValue(FormDataVOMeta.DELETED));
