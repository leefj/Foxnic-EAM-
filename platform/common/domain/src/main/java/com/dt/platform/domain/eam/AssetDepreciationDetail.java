 ...
 * <p>eam_asset_depreciation_detail , 数据表 eam_asset_depreciation_detail 的PO类型</p>
...
@ApiModel(description = "eam_asset_depreciation_detail ; eam_asset_depreciation_detail , 数据表 eam_asset_depreciation_detail 的PO类型")
