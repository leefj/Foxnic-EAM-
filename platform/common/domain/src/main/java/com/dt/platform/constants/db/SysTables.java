	...
	public static class SYS_FORM_INFO extends DBTable {
		...
		*/
		...
		public SYS_FORM_INFO() {
			this.init($NAME,"表单信息" , ID , CODE , CATALOG_ID , NAME , STATUS , ROUTE , NOTES , DESIGNER_DATA , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
