...
public class SysTables {
	...
	*/
	 ...
	 * 页面开发
	*/
	public static class SYS_PAGE_INFO extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "sys_page_info";
	 ...
	 * 页面历史
	*/
	public static class SYS_PAGE_INFO_HIS extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "sys_page_info_his";
		...
		*/
		 ...
		 * 名称
		*/
		public static final DBField PAGE_ID = new DBField(DBDataType.STRING , "page_id","pageId","名称","名称",false,false,true);
		...
		*/
		...
		public SYS_PAGE_INFO_HIS() {
			this.init($NAME,"页面历史" , ID , PAGE_ID , DEF_JSON , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final SYS_PAGE_INFO_HIS $TABLE=new SYS_PAGE_INFO_HIS();
	}
	...
	*/
	public static class SYS_REPORT_U_DEF extends DBTable {
		...
		*/
		...
		/**
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","content","content",false,false,true);
