	...
	public static class SYS_FORM_DATA extends DBTable {
		...
		*/
		...
		public SYS_FORM_DATA() {
			this.init($NAME,"表单数据" , ID , DEF_ID , FORM_ID , DESIGNER_DATA , DATA , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
