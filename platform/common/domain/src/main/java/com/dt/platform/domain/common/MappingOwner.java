...
import com.dt.platform.constants.db.SysTables.SYS_MAPPING_OWNER;
...
import com.dt.platform.domain.common.meta.MappingOwnerMeta;
...
@Table(name = "sys_mapping_owner")
@ApiModel(description = "归属 ; 归属 , 数据表 sys_mapping_owner 的PO类型")
public class MappingOwner extends Entity {

	private static final long serialVersionUID = 1L;

	public static final DBTable TABLE =SYS_MAPPING_OWNER.$TABLE;
	...
	*/
	...
	public static MappingOwner create() {
		return new com.dt.platform.domain.common.meta.MappingOwnerMeta.$$proxy$$();
	}
