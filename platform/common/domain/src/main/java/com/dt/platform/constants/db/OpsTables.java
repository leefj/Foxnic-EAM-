...
public class OpsTables {
	...
	public static class OPS_AUTO_ACTION extends DBTable {
		...
		*/
		...
		public OPS_AUTO_ACTION() {
			this.init($NAME,"执行任务" , ID , NAME , STATUS , TYPE , TPL_VERSION , SUPPORT , INFO , FILE_STATUS , NODE_NUMBER_TYPE , CONF_CONTENT , EXAMPLE_CONF_CONTENT , EXECUTE_CONTENT , EXECUTE_TOOL , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
	...
	public static class OPS_AUTO_ACTION_FILE extends DBTable {
		...
		*/
		...
		public OPS_AUTO_ACTION_FILE() {
			this.init($NAME,"执行介质" , ID , NAME , FILE_NAME , FILE_ID , NOTES , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , CREATE_BY , CREATE_TIME);
		}
	...
	public static class OPS_AUTO_GROUP extends DBTable {
		...
		*/
		...
		public OPS_AUTO_GROUP() {
			this.init($NAME,"节点分组" , ID , NAME , STATUS , NOTES , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , CREATE_BY , CREATE_TIME);
		}
	...
	public static class OPS_AUTO_NODE extends DBTable {
		...
		*/
		...
		public OPS_AUTO_NODE() {
			this.init($NAME,"节点" , ID , OWNER_CODE , NAME , GROUP_ID , TYPE , STATUS , IP , PORT , AUTHENTICATION_METHOD , VOUCHER_ID , USER_NAME , PASSWORD , PUB_KEY , NOTES , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , CREATE_BY , CREATE_TIME);
		}
	...
	public static class OPS_AUTO_TASK extends DBTable {
		...
		*/
		...
		public OPS_AUTO_TASK() {
			this.init($NAME,"批次作业" , ID , OWNER_ID , NAME , STATUS , RUN_STATUS , GROUP_ID , BATCH_ID , ACTION_ID , CONF_CONTENT , NOTES , SELECTED_CODE , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID , CREATE_BY , CREATE_TIME);
		}
	...
	*/
	public static class OPS_AUTO_TASK_LOG extends DBTable {
		...
		*/
		...
		public OPS_AUTO_TASK_LOG() {
			this.init($NAME,"明细日志" , ID , TASK_ID , M_LOG_ID , ACTION_ID , NODE_IP , NODE_ID , STATUS , STIME , ETIME , RECORD_CONTENT , CONTENT_DETAIL , RECORD_TIME , NOTES , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , CREATE_BY , CREATE_TIME);
		}
	 ...
	 * 明细日志
	*/
	public static class OPS_AUTO_TASK_LOG_DTL extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_auto_task_log_dtl";
		...
		*/
		 ...
		 * 序列
		*/
		public static final DBField IND = new DBField(DBDataType.INTEGER , "ind","ind","序列","序列",false,false,true);
		
		/**
		 * 记录
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","记录","记录",false,false,true);
		...
		*/
		...
		public OPS_AUTO_TASK_LOG_DTL() {
			this.init($NAME,"明细日志" , ID , OWNER_ID , IND , CONTENT , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , CREATE_BY , CREATE_TIME);
		}
		public static final OPS_AUTO_TASK_LOG_DTL $TABLE=new OPS_AUTO_TASK_LOG_DTL();
	}
	...
	public static class OPS_AUTO_TASK_M_LOG extends DBTable {
		...
		*/
		...
		public OPS_AUTO_TASK_M_LOG() {
			this.init($NAME,"执行日志" , ID , TASK_ID , ACTION_ID , STATUS , CONTENT , STIME , ETIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , CREATE_BY , CREATE_TIME);
		}
	...
	public static class OPS_AUTO_TASK_NODE extends DBTable {
		...
		*/
		...
		public OPS_AUTO_TASK_NODE() {
			this.init($NAME,"作业节点" , ID , TASK_ID , NODE_ID , NOTES , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	*/
	 ...
	 * 数据库操作执行
	*/
	public static class OPS_DB_APPLY_EXECUTE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_db_apply_execute";
		...
		*/
		 ...
		 * 编号
		*/
		public static final DBField OWNER_ID = new DBField(DBDataType.STRING , "owner_id","ownerId","编号","编号",false,false,true);
	 ...
	 * 附件
	*/
	public static class OPS_DB_APPLY_FILE extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_db_apply_file";
		...
		*/
		 ...
		 * SQL文件
		*/
		public static final DBField FILE_ID = new DBField(DBDataType.STRING , "file_id","fileId","SQL文件","SQL文件",false,false,true);
		
		/**
		 * 执行顺序
		*/
		public static final DBField SN = new DBField(DBDataType.INTEGER , "sn","sn","执行顺序","执行顺序",false,false,true);
		...
		*/
		...
		public OPS_DB_APPLY_FILE() {
			this.init($NAME,"附件" , ID , OWNER_ID , FILE_ID , SN , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , CREATE_BY , CREATE_TIME , VERSION);
		}
		public static final OPS_DB_APPLY_FILE $TABLE=new OPS_DB_APPLY_FILE();
	}
	...
	*/
	 ...
	 * 数据库容量
	*/
	public static class OPS_DB_CAPACITY_RPT extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_db_capacity_rpt";
		...
		*/
		...
		public OPS_DB_CAPACITY_RPT() {
			this.init($NAME,"数据库容量" , ID , NAME , FILE_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final OPS_DB_CAPACITY_RPT $TABLE=new OPS_DB_CAPACITY_RPT();
	}
	
	/**
	 * 数据库变更申请
	*/
	public static class OPS_DB_CHANGE_APPLY extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_db_change_apply";
		...
		*/
		 ...
		 * 关联工单
		*/
		public static final DBField ITEM_NAME = new DBField(DBDataType.STRING , "item_name","itemName","关联工单","关联工单",false,false,true);
		...
		*/
		 ...
		 * 数据库
		*/
		public static final DBField DB_FULL_NAME = new DBField(DBDataType.STRING , "db_full_name","dbFullName","数据库","数据库",false,false,true);
		...
		*/
		 ...
		 * 数据库IP
		*/
		public static final DBField DB_IP = new DBField(DBDataType.STRING , "db_ip","dbIp","数据库IP","数据库IP",false,false,true);
		...
		*/
		 ...
		 * 数据库用户
		*/
		public static final DBField DB_USER = new DBField(DBDataType.STRING , "db_user","dbUser","数据库用户","数据库用户",false,false,true);
		...
		*/
		 ...
		 * SQL文本
		*/
		public static final DBField SQL_AREA = new DBField(DBDataType.STRING , "sql_area","sqlArea","SQL文本","SQL文本",false,false,true);
		
		/**
		 * 验证结果
		*/
		public static final DBField CHECK_RESULT = new DBField(DBDataType.STRING , "check_result","checkResult","验证结果","验证结果",false,false,true);
		
		/**
		 * 回滚/备份
		*/
		public static final DBField RB_RESULT = new DBField(DBDataType.STRING , "rb_result","rbResult","回滚/备份","回滚/备份",false,false,true);
		
		/**
		 * 推送工单
		*/
		public static final DBField PUSH_ORDER_STATUS = new DBField(DBDataType.STRING , "push_order_status","pushOrderStatus","推送工单","推送工单",false,false,true);
		
		/**
		 * 返回信息
		*/
		public static final DBField PUSH_RESULT = new DBField(DBDataType.STRING , "push_result","pushResult","返回信息","返回信息",false,false,true);
		
		/**
		 * 工单编号
		*/
		public static final DBField ORDER_ID = new DBField(DBDataType.STRING , "order_id","orderId","工单编号","工单编号",false,false,true);
		...
		*/
		...
		public OPS_DB_CHANGE_APPLY() {
			this.init($NAME,"数据库变更申请" , ID , ITEM_CODE , ITEM_NAME , STATUS , DB_FULL_NAME , DB_ID , DB_IP , DB_NAME , DB_PORT , DB_USER , CONTENT , SQL_AREA , CHECK_RESULT , RB_RESULT , PUSH_ORDER_STATUS , PUSH_RESULT , ORDER_ID , APPLY_USER_ID , SELECTED_CODE , NOTES , ASSOCIATED_SYSTEM , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , CREATE_BY , CREATE_TIME , VERSION , TENANT_ID);
		}
		public static final OPS_DB_CHANGE_APPLY $TABLE=new OPS_DB_CHANGE_APPLY();
	}
	...
	*/
	 ...
	 * 数据库文档
	*/
	public static class OPS_DB_DOC extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_db_doc";
		...
		*/
		...
		public OPS_DB_DOC() {
			this.init($NAME,"数据库文档" , ID , NAME , TYPE , STATUS , FILE_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final OPS_DB_DOC $TABLE=new OPS_DB_DOC();
	}
	...
	*/
	public static class OPS_DB_EXTRACT_APPLY extends DBTable {
		 ...
		 * 表名
		*/
		public static final String $NAME = "ops_db_extract_apply";
		...
		*/
		 ...
		 * SQL文本1
		*/
		public static final DBField SQL_AREA = new DBField(DBDataType.STRING , "sql_area","sqlArea","SQL文本1","SQL文本1",false,false,true);
		
		/**
		 * SQL文本2
		*/
		public static final DBField SQL_AREA2 = new DBField(DBDataType.STRING , "sql_area2","sqlArea2","SQL文本2","SQL文本2",false,false,true);
		
		/**
		 * SQL文本3
		*/
		public static final DBField SQL_AREA3 = new DBField(DBDataType.STRING , "sql_area3","sqlArea3","SQL文本3","SQL文本3",false,false,true);
		
		/**
		 * SQL文本4
		*/
		public static final DBField SQL_AREA4 = new DBField(DBDataType.STRING , "sql_area4","sqlArea4","SQL文本4","SQL文本4",false,false,true);
		
		/**
		 * SQL文本5
		*/
		public static final DBField SQL_AREA5 = new DBField(DBDataType.STRING , "sql_area5","sqlArea5","SQL文本5","SQL文本5",false,false,true);
		...
		*/
		...
		public OPS_DB_EXTRACT_APPLY() {
			this.init($NAME,"数据库提取申请" , ID , ITEM_CODE , ITEM_NAME , STATUS , DB_FULL_NAME , DB_ID , DB_IP , DB_NAME , DB_PORT , DB_USER , CONTENT , SQL_AREA , SQL_AREA2 , SQL_AREA3 , SQL_AREA4 , SQL_AREA5 , CHECK_RESULT , PUSH_ORDER_STATUS , PUSH_RESULT , ORDER_ID , APPLY_USER_ID , SELECTED_CODE , NOTES , ASSOCIATED_SYSTEM , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , CREATE_BY , CREATE_TIME , VERSION , TENANT_ID);
		}
		public static final OPS_DB_EXTRACT_APPLY $TABLE=new OPS_DB_EXTRACT_APPLY();
	}
	...
	*/
	 ...
	 * 变更数据库
	*/
	public static class OPS_DB_INFO_APPLY extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_db_info_apply";
	...
	*/
	 ...
	 * 数据库巡检
	*/
	public static class OPS_DB_INSPECTION extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_db_inspection";
		...
		*/
		 ...
		 * 巡检方
		*/
		public static final DBField ACTION_USER = new DBField(DBDataType.STRING , "action_user","actionUser","巡检方","巡检方",false,false,true);
		
		/**
		 * 巡检结果
		*/
		public static final DBField RESULT = new DBField(DBDataType.STRING , "result","result","巡检结果","巡检结果",false,false,true);
		
		/**
		 * 记录时间
		*/
		public static final DBField RCD_DATE = new DBField(DBDataType.DATE , "rcd_date","rcdDate","记录时间","记录时间",false,false,true);
		...
		*/
		...
		public OPS_DB_INSPECTION() {
			this.init($NAME,"数据库巡检" , ID , NAME , ACTION_USER , RESULT , RCD_DATE , FILE_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final OPS_DB_INSPECTION $TABLE=new OPS_DB_INSPECTION();
	}
	...
	*/
	 ...
	 * 性能报表
	*/
	public static class OPS_DB_REPORT extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_db_report";
		...
		*/
		 ...
		 * 报告内容
		*/
		public static final DBField CONTENT = new DBField(DBDataType.STRING , "content","content","报告内容","报告内容",false,false,true);
		...
		*/
		...
		public OPS_DB_REPORT() {
			this.init($NAME,"性能报表" , ID , NAME , CONTENT , FILE_ID , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
		public static final OPS_DB_REPORT $TABLE=new OPS_DB_REPORT();
	}
	...
	*/
	 ...
	 * 地址分组
	*/
	public static class OPS_IP_GROUP extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_ip_group";
		...
		*/
		...
		public OPS_IP_GROUP() {
			this.init($NAME,"地址分组" , ID , STATUS , CATEGORY_NAME , CATEGORY_FULLNAME , CATEGORY_CODE , SERVICE_LIFE , PARENT_ID , SORT , HIERARCHY , HIERARCHY_NAME , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final OPS_IP_GROUP $TABLE=new OPS_IP_GROUP();
	}
	
	/**
	 * 监控告警
	*/
	public static class OPS_MONITOR_ALERT extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_monitor_alert";
		...
		*/
		 ...
		 * 触发器
		*/
		public static final DBField TRIGGER_NAME = new DBField(DBDataType.STRING , "trigger_name","triggerName","触发器","触发器",false,false,true);
		
		/**
		 * 规则描述
		*/
		public static final DBField TRIGGER_RULE_DESC = new DBField(DBDataType.STRING , "trigger_rule_desc","triggerRuleDesc","规则描述","规则描述",false,false,true);
		
		/**
		 * 监控数值
		*/
		public static final DBField ALERT_VALUE = new DBField(DBDataType.STRING , "alert_value","alertValue","监控数值","监控数值",false,false,true);
		...
		*/
		 ...
		 * 处理人
		*/
		public static final DBField USER_ID = new DBField(DBDataType.STRING , "user_id","userId","处理人","处理人",false,false,true);
		
		/**
		 * 处理内容
		*/
		public static final DBField PROCESS_MESSAGE = new DBField(DBDataType.STRING , "process_message","processMessage","处理内容","处理内容",false,false,true);
	...
	*/
	public static class OPS_MONITOR_NODE extends DBTable {
		...
		*/
		 ...
		 * 变量
		*/
		public static final DBField VAR = new DBField(DBDataType.STRING , "var","var","变量","变量",false,false,true);
	...
	*/
	 ...
	 * 触发器
	*/
	public static class OPS_MONITOR_NODE_TRIGGER extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_monitor_node_trigger";
	...
	*/
	public static class OPS_MONITOR_NODE_VALUE extends DBTable {
		...
		*/
		 ...
		 * 数据库状态
		*/
		public static final DBField DB_STATUS = new DBField(DBDataType.INTEGER , "db_status","dbStatus","数据库状态","数据库状态",false,false,true);
		
		/**
		 * 数据库大小
		*/
		public static final DBField DB_SIZE = new DBField(DBDataType.LONG , "db_size","dbSize","数据库大小","数据库大小",false,false,true);
		
		/**
		 * 数据库连接数
		*/
		public static final DBField DB_CONNECT_NUMBER = new DBField(DBDataType.INTEGER , "db_connect_number","dbConnectNumber","数据库连接数","数据库连接数",false,false,true);
		
		/**
		 * 版本
		*/
		public static final DBField NODE_VERSION = new DBField(DBDataType.STRING , "node_version","nodeVersion","版本","版本",false,false,true);
		...
		*/
		 ...
		 * 字符串1
		*/
		public static final DBField VALUE_BSTR1 = new DBField(DBDataType.STRING , "value_bstr1","valueBstr1","字符串1","字符串1",false,false,true);
	...
	*/
	public static class OPS_MONITOR_TPL_INDICATOR extends DBTable {
		...
		*/
		 ...
		 * 值行列数
		*/
		public static final DBField ROW_COL_TYPE = new DBField(DBDataType.STRING , "row_col_type","rowColType","值行列数","值行列数",false,false,true);
		...
		*/
		 ...
		 * 超时时间(秒)
		*/
		public static final DBField TIME_OUT = new DBField(DBDataType.INTEGER , "time_out","timeOut","超时时间","秒)",false,false,true);
	...
	*/
	 ...
	 * 触发器
	*/
	public static class OPS_MONITOR_TPL_TRIGGER extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_monitor_tpl_trigger";
		...
		*/
		 ...
		 * 触发器
		*/
		public static final DBField NAME = new DBField(DBDataType.STRING , "name","name","触发器","触发器",false,false,true);
		
		/**
		 * 规则类型
		*/
		public static final DBField RULE_TYPE = new DBField(DBDataType.STRING , "rule_type","ruleType","规则类型","规则类型",false,false,true);
		...
		*/
		 ...
		 * 发现规则
		*/
		public static final DBField RULE_DISCOVERY = new DBField(DBDataType.STRING , "rule_discovery","ruleDiscovery","发现规则","发现规则",false,false,true);
		
		/**
		 * 间隔时间
		*/
		public static final DBField INTERVAL_TIME = new DBField(DBDataType.INTEGER , "interval_time","intervalTime","间隔时间","间隔时间",false,false,true);
		...
		*/
		...
		public OPS_MONITOR_TPL_TRIGGER() {
			this.init($NAME,"触发器" , ID , NAME , RULE_TYPE , WARN_LEVEL , RULE_DISCOVERY , INTERVAL_TIME , RULE , CONTENT_VALUE , STATUS , MONITOR_TPL_CODE , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION);
		}
	...
	*/
	public static class OPS_MONITOR_WARN extends DBTable {
		...
		*/
		...
		/**
		*/
		public static final DBField TRIGGER_NAME = new DBField(DBDataType.INTEGER , "trigger_name","triggerName","trigger_name","trigger_name",false,false,true);
		...
		*/
		 ...
		 * 指标名称
		*/
		public static final DBField INDICATOR_NAMECOPY = new DBField(DBDataType.STRING , "indicator_nameCopy","indicatorNamecopy","指标名称","指标名称",false,false,true);
		
		public OPS_MONITOR_WARN() {
			this.init($NAME,"节点告警" , ID , NODE_ID , NODE_NAME , NODE_VALUE_ID , MONITOR_TPL_CODE , INDICATOR_CODE , INDICATOR_NAME , TRIGGER_NAME , WARN_LEVEL , STATUS , HANDLED_TIME , WARN_TIME , CONTENT , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , INDICATOR_NAMECOPY);
		}
	 ...
	 * 地址映射
	*/
	public static class OPS_NETWORK_NAT_MAP extends DBTable {
		
		/**
		 * 表名
		*/
		public static final String $NAME = "ops_network_nat_map";
		...
		*/
		 ...
		 * NAT地址
		*/
		public static final DBField NAT_IPV4 = new DBField(DBDataType.STRING , "nat_ipv4","natIpv4","NAT地址","NAT地址",false,false,true);
		
		/**
		 * 后端地址
		*/
		public static final DBField SOURCE_IPV4 = new DBField(DBDataType.STRING , "source_ipv4","sourceIpv4","后端地址","后端地址",false,false,true);
		...
		*/
		...
		public OPS_NETWORK_NAT_MAP() {
			this.init($NAME,"地址映射" , ID , NAME , LABEL , NAT_IPV4 , SOURCE_IPV4 , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , VERSION , TENANT_ID);
		}
		public static final OPS_NETWORK_NAT_MAP $TABLE=new OPS_NETWORK_NAT_MAP();
	}
