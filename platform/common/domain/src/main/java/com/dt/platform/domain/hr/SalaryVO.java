	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setPersonalTaxZfdkNotes(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSONAL_TAX_ZFDK_NOTES)));
			...
			this.setPersonalStatus(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSONAL_STATUS)));
			...
			this.setPersonalTaxErzhNotes(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSONAL_TAX_ERZH_NOTES)));
			...
			this.setPersonalTaxJxjyNotes(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSONAL_TAX_JXJY_NOTES)));
			...
			this.setPersonalTaxZnjyNotes(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSONAL_TAX_ZNJY_NOTES)));
			...
			this.setPersonalTaxDbylNotes(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSONAL_TAX_DBYL_NOTES)));
			this.setPersonalTaxZfzjNotes(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSONAL_TAX_ZFZJ_NOTES)));
			...
			this.setPersonalTaxSylrNotes(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSONAL_TAX_SYLR_NOTES)));
			...
			this.setPersonCardNumber(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSON_CARD_NUMBER)));
			...
			this.setPersonJobNumber(DataParser.parse(String.class, map.get(SalaryVOMeta.PERSON_JOB_NUMBER)));
			...
			try {
				...
				this.setPersonalTaxZfdkNotes( (String)map.get(SalaryVOMeta.PERSONAL_TAX_ZFDK_NOTES));
				...
				this.setPersonalStatus( (String)map.get(SalaryVOMeta.PERSONAL_STATUS));
				...
				this.setPersonalTaxErzhNotes( (String)map.get(SalaryVOMeta.PERSONAL_TAX_ERZH_NOTES));
				...
				this.setPersonalTaxJxjyNotes( (String)map.get(SalaryVOMeta.PERSONAL_TAX_JXJY_NOTES));
				...
				this.setPersonalTaxZnjyNotes( (String)map.get(SalaryVOMeta.PERSONAL_TAX_ZNJY_NOTES));
				...
				this.setPersonalTaxDbylNotes( (String)map.get(SalaryVOMeta.PERSONAL_TAX_DBYL_NOTES));
				this.setPersonalTaxZfzjNotes( (String)map.get(SalaryVOMeta.PERSONAL_TAX_ZFZJ_NOTES));
				...
				this.setPersonalTaxSylrNotes( (String)map.get(SalaryVOMeta.PERSONAL_TAX_SYLR_NOTES));
				...
				this.setPersonCardNumber( (String)map.get(SalaryVOMeta.PERSON_CARD_NUMBER));
				...
				this.setPersonJobNumber( (String)map.get(SalaryVOMeta.PERSON_JOB_NUMBER));
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setPersonalTaxZfdkNotes(DataParser.parse(String.class, r.getValue(SalaryVOMeta.PERSONAL_TAX_ZFDK_NOTES)));
			...
			this.setPersonalStatus(DataParser.parse(String.class, r.getValue(SalaryVOMeta.PERSONAL_STATUS)));
			...
			this.setPersonalTaxErzhNotes(DataParser.parse(String.class, r.getValue(SalaryVOMeta.PERSONAL_TAX_ERZH_NOTES)));
			...
			this.setPersonalTaxJxjyNotes(DataParser.parse(String.class, r.getValue(SalaryVOMeta.PERSONAL_TAX_JXJY_NOTES)));
			...
			this.setPersonalTaxZnjyNotes(DataParser.parse(String.class, r.getValue(SalaryVOMeta.PERSONAL_TAX_ZNJY_NOTES)));
			...
			this.setPersonalTaxDbylNotes(DataParser.parse(String.class, r.getValue(SalaryVOMeta.PERSONAL_TAX_DBYL_NOTES)));
			this.setPersonalTaxZfzjNotes(DataParser.parse(String.class, r.getValue(SalaryVOMeta.PERSONAL_TAX_ZFZJ_NOTES)));
			...
			this.setPersonalTaxSylrNotes(DataParser.parse(String.class, r.getValue(SalaryVOMeta.PERSONAL_TAX_SYLR_NOTES)));
			...
			try {
				...
				this.setPersonalTaxZfdkNotes( (String)r.getValue(SalaryVOMeta.PERSONAL_TAX_ZFDK_NOTES));
				...
				this.setPersonalStatus( (String)r.getValue(SalaryVOMeta.PERSONAL_STATUS));
				...
				this.setPersonalTaxErzhNotes( (String)r.getValue(SalaryVOMeta.PERSONAL_TAX_ERZH_NOTES));
				...
				this.setPersonalTaxJxjyNotes( (String)r.getValue(SalaryVOMeta.PERSONAL_TAX_JXJY_NOTES));
				...
				this.setPersonalTaxZnjyNotes( (String)r.getValue(SalaryVOMeta.PERSONAL_TAX_ZNJY_NOTES));
				...
				this.setPersonalTaxDbylNotes( (String)r.getValue(SalaryVOMeta.PERSONAL_TAX_DBYL_NOTES));
				this.setPersonalTaxZfzjNotes( (String)r.getValue(SalaryVOMeta.PERSONAL_TAX_ZFZJ_NOTES));
				...
				this.setPersonalTaxSylrNotes( (String)r.getValue(SalaryVOMeta.PERSONAL_TAX_SYLR_NOTES));
