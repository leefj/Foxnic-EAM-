	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setIndividualTax(DataParser.parse(BigDecimal.class, map.get(SalaryDetailVOMeta.INDIVIDUAL_TAX)));
			...
			try {
				...
				this.setIndividualTax( (BigDecimal)map.get(SalaryDetailVOMeta.INDIVIDUAL_TAX));
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setIndividualTax(DataParser.parse(BigDecimal.class, r.getValue(SalaryDetailVOMeta.INDIVIDUAL_TAX)));
			...
			try {
				...
				this.setIndividualTax( (BigDecimal)r.getValue(SalaryDetailVOMeta.INDIVIDUAL_TAX));
