...
public class MonitorTplIndicatorMeta {
	...
	*/
	 ...
	 * 值行列数 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.ops.MonitorTplIndicator,java.lang.String> ROW_COL_TYPE_PROP = new BeanProperty(com.dt.platform.domain.ops.MonitorTplIndicator.class ,ROW_COL_TYPE, java.lang.String.class, "值行列数", "值行列数", java.lang.String.class, null);
