...
public class CCustInspectPlanVOMeta extends CCustInspectPlanMeta {
	...
	*/
	 ...
	 * 巡检类型 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.eam.CCustInspectPlanVO,java.lang.String> TYPE_PROP = new BeanProperty(com.dt.platform.domain.eam.CCustInspectPlanVO.class ,TYPE, java.lang.String.class, "巡检类型", "巡检类型", java.lang.String.class, null);
	...
	*/
	 ...
	 * 全部属性清单
	*/
	public static final String[] $PROPS={ PAGE_INDEX , PAGE_SIZE , SEARCH_FIELD , FUZZY_FIELD , SEARCH_VALUE , DIRTY_FIELDS , SORT_FIELD , SORT_TYPE , DATA_ORIGIN , QUERY_LOGIC , REQUEST_ACTION , IDS , ID , NAME , STATUS , TYPE , INSPECT_USER_ID , TPL_ID , CRONTAB , NOTES , CREATE_BY , CREATE_TIME , UPDATE_BY , UPDATE_TIME , DELETED , DELETE_BY , DELETE_TIME , TENANT_ID , VERSION , CUST_INSPECT_TPL , LEADER , MEMBER_LIST , MEMBER_IDS };
