	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setPurchaseUnitPrice(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.PURCHASE_UNIT_PRICE)));
			this.setDepreciationPrice(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.DEPRECIATION_PRICE)));
			...
			this.setRedidualPrice(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.REDIDUAL_PRICE)));
			this.setId(DataParser.parse(String.class, map.get(AssetDepreciationDetailVOMeta.ID)));
			this.setCurPrice(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.CUR_PRICE)));
			...
			this.setUsedServiceLife(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.USED_SERVICE_LIFE)));
			...
			this.setPurchaseDate(DataParser.parse(Date.class, map.get(AssetDepreciationDetailVOMeta.PURCHASE_DATE)));
			...
			this.setOriginalUnitPrice(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.ORIGINAL_UNIT_PRICE)));
			...
			this.setAfterPrice(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.AFTER_PRICE)));
			this.setServiceLife(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.SERVICE_LIFE)));
			this.setRegisterDate(DataParser.parse(Date.class, map.get(AssetDepreciationDetailVOMeta.REGISTER_DATE)));
			...
			this.setBeforePrice(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.BEFORE_PRICE)));
			...
			this.setResidualRate(DataParser.parse(BigDecimal.class, map.get(AssetDepreciationDetailVOMeta.RESIDUAL_RATE)));
			this.setTenantId(DataParser.parse(String.class, map.get(AssetDepreciationDetailVOMeta.TENANT_ID)));
			...
			this.setAssetCurModel(DataParser.parse(String.class, map.get(AssetDepreciationDetailVOMeta.ASSET_CUR_MODEL)));
			...
			this.setAssetCurCode(DataParser.parse(String.class, map.get(AssetDepreciationDetailVOMeta.ASSET_CUR_CODE)));
			...
			this.setAssetCurName(DataParser.parse(String.class, map.get(AssetDepreciationDetailVOMeta.ASSET_CUR_NAME)));
			return true;
		} else {
			try {
				...
				this.setPurchaseUnitPrice( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.PURCHASE_UNIT_PRICE));
				this.setDepreciationPrice( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.DEPRECIATION_PRICE));
				...
				this.setRedidualPrice( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.REDIDUAL_PRICE));
				this.setId( (String)map.get(AssetDepreciationDetailVOMeta.ID));
				this.setCurPrice( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.CUR_PRICE));
				this.setCYearDepreciationAmount( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.C_YEAR_DEPRECIATION_AMOUNT));
				this.setUsedServiceLife( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.USED_SERVICE_LIFE));
				...
				this.setPurchaseDate( (Date)map.get(AssetDepreciationDetailVOMeta.PURCHASE_DATE));
				...
				this.setOriginalUnitPrice( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.ORIGINAL_UNIT_PRICE));
				...
				this.setAfterPrice( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.AFTER_PRICE));
				this.setServiceLife( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.SERVICE_LIFE));
				this.setRegisterDate( (Date)map.get(AssetDepreciationDetailVOMeta.REGISTER_DATE));
				this.setCOriginalPriceIncrease( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.C_ORIGINAL_PRICE_INCREASE));
				this.setBeforePrice( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.BEFORE_PRICE));
				...
				this.setResidualRate( (BigDecimal)map.get(AssetDepreciationDetailVOMeta.RESIDUAL_RATE));
				this.setTenantId( (String)map.get(AssetDepreciationDetailVOMeta.TENANT_ID));
				...
				this.setAssetCurModel( (String)map.get(AssetDepreciationDetailVOMeta.ASSET_CUR_MODEL));
				...
				this.setAssetCurCode( (String)map.get(AssetDepreciationDetailVOMeta.ASSET_CUR_CODE));
				...
				this.setAssetCurName( (String)map.get(AssetDepreciationDetailVOMeta.ASSET_CUR_NAME));
				return true;
			} catch (Exception e) {
				return false;
			}
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setPurchaseUnitPrice(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.PURCHASE_UNIT_PRICE)));
			this.setDepreciationPrice(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.DEPRECIATION_PRICE)));
			...
			this.setRedidualPrice(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.REDIDUAL_PRICE)));
			this.setId(DataParser.parse(String.class, r.getValue(AssetDepreciationDetailVOMeta.ID)));
			this.setCurPrice(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.CUR_PRICE)));
			...
			this.setUsedServiceLife(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.USED_SERVICE_LIFE)));
			...
			this.setPurchaseDate(DataParser.parse(Date.class, r.getValue(AssetDepreciationDetailVOMeta.PURCHASE_DATE)));
			...
			this.setOriginalUnitPrice(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.ORIGINAL_UNIT_PRICE)));
			...
			this.setAfterPrice(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.AFTER_PRICE)));
			this.setServiceLife(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.SERVICE_LIFE)));
			this.setRegisterDate(DataParser.parse(Date.class, r.getValue(AssetDepreciationDetailVOMeta.REGISTER_DATE)));
			...
			this.setBeforePrice(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.BEFORE_PRICE)));
			...
			this.setResidualRate(DataParser.parse(BigDecimal.class, r.getValue(AssetDepreciationDetailVOMeta.RESIDUAL_RATE)));
			this.setTenantId(DataParser.parse(String.class, r.getValue(AssetDepreciationDetailVOMeta.TENANT_ID)));
			...
			try {
				...
				this.setPurchaseUnitPrice( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.PURCHASE_UNIT_PRICE));
				this.setDepreciationPrice( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.DEPRECIATION_PRICE));
				...
				this.setRedidualPrice( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.REDIDUAL_PRICE));
				this.setId( (String)r.getValue(AssetDepreciationDetailVOMeta.ID));
				this.setCurPrice( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.CUR_PRICE));
				this.setCYearDepreciationAmount( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.C_YEAR_DEPRECIATION_AMOUNT));
				this.setUsedServiceLife( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.USED_SERVICE_LIFE));
				...
				this.setPurchaseDate( (Date)r.getValue(AssetDepreciationDetailVOMeta.PURCHASE_DATE));
				...
				this.setOriginalUnitPrice( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.ORIGINAL_UNIT_PRICE));
				...
				this.setAfterPrice( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.AFTER_PRICE));
				this.setServiceLife( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.SERVICE_LIFE));
				this.setRegisterDate( (Date)r.getValue(AssetDepreciationDetailVOMeta.REGISTER_DATE));
				this.setCOriginalPriceIncrease( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.C_ORIGINAL_PRICE_INCREASE));
				this.setBeforePrice( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.BEFORE_PRICE));
				...
				this.setResidualRate( (BigDecimal)r.getValue(AssetDepreciationDetailVOMeta.RESIDUAL_RATE));
				this.setTenantId( (String)r.getValue(AssetDepreciationDetailVOMeta.TENANT_ID));
