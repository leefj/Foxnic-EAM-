...
public class SalaryMeta {
	...
	*/
	 ...
	 * 是否发放 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.hr.Salary,java.lang.String> STATUS_PROP = new BeanProperty(com.dt.platform.domain.hr.Salary.class ,STATUS, java.lang.String.class, "是否发放", "是否发放", java.lang.String.class, null);
