	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setRequestAction(DataParser.parse(String.class, map.get(AssetDepreciationCalRuleVOMeta.REQUEST_ACTION)));
			...
			this.setDataOrigin(DataParser.parse(String.class, map.get(AssetDepreciationCalRuleVOMeta.DATA_ORIGIN)));
			this.setQueryLogic(DataParser.parse(String.class, map.get(AssetDepreciationCalRuleVOMeta.QUERY_LOGIC)));
			...
			try {
				...
				this.setRequestAction( (String)map.get(AssetDepreciationCalRuleVOMeta.REQUEST_ACTION));
				...
				this.setDataOrigin( (String)map.get(AssetDepreciationCalRuleVOMeta.DATA_ORIGIN));
				this.setQueryLogic( (String)map.get(AssetDepreciationCalRuleVOMeta.QUERY_LOGIC));
