...
@ApiModel(description = "数据源VO类型 ; 数据源 , 数据表 sys_screen_ds_data 的通用VO类型" , parent = ScreenDsData.class)
public class ScreenDsDataVO extends ScreenDsData {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ScreenDsDataVO addDirtyField(String... dirtyField) {
	...
	*/
	 ...
	 * @return 当前对象
	*/
	public ScreenDsDataVO addId(String... id) {
	 ...
	 * 将自己转换成指定类型的PO
	 * @param poType  PO类型
	 * @return ScreenDsDataVO , 转换好的 ScreenDsDataVO 对象
	*/
	@Transient
	 ...
	 * @return ScreenDsDataVO , 转换好的 PoJo 对象
	*/
	@Transient
	...
	*/
	@Transient
	public ScreenDsDataVO clone(boolean deep) {
		return EntityContext.clone(ScreenDsDataVO.class,this,deep);
	}

	/**
	 * 将 Map 转换成 ScreenDsDataVO
	 * @param screenDsDataMap 包含实体信息的 Map 对象
	 * @return ScreenDsDataVO , 转换好的的 ScreenDsData 对象
	*/
	@Transient
	public static ScreenDsDataVO createFrom(Map<String,Object> screenDsDataMap) {
		if(screenDsDataMap==null) return null;
		ScreenDsDataVO vo = create();
		EntityContext.copyProperties(vo,screenDsDataMap);
		vo.clearModifies();
		return vo;
	}

	/**
	 * 将 Pojo 转换成 ScreenDsDataVO
	 * @param pojo 包含实体信息的 Pojo 对象
	 * @return ScreenDsDataVO , 转换好的的 ScreenDsData 对象
	*/
	@Transient
	public static ScreenDsDataVO createFrom(Object pojo) {
	...
	/**
	 * 创建一个 ScreenDsDataVO，等同于 new
	 * @return ScreenDsDataVO 对象
	*/
	@Transient
	public static ScreenDsDataVO create() {
		return new com.dt.platform.domain.common.meta.ScreenDsDataVOMeta.$$proxy$$();
	}
	...
	*/
	public boolean read(Map<String, Object> map,boolean cast) {
		...
		if(cast) {
			...
			this.setDeleteTime(DataParser.parse(Date.class, map.get(ScreenDsDataVOMeta.DELETE_TIME)));
			this.setName(DataParser.parse(String.class, map.get(ScreenDsDataVOMeta.NAME)));
			...
			try {
				...
				this.setDeleteTime( (Date)map.get(ScreenDsDataVOMeta.DELETE_TIME));
				this.setName( (String)map.get(ScreenDsDataVOMeta.NAME));
	...
	*/
	public boolean read(ExprRcd r,boolean cast) {
		...
		if(cast) {
			...
			this.setDeleteTime(DataParser.parse(Date.class, r.getValue(ScreenDsDataVOMeta.DELETE_TIME)));
			this.setName(DataParser.parse(String.class, r.getValue(ScreenDsDataVOMeta.NAME)));
			...
			try {
				...
				this.setDeleteTime( (Date)r.getValue(ScreenDsDataVOMeta.DELETE_TIME));
				this.setName( (String)r.getValue(ScreenDsDataVOMeta.NAME));
