...
public class AssessmentIndicatorVOMeta extends AssessmentIndicatorMeta {
	...
	*/
	 ...
	 * 组件类型 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.hr.AssessmentIndicatorVO,java.lang.String> INPUT_TYPE_PROP = new BeanProperty(com.dt.platform.domain.hr.AssessmentIndicatorVO.class ,INPUT_TYPE, java.lang.String.class, "组件类型", "组件类型", java.lang.String.class, null);
