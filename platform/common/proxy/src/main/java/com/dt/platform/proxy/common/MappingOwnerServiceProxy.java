 ...
 */
@FeignClient(value = ServiceNames.COMMON, contextId = MappingOwnerServiceProxy.API_CONTEXT_PATH, configuration = FeignConfiguration.class)
public interface MappingOwnerServiceProxy {
    ...
    /**
     * API 上下文路径 , sys-mapping-owner
     */
    public static final String API_CONTEXT_PATH = "sys-mapping-owner";
     ...
     * 控制器类名
     */
    public static final String CONTROLLER_CLASS_NAME = "com.dt.platform.common.controller.MappingOwnerController";
