...
public interface CheckGroupServiceProxy {
    ...
    /**
     * API 上下文路径 , eam-check-group
     */
    public static final String API_CONTEXT_PATH = "eam-check-group";
     ...
     * 控制器类名
     */
    public static final String CONTROLLER_CLASS_NAME = "com.dt.platform.eam.controller.CheckGroupController";

    /**
     * 统一的调用接口，实现在单体应用和微服务应用下的无差异调用
     */
    public static CheckGroupServiceProxy api() {
        return APIProxy.get(CheckGroupServiceProxy.class, CONTROLLER_CLASS_NAME);
    }
}
