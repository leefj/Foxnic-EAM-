 ...
 */
@FeignClient(value = ServiceNames.OA, contextId = TestServiceProxy.API_CONTEXT_PATH, configuration = FeignConfiguration.class)
public interface TestServiceProxy {
     ...
     * API 上下文路径 , oa-test
     */
    public static final String API_CONTEXT_PATH = "oa-test";
     ...
     * 控制器类名
     */
    public static final String CONTROLLER_CLASS_NAME = "com.dt.platform.oa.controller.TestController";
