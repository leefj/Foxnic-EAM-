...
public interface AttendanceRecordServiceProxy {
    ...
    void exportExcel(@RequestParam(name = "sample") AttendanceRecordVO sample, @RequestParam(name = "response") HttpServletResponse response) throws Exception;
     ...
     * 导入 Excel
     */
    @RequestMapping(AttendanceRecordServiceProxy.IMPORT_EXCEL)
