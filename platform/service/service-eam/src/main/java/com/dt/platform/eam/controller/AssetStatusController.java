...
public class AssetStatusController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = AssetStatusVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class , example = "608234495723708416"),
		@ApiImplicitParam(name = AssetStatusVOMeta.CODE , value = "编码" , required = false , dataTypeClass=String.class , example = "idle"),
		@ApiImplicitParam(name = AssetStatusVOMeta.NAME , value = "名称" , required = false , dataTypeClass=String.class , example = "闲置"),
		@ApiImplicitParam(name = AssetStatusVOMeta.TYPE , value = "类型" , required = false , dataTypeClass=String.class , example = "system"),
		@ApiImplicitParam(name = AssetStatusVOMeta.SORT , value = "排序" , required = false , dataTypeClass=Integer.class , example = "1"),
		@ApiImplicitParam(name = AssetStatusVOMeta.NOTES , value = "备注" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssetStatusVOMeta.UPDATE_BY , value = "修改人ID" , required = false , dataTypeClass=String.class , example = "110588348101165911"),
	})
	...
	*/
	...
	@ApiOperationSupport( order=4 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AssetStatusVOMeta.PAGE_INDEX , AssetStatusVOMeta.PAGE_SIZE , AssetStatusVOMeta.SEARCH_FIELD , AssetStatusVOMeta.FUZZY_FIELD , AssetStatusVOMeta.SEARCH_VALUE , AssetStatusVOMeta.DIRTY_FIELDS , AssetStatusVOMeta.SORT_FIELD , AssetStatusVOMeta.SORT_TYPE , AssetStatusVOMeta.DATA_ORIGIN , AssetStatusVOMeta.QUERY_LOGIC , AssetStatusVOMeta.REQUEST_ACTION , AssetStatusVOMeta.IDS } )
	...
	*/
	...
	@ApiOperationSupport(order=5 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AssetStatusVOMeta.PAGE_INDEX , AssetStatusVOMeta.PAGE_SIZE } )
