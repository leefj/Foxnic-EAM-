...
public class InventoryController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InventoryVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "514089040971042816"), @ApiImplicitParam(name = InventoryVOMeta.TYPE, value = "类型", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.BUSINESS_CODE, value = "业务编码", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.OWNER_CODE, value = "所属", required = false, dataTypeClass = String.class, example = "inventory"), @ApiImplicitParam(name = InventoryVOMeta.STATUS, value = "业务状态", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.NAME, value = "盘点名称", required = false, dataTypeClass = String.class, example = "1212"), @ApiImplicitParam(name = InventoryVOMeta.INVENTORY_STATUS, value = "盘点状态", required = false, dataTypeClass = String.class, example = "1212"), @ApiImplicitParam(name = InventoryVOMeta.DATA_STATUS, value = "数据状态", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.ALL_EMPLOYEE, value = "全员盘点", required = false, dataTypeClass = String.class, example = "0"), @ApiImplicitParam(name = InventoryVOMeta.ASSET_STATUS, value = "资产状态", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.CATEGORY_ID, value = "资产分类", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.OWN_COMPANY_ID, value = "所属公司", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.USE_ORGANIZATION_ID, value = "使用公司/部门", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.PURCHASE_START_DATE, value = "购置开始日期", required = false, dataTypeClass = Date.class), @ApiImplicitParam(name = InventoryVOMeta.PURCHASE_END_DATE, value = "购置结束日期", required = false, dataTypeClass = Date.class), @ApiImplicitParam(name = InventoryVOMeta.START_TIME, value = "盘点开始时间", required = false, dataTypeClass = Date.class), @ApiImplicitParam(name = InventoryVOMeta.FINISH_TIME, value = "盘点结束时间", required = false, dataTypeClass = Date.class), @ApiImplicitParam(name = InventoryVOMeta.ORIGINATOR_ID, value = "制单人", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.BUSINESS_DATE, value = "业务日期", required = false, dataTypeClass = Date.class), @ApiImplicitParam(name = InventoryVOMeta.NOTES, value = "备注", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InventoryVOMeta.PLAN_ID, value = "计划编号", required = false, dataTypeClass = String.class) })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InventoryVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "514089040971042816") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InventoryVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InventoryVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InventoryVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1"), @ApiImplicitParam(name = "assetId", value = "资产", required = true, dataTypeClass = String.class, example = "1"), @ApiImplicitParam(name = "action", value = "动作", required = true, dataTypeClass = String.class, example = "loss") })
