...
public class AssetStatusRuleController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = AssetStatusRuleVOMeta.STATUS , value = "状态" , required = false , dataTypeClass=String.class , example = "enable"),
		...
		@ApiImplicitParam(name = AssetStatusRuleVOMeta.OPER_CONDITION , value = "条件" , required = false , dataTypeClass=String.class , example = "in"),
		@ApiImplicitParam(name = AssetStatusRuleVOMeta.NOTES , value = "备注" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssetStatusRuleVOMeta.UPDATE_BY , value = "修改人ID" , required = false , dataTypeClass=String.class , example = "110588348101165911"),
	})
	...
	*/
	...
	@ApiOperationSupport( order=4 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AssetStatusRuleVOMeta.PAGE_INDEX , AssetStatusRuleVOMeta.PAGE_SIZE , AssetStatusRuleVOMeta.SEARCH_FIELD , AssetStatusRuleVOMeta.FUZZY_FIELD , AssetStatusRuleVOMeta.SEARCH_VALUE , AssetStatusRuleVOMeta.DIRTY_FIELDS , AssetStatusRuleVOMeta.SORT_FIELD , AssetStatusRuleVOMeta.SORT_TYPE , AssetStatusRuleVOMeta.DATA_ORIGIN , AssetStatusRuleVOMeta.QUERY_LOGIC , AssetStatusRuleVOMeta.REQUEST_ACTION , AssetStatusRuleVOMeta.IDS } )
	...
	*/
	...
	@ApiOperationSupport(order=5 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AssetStatusRuleVOMeta.PAGE_INDEX , AssetStatusRuleVOMeta.PAGE_SIZE } )
