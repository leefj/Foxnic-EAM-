...
public class RepairOrderTransferController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = RepairOrderTransferVOMeta.ORDER_ID , value = "申请单" , required = false , dataTypeClass=String.class),
	...
	*/
	...
	public Result<RepairOrderTransfer> getById(String id) {
		...
		// join 关联的对象
		repairOrderTransferService.dao().fill(repairOrderTransfer)
			.with(RepairOrderTransferMeta.REPAIR_GROUP)
			.with(RepairOrderTransferMeta.EXECUTOR)
			.execute();
	...
	*/
	...
	public Result<PagedList<RepairOrderTransfer>> queryPagedList(RepairOrderTransferVO sample) {
		...
		// join 关联的对象
		repairOrderTransferService.dao().fill(list)
			.with(RepairOrderTransferMeta.REPAIR_GROUP)
			.with(RepairOrderTransferMeta.EXECUTOR)
			.execute();
		result.success(true).data(list);
