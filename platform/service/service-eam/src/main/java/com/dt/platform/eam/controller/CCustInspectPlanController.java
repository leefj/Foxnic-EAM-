...
public class CCustInspectPlanController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = CCustInspectPlanVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = CCustInspectPlanVOMeta.NAME , value = "标题" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = CCustInspectPlanVOMeta.STATUS , value = "状态" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = CCustInspectPlanVOMeta.TYPE , value = "巡检类型" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = CCustInspectPlanVOMeta.INSPECT_USER_ID , value = "负责人" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = CCustInspectPlanVOMeta.TPL_ID , value = "模版" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = CCustInspectPlanVOMeta.CRONTAB , value = "触发周期" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = CCustInspectPlanVOMeta.NOTES , value = "备注" , required = false , dataTypeClass=String.class),
	})
	...
	*/
	...
	public Result<CCustInspectPlan> getById(String id) {
		...
		// join 关联的对象
		cCustInspectPlanService.dao().fill(cCustInspectPlan)
			.with("leader")
			.with(CCustInspectPlanMeta.TPL_ID)
			.execute();
	...
	*/
	...
	public Result<PagedList<CCustInspectPlan>> queryPagedList(CCustInspectPlanVO sample) {
		...
		// join 关联的对象
		cCustInspectPlanService.dao().fill(list)
			.with("leader")
			.with(CCustInspectPlanMeta.TPL_ID)
			.execute();
		result.success(true).data(list);
