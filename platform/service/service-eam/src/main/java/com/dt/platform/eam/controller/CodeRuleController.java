...
public class CodeRuleController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = CodeRuleVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "T001"), @ApiImplicitParam(name = CodeRuleVOMeta.NAME, value = "名称", required = false, dataTypeClass = String.class, example = "资产编码"), @ApiImplicitParam(name = CodeRuleVOMeta.VALUE, value = "编码", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = CodeRuleVOMeta.PART_IDS, value = "组成", required = false, dataTypeClass = String.class, example = "[]"), @ApiImplicitParam(name = CodeRuleVOMeta.CODE_SEPARATOR, value = "分割符", required = false, dataTypeClass = String.class, example = "-"), @ApiImplicitParam(name = CodeRuleVOMeta.NUMBER_SEQ, value = "随机数位数", required = false, dataTypeClass = Integer.class, example = "5"), @ApiImplicitParam(name = CodeRuleVOMeta.FS1, value = "固定字符串", required = false, dataTypeClass = String.class, example = "E") })
