...
public class MaintainPlanController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = MaintainPlanVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "585374391123054592"), @ApiImplicitParam(name = MaintainPlanVOMeta.CODE, value = "编号", required = false, dataTypeClass = String.class, example = "121"), @ApiImplicitParam(name = MaintainPlanVOMeta.NAME, value = "方案名称", required = false, dataTypeClass = String.class, example = "1212"), @ApiImplicitParam(name = MaintainPlanVOMeta.STATUS, value = "状态", required = false, dataTypeClass = String.class, example = "enable"), @ApiImplicitParam(name = MaintainPlanVOMeta.GROUP_ID, value = "执行班组", required = false, dataTypeClass = String.class, example = "584133248423034880"), @ApiImplicitParam(name = MaintainPlanVOMeta.MAINTAIN_TYPE, value = "保养类型", required = false, dataTypeClass = String.class, example = "default"), @ApiImplicitParam(name = MaintainPlanVOMeta.CYCLE_METHOD, value = "循环方式", required = false, dataTypeClass = String.class, example = "once"), @ApiImplicitParam(name = MaintainPlanVOMeta.ACTION_CYCLE_ID, value = "保养周期", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = MaintainPlanVOMeta.START_TIME, value = "开始时间", required = false, dataTypeClass = Date.class), @ApiImplicitParam(name = MaintainPlanVOMeta.END_TIME, value = "结束时间", required = false, dataTypeClass = Date.class), @ApiImplicitParam(name = MaintainPlanVOMeta.TOTAL_COST, value = "总工时", required = false, dataTypeClass = BigDecimal.class), @ApiImplicitParam(name = MaintainPlanVOMeta.INFO, value = "方案说明", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = MaintainPlanVOMeta.NOTES, value = "备注", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = MaintainPlanVOMeta.ORIGINATOR_ID, value = "制单人", required = false, dataTypeClass = String.class) })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = MaintainPlanVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "585374391123054592") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = MaintainPlanVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = MaintainPlanVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
