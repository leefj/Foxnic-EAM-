...
public class AssetDepreciationCalRuleController extends SuperController {
    ...
    @ApiImplicitParams({
		...
		@ApiImplicitParam(name = AssetDepreciationCalRuleVOMeta.UPDATE_BY, value = "修改人ID", required = false, dataTypeClass = String.class, example = "110588348101165911")
	})
    ...
    public Result<AssetDepreciationCalRule> getById(String id) {
        ...
        // join 关联的对象
        assetDepreciationCalRuleService.dao().fill(assetDepreciationCalRule).with(AssetDepreciationCalRuleMeta.ASSET_DEPRECIATION).execute();
    ...
    public Result<PagedList<AssetDepreciationCalRule>> queryPagedList(AssetDepreciationCalRuleVO sample) {
        ...
        // join 关联的对象
        assetDepreciationCalRuleService.dao().fill(list).with(AssetDepreciationCalRuleMeta.ASSET_DEPRECIATION).execute();
        result.success(true).data(list);
        return result;
    }
}
