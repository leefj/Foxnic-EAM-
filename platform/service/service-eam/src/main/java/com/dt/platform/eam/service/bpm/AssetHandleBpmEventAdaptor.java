...
public class AssetHandleBpmEventAdaptor extends BpmEventAdaptor<AssetHandle,IAssetHandleService> {

	public String BPM_TABLE="eam_asset_handle";
	...
	public AssetHandleBpmEventAdaptor(IAssetHandleService service) {
		super(service);
	}
