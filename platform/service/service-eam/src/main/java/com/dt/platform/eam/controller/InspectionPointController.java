...
public class InspectionPointController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InspectionPointVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "571598323383795712"), @ApiImplicitParam(name = InspectionPointVOMeta.CODE, value = "编码", required = false, dataTypeClass = String.class, example = "巡检点1"), @ApiImplicitParam(name = InspectionPointVOMeta.NAME, value = "名称", required = false, dataTypeClass = String.class, example = "巡检点1"), @ApiImplicitParam(name = InspectionPointVOMeta.STATUS, value = "状态", required = false, dataTypeClass = String.class, example = "enable"), @ApiImplicitParam(name = InspectionPointVOMeta.CONTENT, value = "巡检内容", required = false, dataTypeClass = String.class, example = "巡检1"), @ApiImplicitParam(name = InspectionPointVOMeta.ROUTE_ID, value = "巡检路线", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InspectionPointVOMeta.RFID, value = "RFID", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InspectionPointVOMeta.POS, value = "位置", required = false, dataTypeClass = String.class, example = "1"), @ApiImplicitParam(name = InspectionPointVOMeta.POS_LONGITUDE, value = "位置经度", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InspectionPointVOMeta.POS_LATITUDE, value = "位置纬度", required = false, dataTypeClass = String.class, example = "1"), @ApiImplicitParam(name = InspectionPointVOMeta.NOTES, value = "备注", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = InspectionPointVOMeta.PICTURE_ID, value = "图片", required = false, dataTypeClass = String.class) })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InspectionPointVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "571598323383795712") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InspectionPointVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = InspectionPointVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
