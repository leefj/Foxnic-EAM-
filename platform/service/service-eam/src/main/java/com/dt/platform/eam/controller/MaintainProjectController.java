...
public class MaintainProjectController extends SuperController {
    ...
    @ApiImplicitParams({
		...
		@ApiImplicitParam(name = MaintainProjectVOMeta.BASE_COST, value = "标准工时", required = false, dataTypeClass = BigDecimal.class, example = "12.00"),
		...
		@ApiImplicitParam(name = MaintainProjectVOMeta.CONTENT, value = "保养内容", required = false, dataTypeClass = String.class)
	})
    ...
    public Result<PagedList<MaintainProject>> queryPagedList1(MaintainProjectVO sample) {
    ...
    public Result<PagedList<MaintainProject>> queryPagedList2(MaintainProjectVO sample, String ownerId, String ownerType) {
        Result<PagedList<MaintainProject>> result = new Result<>();
