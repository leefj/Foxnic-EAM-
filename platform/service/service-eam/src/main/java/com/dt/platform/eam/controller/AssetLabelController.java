...
public class AssetLabelController extends SuperController {
    ...
    @ApiImplicitParams({
		...
		@ApiImplicitParam(name = AssetLabelVOMeta.LABEL_LAYOUT, value = "标签布局", required = false, dataTypeClass = String.class),
		...
		@ApiImplicitParam(name = AssetLabelVOMeta.LABEL_TABLE_MARGIN_TOP, value = "表格marginTop", required = false, dataTypeClass = BigDecimal.class, example = "0.00"),
		@ApiImplicitParam(name = AssetLabelVOMeta.LABEL_TABLE_MARGIN_BOTTOM, value = "表格marginBottom", required = false, dataTypeClass = BigDecimal.class, example = "0.00"),
		@ApiImplicitParam(name = AssetLabelVOMeta.LABEL_TABLE_MARGIN_LEFT, value = "表格marginLeft", required = false, dataTypeClass = BigDecimal.class, example = "0.00"),
		@ApiImplicitParam(name = AssetLabelVOMeta.LABEL_TABLE_MARGIN_RIGHT, value = "表格marginRight", required = false, dataTypeClass = BigDecimal.class, example = "0.00"),
		...
		@ApiImplicitParam(name = AssetLabelVOMeta.UPDATE_BY, value = "修改人ID", required = false, dataTypeClass = String.class, example = "110588348101165911")
	})
