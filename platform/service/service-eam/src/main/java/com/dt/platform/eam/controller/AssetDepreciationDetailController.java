...
public class AssetDepreciationDetailController extends SuperController {
    ...
    public Result<AssetDepreciationDetail> getById(String id) {
        ...
        // join 关联的对象
        assetDepreciationDetailService.dao().fill(assetDepreciationDetail).with(AssetDepreciationDetailMeta.ASSET_DEPRECIATION).with(AssetDepreciationDetailMeta.ASSET_DEPRECIATION_OPER).with(AssetDepreciationDetailMeta.ASSET).execute();
    ...
    public Result<PagedList<AssetDepreciationDetail>> queryPagedList(AssetDepreciationDetailVO sample) {
        ...
        // join 关联的对象
        assetDepreciationDetailService.dao().fill(list).with(AssetDepreciationDetailMeta.ASSET_DEPRECIATION).with(AssetDepreciationDetailMeta.ASSET_DEPRECIATION_OPER).with(AssetDepreciationDetailMeta.ASSET).execute();
        result.success(true).data(list);
        return result;
    }
