...
public class AssetItemController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = AssetItemVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "568055947281301504"), @ApiImplicitParam(name = AssetItemVOMeta.HANDLE_ID, value = "处理", required = false, dataTypeClass = String.class, example = "568055947201609728"), @ApiImplicitParam(name = AssetItemVOMeta.ASSET_ID, value = "资产", required = false, dataTypeClass = String.class, example = "568055936627769344"), @ApiImplicitParam(name = AssetItemVOMeta.BEFORE_USE_USER_ID, value = "资产使用人", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = AssetItemVOMeta.BEFORE_ASSET_STATUS, value = "资产状态", required = false, dataTypeClass = String.class), @ApiImplicitParam(name = AssetItemVOMeta.CRD, value = "修改标记", required = false, dataTypeClass = String.class, example = "r"), @ApiImplicitParam(name = AssetItemVOMeta.SELECTED_CODE, value = "选择", required = false, dataTypeClass = String.class) })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = AssetItemVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "568055947281301504") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = AssetItemVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = AssetItemVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
