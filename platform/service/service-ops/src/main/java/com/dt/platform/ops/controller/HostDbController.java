...
public class HostDbController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = HostDbVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "495707591398129665"), @ApiImplicitParam(name = HostDbVOMeta.HOST_ID, value = "主机", required = false, dataTypeClass = String.class, example = "495707314385321984"), @ApiImplicitParam(name = HostDbVOMeta.SERVICE_INFO_ID, value = "服务内容", required = false, dataTypeClass = String.class, example = "495614616022286336") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = HostDbVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "495707591398129665") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = HostDbVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = HostDbVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
