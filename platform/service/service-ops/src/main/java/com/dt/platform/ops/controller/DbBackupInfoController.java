...
public class DbBackupInfoController extends SuperController {
	...
	*/
	...
	@NotNull(name = DbBackupInfoVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = dbBackupInfoService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = DbBackupInfoVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = dbBackupInfoService.hasRefers(ids);
		// 收集可以删除的ID值
