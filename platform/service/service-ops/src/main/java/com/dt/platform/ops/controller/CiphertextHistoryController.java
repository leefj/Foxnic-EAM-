...
public class CiphertextHistoryController extends SuperController {
	...
	*/
	...
	@NotNull(name = CiphertextHistoryVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = ciphertextHistoryService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = CiphertextHistoryVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = ciphertextHistoryService.hasRefers(ids);
		// 收集可以删除的ID值
