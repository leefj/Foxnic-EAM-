...
public class CiphertextConfController extends SuperController {
	...
	*/
	...
	@NotNull(name = CiphertextConfVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = ciphertextConfService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = CiphertextConfVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = ciphertextConfService.hasRefers(ids);
		// 收集可以删除的ID值
