...
public class AutoActionFileController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = AutoActionFileVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class , example = "613759342629355520"),
		@ApiImplicitParam(name = AutoActionFileVOMeta.NAME , value = "名称" , required = false , dataTypeClass=String.class , example = "12"),
		@ApiImplicitParam(name = AutoActionFileVOMeta.FILE_NAME , value = "文件名称" , required = false , dataTypeClass=String.class , example = "12"),
		@ApiImplicitParam(name = AutoActionFileVOMeta.FILE_ID , value = "文件" , required = false , dataTypeClass=String.class , example = "613759333934563328"),
		@ApiImplicitParam(name = AutoActionFileVOMeta.NOTES , value = "备注" , required = false , dataTypeClass=String.class , example = "1212"),
	})
	...
	*/
	...
	@ApiOperationSupport( order=4 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AutoActionFileVOMeta.PAGE_INDEX , AutoActionFileVOMeta.PAGE_SIZE , AutoActionFileVOMeta.SEARCH_FIELD , AutoActionFileVOMeta.FUZZY_FIELD , AutoActionFileVOMeta.SEARCH_VALUE , AutoActionFileVOMeta.DIRTY_FIELDS , AutoActionFileVOMeta.SORT_FIELD , AutoActionFileVOMeta.SORT_TYPE , AutoActionFileVOMeta.DATA_ORIGIN , AutoActionFileVOMeta.QUERY_LOGIC , AutoActionFileVOMeta.REQUEST_ACTION , AutoActionFileVOMeta.IDS } )
	...
	*/
	...
	@ApiParamSupport(ignoreDBTreatyProperties = true, ignoreDefaultVoProperties = true)
	@ApiOperationSupport(order=5 ,  ignoreParameters = { AutoActionFileVOMeta.PAGE_INDEX , AutoActionFileVOMeta.PAGE_SIZE , AutoActionFileVOMeta.SEARCH_FIELD , AutoActionFileVOMeta.FUZZY_FIELD , AutoActionFileVOMeta.SEARCH_VALUE , AutoActionFileVOMeta.DIRTY_FIELDS , AutoActionFileVOMeta.SORT_FIELD , AutoActionFileVOMeta.SORT_TYPE , AutoActionFileVOMeta.DATA_ORIGIN , AutoActionFileVOMeta.QUERY_LOGIC , AutoActionFileVOMeta.REQUEST_ACTION , AutoActionFileVOMeta.IDS } )
	...
	*/
	...
	@ApiOperationSupport(order=5 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AutoActionFileVOMeta.PAGE_INDEX , AutoActionFileVOMeta.PAGE_SIZE } )
