...
public class CmdbLogController extends SuperController {
	...
	*/
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = cmdbLogService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = cmdbLogService.hasRefers(ids);
		// 收集可以删除的ID值
	...
	*/
	...
	public Result<CmdbLog> getById(String id) {
		...
		// join 关联的对象
		cmdbLogService.dao().fill(cmdbLog)
			.with(CmdbLogMeta.CMDB_MODEL)
			.with(CmdbLogMeta.CMDB_MODEL_V)
			.execute();
