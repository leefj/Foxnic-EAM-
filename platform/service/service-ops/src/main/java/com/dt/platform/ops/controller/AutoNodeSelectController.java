...
public class AutoNodeSelectController extends SuperController {
	...
	*/
	...
	@NotNull(name = AutoNodeSelectVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = autoNodeSelectService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AutoNodeSelectVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = autoNodeSelectService.hasRefers(ids);
		// 收集可以删除的ID值
