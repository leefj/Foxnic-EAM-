...
public class AutoTaskMLogController extends SuperController {
	...
	*/
	...
	@NotNull(name = AutoTaskMLogVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = autoTaskMLogService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AutoTaskMLogVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = autoTaskMLogService.hasRefers(ids);
		// 收集可以删除的ID值
	...
	*/
	...
	public Result<AutoTaskMLog> getById(String id) {
		...
		// join 关联的对象
		autoTaskMLogService.dao().fill(autoTaskMLog)
	...
	*/
	...
	public Result<PagedList<AutoTaskMLog>> queryPagedList(AutoTaskMLogVO sample) {
		...
		// join 关联的对象
		autoTaskMLogService.dao().fill(list)
			.with(AutoTaskMLogMeta.TASK)
			.with(AutoTaskMLogMeta.ACTION)
			.execute();
		result.success(true).data(list);
