...
public class IpAddressRangeController extends SuperController {
	...
	*/
	...
	@NotNull(name = IpAddressRangeVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = ipAddressRangeService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = IpAddressRangeVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = ipAddressRangeService.hasRefers(ids);
		// 收集可以删除的ID值
