...
public class IpAddressRangeController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = IpAddressRangeVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = IpAddressRangeVOMeta.STATUS , value = "状态" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = IpAddressRangeVOMeta.ADDRESS_SEGMENT , value = "地址段" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = IpAddressRangeVOMeta.REGION_ID , value = "区域" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = IpAddressRangeVOMeta.CLASS_ID , value = "分类" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = IpAddressRangeVOMeta.PROD_ID , value = "环境" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = IpAddressRangeVOMeta.SCENE , value = "场景" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = IpAddressRangeVOMeta.VLAN , value = "VLAN" , required = false , dataTypeClass=String.class),
	...
	*/
	...
	public Result<IpAddressRange> getById(String id) {
		...
		// join 关联的对象
		ipAddressRangeService.dao().fill(ipAddressRange)
			.with(IpAddressRangeMeta.REGION_DICT)
			.with(IpAddressRangeMeta.PROD_DICT)
			.with(IpAddressRangeMeta.CLASS_DICT)
			.execute();
	...
	*/
	...
	@ApiOperationSupport(order=5 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { IpAddressRangeVOMeta.PAGE_INDEX , IpAddressRangeVOMeta.PAGE_SIZE } )
	...
	*/
	...
	public Result<PagedList<IpAddressRange>> queryPagedList(IpAddressRangeVO sample) {
		...
		// join 关联的对象
		ipAddressRangeService.dao().fill(list)
			.with(IpAddressRangeMeta.REGION_DICT)
			.with(IpAddressRangeMeta.PROD_DICT)
			.with(IpAddressRangeMeta.CLASS_DICT)
			.execute();
