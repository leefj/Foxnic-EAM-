...
public class MonitorTplGraphController extends SuperController {
	...
	*/
	...
	@ApiOperationSupport( order=4 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { MonitorTplGraphVOMeta.PAGE_INDEX , MonitorTplGraphVOMeta.PAGE_SIZE , MonitorTplGraphVOMeta.SEARCH_FIELD , MonitorTplGraphVOMeta.FUZZY_FIELD , MonitorTplGraphVOMeta.SEARCH_VALUE , MonitorTplGraphVOMeta.DIRTY_FIELDS , MonitorTplGraphVOMeta.SORT_FIELD , MonitorTplGraphVOMeta.SORT_TYPE , MonitorTplGraphVOMeta.DATA_ORIGIN , MonitorTplGraphVOMeta.QUERY_LOGIC , MonitorTplGraphVOMeta.REQUEST_ACTION , MonitorTplGraphVOMeta.IDS } )
	...
	*/
	...
	@ApiOperationSupport(order=5 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { MonitorTplGraphVOMeta.PAGE_INDEX , MonitorTplGraphVOMeta.PAGE_SIZE } )
