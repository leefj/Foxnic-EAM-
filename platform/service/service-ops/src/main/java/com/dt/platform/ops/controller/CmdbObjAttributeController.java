...
public class CmdbObjAttributeController extends SuperController {
	...
	*/
	...
	public Result<CmdbObjAttribute> getById(String id) {
		...
		// join 关联的对象
		cmdbObjAttributeService.dao().fill(cmdbObjAttribute)
			.with(CmdbObjAttributeMeta.CMDB_ATTRIBUTE_C)
			.with(CmdbObjAttributeMeta.CMDB_MODEL)
			.execute();
	...
	*/
	...
	public Result<PagedList<CmdbObjAttribute>> queryPagedList(CmdbObjAttributeVO sample) {
		...
		// join 关联的对象
		cmdbObjAttributeService.dao().fill(list)
			.with(CmdbObjAttributeMeta.CMDB_ATTRIBUTE_C)
			.with(CmdbObjAttributeMeta.CMDB_MODEL)
			.execute();
		result.success(true).data(list);
