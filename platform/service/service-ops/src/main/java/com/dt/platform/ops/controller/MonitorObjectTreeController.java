...
public class MonitorObjectTreeController extends SuperController {
	...
	*/
	...
	@NotNull(name = MonitorObjectTreeVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = monitorObjectTreeService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = MonitorObjectTreeVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = monitorObjectTreeService.hasRefers(ids);
		// 收集可以删除的ID值
