...
public class AutoVoucherController extends SuperController {
	...
	*/
	...
	@ApiOperationSupport( order=4 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AutoVoucherVOMeta.PAGE_INDEX , AutoVoucherVOMeta.PAGE_SIZE , AutoVoucherVOMeta.SEARCH_FIELD , AutoVoucherVOMeta.FUZZY_FIELD , AutoVoucherVOMeta.SEARCH_VALUE , AutoVoucherVOMeta.DIRTY_FIELDS , AutoVoucherVOMeta.SORT_FIELD , AutoVoucherVOMeta.SORT_TYPE , AutoVoucherVOMeta.DATA_ORIGIN , AutoVoucherVOMeta.QUERY_LOGIC , AutoVoucherVOMeta.REQUEST_ACTION , AutoVoucherVOMeta.IDS } )
	...
	*/
	...
	@ApiOperationSupport(order=5 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AutoVoucherVOMeta.PAGE_INDEX , AutoVoucherVOMeta.PAGE_SIZE } )
