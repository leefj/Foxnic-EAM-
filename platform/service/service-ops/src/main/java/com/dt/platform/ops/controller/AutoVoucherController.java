...
public class AutoVoucherController extends SuperController {
	...
	*/
	...
	@NotNull(name = AutoVoucherVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = autoVoucherService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = AutoVoucherVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = autoVoucherService.hasRefers(ids);
		// 收集可以删除的ID值
