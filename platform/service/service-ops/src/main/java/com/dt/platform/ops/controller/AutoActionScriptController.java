...
public class AutoActionScriptController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = AutoActionScriptVOMeta.NAME , value = "名称" , required = false , dataTypeClass=String.class , example = "b.java"),
		@ApiImplicitParam(name = AutoActionScriptVOMeta.FILE_NAME , value = "文件名称" , required = false , dataTypeClass=String.class , example = "b.java"),
		@ApiImplicitParam(name = AutoActionScriptVOMeta.FILE_ID , value = "文件" , required = false , dataTypeClass=String.class , example = "614434136450400257"),
	...
	*/
	...
	@ApiOperationSupport( order=4 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AutoActionScriptVOMeta.PAGE_INDEX , AutoActionScriptVOMeta.PAGE_SIZE , AutoActionScriptVOMeta.SEARCH_FIELD , AutoActionScriptVOMeta.FUZZY_FIELD , AutoActionScriptVOMeta.SEARCH_VALUE , AutoActionScriptVOMeta.DIRTY_FIELDS , AutoActionScriptVOMeta.SORT_FIELD , AutoActionScriptVOMeta.SORT_TYPE , AutoActionScriptVOMeta.DATA_ORIGIN , AutoActionScriptVOMeta.QUERY_LOGIC , AutoActionScriptVOMeta.REQUEST_ACTION , AutoActionScriptVOMeta.IDS } )
	...
	*/
	...
	@ApiOperationSupport(order=5 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { AutoActionScriptVOMeta.PAGE_INDEX , AutoActionScriptVOMeta.PAGE_SIZE } )
