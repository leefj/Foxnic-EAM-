...
public class MonitorObjectGrafanaController extends SuperController {
	...
	*/
	...
	@NotNull(name = MonitorObjectGrafanaVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = monitorObjectGrafanaService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = MonitorObjectGrafanaVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = monitorObjectGrafanaService.hasRefers(ids);
		// 收集可以删除的ID值
