...
public class DbBackupRecordController extends SuperController {
	 ...
	 * 添加数据库备份记录
	*/
	@ApiOperation(value = "添加数据库备份记录")
	@ApiImplicitParams({
		@ApiImplicitParam(name = DbBackupRecordVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.DB_ID , value = "数据库" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.DB_BK_ID , value = "数据备份" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.DB_NAME , value = "数据库名称" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.BACKUP_RESULT , value = "备份结果" , required = false , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = DbBackupRecordVOMeta.BACKUP_STIME , value = "开始时间" , required = false , dataTypeClass=Date.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.BACKUP_ETIME , value = "结束时间" , required = false , dataTypeClass=Date.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.BACKUP_SIZE , value = "备份大小" , required = false , dataTypeClass=BigDecimal.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.STRATEGY , value = "备份策略" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.RETENTION , value = "备份保留" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.NOTES , value = "备注" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.UPDATE_BY , value = "修改人ID" , required = false , dataTypeClass=String.class),
	})
	...
	*/
	 ...
	 * 联合主键时，请自行调整实现
	*/
	@ApiOperation(value = "批量删除数据库备份记录")
	@ApiImplicitParams({
	...
	*/
	...
	@ApiOperationSupport( order=4 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { DbBackupRecordVOMeta.PAGE_INDEX , DbBackupRecordVOMeta.PAGE_SIZE , DbBackupRecordVOMeta.SEARCH_FIELD , DbBackupRecordVOMeta.FUZZY_FIELD , DbBackupRecordVOMeta.SEARCH_VALUE , DbBackupRecordVOMeta.DIRTY_FIELDS , DbBackupRecordVOMeta.SORT_FIELD , DbBackupRecordVOMeta.SORT_TYPE , DbBackupRecordVOMeta.DATA_ORIGIN , DbBackupRecordVOMeta.QUERY_LOGIC , DbBackupRecordVOMeta.REQUEST_ACTION , DbBackupRecordVOMeta.IDS } )
	...
	*/
	...
	public Result<DbBackupRecord> getById(String id) {
		...
		// join 关联的对象
		dbBackupRecordService.dao().fill(dbBackupRecord)
			.with(DbBackupRecordMeta.HOST)
			.with(DbBackupRecordMeta.DB)
			.with(DbBackupRecordMeta.DB_TYPE)
			.with(DbBackupRecordMeta.BACKUP_INFO)
			.execute();
	 ...
	 * 联合主键时，请自行调整实现
	*/
		@ApiOperation(value = "批量获取数据库备份记录")
		@ApiImplicitParams({
				@ApiImplicitParam(name = DbBackupRecordVOMeta.IDS , value = "主键清单" , required = true , dataTypeClass=List.class , example = "[1,3,4]")
		})
		@ApiOperationSupport(order=3 , author="金杰 , maillank@qq.com") 
	...
	*/
	...
	@ApiOperationSupport(order=5 , author="金杰 , maillank@qq.com" ,  ignoreParameters = { DbBackupRecordVOMeta.PAGE_INDEX , DbBackupRecordVOMeta.PAGE_SIZE } )
	 ...
	 * 分页查询数据库备份记录
	*/
	@ApiOperation(value = "分页查询数据库备份记录")
	@ApiImplicitParams({
		@ApiImplicitParam(name = DbBackupRecordVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.DB_ID , value = "数据库" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = DbBackupRecordVOMeta.DB_BK_ID , value = "数据备份" , required = false , dataTypeClass=String.class),
	...
	public Result<PagedList<DbBackupRecord>> queryPagedList(DbBackupRecordVO sample) {
		...
		// join 关联的对象
		dbBackupRecordService.dao().fill(list)
			.with(DbBackupRecordMeta.HOST)
			.with(DbBackupRecordMeta.DB)
			.with(DbBackupRecordMeta.DB_TYPE)
			.with(DbBackupRecordMeta.BACKUP_INFO)
