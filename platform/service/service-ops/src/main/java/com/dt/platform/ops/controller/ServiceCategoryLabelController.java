...
public class ServiceCategoryLabelController extends SuperController {
	...
	*/
	...
	@NotNull(name = ServiceCategoryLabelVOMeta.ID)
	...
	public Result deleteById(String id) {
		...
		// 引用校验
		Boolean hasRefer = serviceCategoryLabelService.hasRefers(id);
		// 判断是否可以删除
	...
	*/
	...
	@NotNull(name = ServiceCategoryLabelVOMeta.IDS)
	...
	public Result deleteByIds(List<String> ids) {
		...
		// 查询引用
		Map<String, Boolean> hasRefersMap = serviceCategoryLabelService.hasRefers(ids);
		// 收集可以删除的ID值
