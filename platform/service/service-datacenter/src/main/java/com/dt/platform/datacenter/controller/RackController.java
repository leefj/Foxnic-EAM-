...
public class RackController extends SuperController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = RackVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "565459579211616256"), @ApiImplicitParam(name = RackVOMeta.RACK_CODE, value = "编码", required = false, dataTypeClass = String.class, example = "G01"), @ApiImplicitParam(name = RackVOMeta.RACK_TYPE, value = "类型", required = false, dataTypeClass = String.class, example = "scattered"), @ApiImplicitParam(name = RackVOMeta.RACK_NAME, value = "名称", required = false, dataTypeClass = String.class, example = "G01"), @ApiImplicitParam(name = RackVOMeta.STATUS, value = "状态", required = false, dataTypeClass = String.class, example = "using"), @ApiImplicitParam(name = RackVOMeta.ENVIRONMENT, value = "环境", required = false, dataTypeClass = String.class, example = "prod"), @ApiImplicitParam(name = RackVOMeta.RACK_USED_TYPE, value = "使用分类", required = false, dataTypeClass = String.class, example = "network"), @ApiImplicitParam(name = RackVOMeta.AREA_ID, value = "区域", required = false, dataTypeClass = String.class, example = "565457749140312064"), @ApiImplicitParam(name = RackVOMeta.LAYER_ID, value = "层级", required = false, dataTypeClass = String.class, example = "565457784187916288"), @ApiImplicitParam(name = RackVOMeta.RACK_CAPTICAL, value = "容量", required = false, dataTypeClass = BigDecimal.class, example = "12.00"), @ApiImplicitParam(name = RackVOMeta.U_POSTION_NUMBER, value = "U位数量", required = false, dataTypeClass = Integer.class, example = "45"), @ApiImplicitParam(name = RackVOMeta.PDU_NUMBER, value = "PDU数量", required = false, dataTypeClass = Integer.class, example = "12"), @ApiImplicitParam(name = RackVOMeta.JUMPER_NUMBER, value = "跳线数", required = false, dataTypeClass = Integer.class, example = "12"), @ApiImplicitParam(name = RackVOMeta.CONTRACT_POWER, value = "合同电力", required = false, dataTypeClass = Integer.class, example = "12"), @ApiImplicitParam(name = RackVOMeta.EQUIPMENT_NUMBER, value = "设备数量", required = false, dataTypeClass = Integer.class, example = "0"), @ApiImplicitParam(name = RackVOMeta.EXPIRE_DATE, value = "到期日期", required = false, dataTypeClass = Date.class, example = "2022-04-15 12:00:00"), @ApiImplicitParam(name = RackVOMeta.RACK_LABEL1, value = "标签1", required = false, dataTypeClass = String.class, example = "12"), @ApiImplicitParam(name = RackVOMeta.RACK_LABEL2, value = "标签2", required = false, dataTypeClass = String.class, example = "12"), @ApiImplicitParam(name = RackVOMeta.RACK_NOTES, value = "备注", required = false, dataTypeClass = String.class, example = "121212") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = RackVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "565459579211616256") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = RackVOMeta.IDS, value = "主键清单", required = true, dataTypeClass = List.class, example = "[1,3,4]") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = RackVOMeta.ID, value = "主键", required = true, dataTypeClass = String.class, example = "1") })
