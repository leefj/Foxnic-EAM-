...
public interface IContractSignerService extends  ISimpleIdService<ContractSigner,String> {
	 ...
	 * @return 实体集
	 * */
	List<ContractSigner> queryListByIds(List<String> ids);

	/**
	 * 按 id 列表查询 Map
	 * @param ids  主键清单
	 * */
	Map<String, ContractSigner> queryMapByIds(List<String> ids);
	 ...
	 * @return 查询结果
	 * */
	List<ContractSigner> queryList(ContractSignerVO sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<ContractSigner> queryPagedList(ContractSignerVO sample,int pageSize,int pageIndex);
