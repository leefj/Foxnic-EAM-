...
@Service("HrSalaryProjectTimeRcdService")

public class SalaryProjectTimeRcdServiceImpl extends SuperService<SalaryProjectTimeRcd> implements ISalaryProjectTimeRcdService {
	 ...
	 */
	@Override
	public Result insert(SalaryProjectTimeRcd salaryProjectTimeRcd,boolean throwsException) {
		Result r=super.insert(salaryProjectTimeRcd,throwsException);
		return r;
	}
	 ...
	 * */
	@Override
	public Result insert(SalaryProjectTimeRcd salaryProjectTimeRcd) {
		return this.insert(salaryProjectTimeRcd,true);
	}
	 ...
	 * */
	@Override
	public Result insertList(List<SalaryProjectTimeRcd> salaryProjectTimeRcdList) {
		return super.insertList(salaryProjectTimeRcdList);
	}
	...
	public Result deleteByIdPhysical(String id) {
		SalaryProjectTimeRcd salaryProjectTimeRcd = new SalaryProjectTimeRcd();
		if(id==null) return ErrorDesc.failure().message("id 不允许为 null 。");
		salaryProjectTimeRcd.setId(id);
		try {
			boolean suc = dao.deleteEntity(salaryProjectTimeRcd);
	...
	public Result deleteByIdLogical(String id) {
		...
		if(id==null) return ErrorDesc.failure().message("id 不允许为 null 。");
		salaryProjectTimeRcd.setId(id);
		salaryProjectTimeRcd.setDeleted(true);
		salaryProjectTimeRcd.setDeleteBy((String)dao.getDBTreaty().getLoginUserId());
		salaryProjectTimeRcd.setDeleteTime(new Date());
		try {
			boolean suc = dao.updateEntity(salaryProjectTimeRcd,SaveMode.NOT_NULL_FIELDS);
			return suc?ErrorDesc.success():ErrorDesc.failure();
		}
		catch(Exception e) {
			Result r= ErrorDesc.failure();
	 ...
	 * */
	@Override
	public Result update(SalaryProjectTimeRcd salaryProjectTimeRcd , SaveMode mode) {
		return this.update(salaryProjectTimeRcd,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(SalaryProjectTimeRcd salaryProjectTimeRcd , SaveMode mode,boolean throwsException) {
		Result r=super.update(salaryProjectTimeRcd , mode , throwsException);
		return r;
	}
	 ...
	 * */
	@Override
	public Result updateList(List<SalaryProjectTimeRcd> salaryProjectTimeRcdList , SaveMode mode) {
		return super.updateList(salaryProjectTimeRcdList , mode);
	}
	 ...
	 */
	public SalaryProjectTimeRcd getById(String id) {
		SalaryProjectTimeRcd sample = new SalaryProjectTimeRcd();
		if(id==null) throw new IllegalArgumentException("id 不允许为 null ");
		sample.setId(id);
	 ...
	 * */
	@Override
	public List<SalaryProjectTimeRcd> getByIds(List<String> ids) {
		return this.queryListByIds(ids);
	}

	@Override
	public List<SalaryProjectTimeRcd> queryListByIds(List<String> ids) {
		return super.queryListByUKeys("id",ids);
	}

	@Override
	public Map<String, SalaryProjectTimeRcd> queryMapByIds(List<String> ids) {
		return super.queryMapByUKeys("id",ids, SalaryProjectTimeRcd::getId);
	}
	 ...
	 * */
	@Override
	public List<SalaryProjectTimeRcd> queryList(SalaryProjectTimeRcdVO sample) {
	 ...
	 * */
	@Override
	public PagedList<SalaryProjectTimeRcd> queryPagedList(SalaryProjectTimeRcdVO sample, int pageSize, int pageIndex) {
	 ...
	 * */
	@Override
	public PagedList<SalaryProjectTimeRcd> queryPagedList(SalaryProjectTimeRcd sample, ConditionExpr condition, int pageSize, int pageIndex) {
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(SalaryProjectTimeRcd salaryProjectTimeRcd) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(salaryProjectTimeRcd, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
