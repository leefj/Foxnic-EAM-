...
public class AssessmentIndicatorValueController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = AssessmentIndicatorValueVOMeta.OWNER , value = "评分人类型" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssessmentIndicatorValueVOMeta.USER_ID , value = "评分人" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssessmentIndicatorValueVOMeta.VALUE , value = "评分" , required = false , dataTypeClass=BigDecimal.class),
		@ApiImplicitParam(name = AssessmentIndicatorValueVOMeta.CONTENT , value = "说明" , required = false , dataTypeClass=String.class),
