...
public class AssessmentTaskController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = AssessmentTaskVOMeta.STATUS , value = "考核状态" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssessmentTaskVOMeta.NAME , value = "考核名称" , required = false , dataTypeClass=String.class , example = "12"),
		@ApiImplicitParam(name = AssessmentTaskVOMeta.POS_ID , value = "岗位" , required = false , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = AssessmentTaskVOMeta.SAME_LEVEL_USER_ID , value = "同级评分人" , required = false , dataTypeClass=String.class),
		...
		@ApiImplicitParam(name = AssessmentTaskVOMeta.HAS_SELF_ASSESSMENT , value = "自评" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssessmentTaskVOMeta.HAS_SAME_ASSESSMENT , value = "同级评分" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssessmentTaskVOMeta.HAS_LEADER_ASSESSMENT , value = "直接领导评分" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssessmentTaskVOMeta.HAS_SECOND_LEADER_ASSESSMENT , value = "领导评分" , required = false , dataTypeClass=String.class),
		@ApiImplicitParam(name = AssessmentTaskVOMeta.HAS_HR_CONFIRM , value = "HR复核" , required = false , dataTypeClass=String.class),
	...
	*/
	...
	public Result<AssessmentTask> getById(String id) {
		...
		// join 关联的对象
		assessmentTaskService.dao().fill(assessmentTask)
			.with(AssessmentTaskMeta.ASSESSMENT_TPL)
			.execute();
	...
	*/
	...
	public Result<PagedList<AssessmentTask>> queryPagedList(AssessmentTaskVO sample) {
		...
		// join 关联的对象
		assessmentTaskService.dao().fill(list)
			.with(AssessmentTaskMeta.ASSESSMENT_TPL)
			.execute();
		result.success(true).data(list);
		return result;
