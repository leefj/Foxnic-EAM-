...
@Service("HrAttendanceOvertimeService")

public class AttendanceOvertimeServiceImpl extends SuperService<AttendanceOvertime> implements IAttendanceOvertimeService {
	 ...
	 *
	 * @param attendanceOvertime  数据对象
	 * @param throwsException 是否抛出异常，如果不抛出异常，则返回一个失败的 Result 对象
	 * @return 结果 , 如果失败返回 false，成功返回 true
	 */
	@Override
	public Result insert(AttendanceOvertime attendanceOvertime,boolean throwsException) {
		Result r=super.insert(attendanceOvertime,throwsException);
		return r;
	}
	 ...
	 * */
	@Override
	public Result insert(AttendanceOvertime attendanceOvertime) {
		return this.insert(attendanceOvertime,true);
	}

	/**
	 * 批量插入实体，事务内
	 * @param attendanceOvertimeList 实体数据清单
	 * @return 插入是否成功
	 * */
	@Override
	public Result insertList(List<AttendanceOvertime> attendanceOvertimeList) {
		return super.insertList(attendanceOvertimeList);
	}
	...
	public Result deleteByIdPhysical(String id) {
		...
		attendanceOvertime.setId(id);
		try {
			boolean suc = dao.deleteEntity(attendanceOvertime);
	...
	public Result deleteByIdLogical(String id) {
		...
		if(id==null) return ErrorDesc.failure().message("id 不允许为 null 。");
		attendanceOvertime.setId(id);
		attendanceOvertime.setDeleted(true);
		attendanceOvertime.setDeleteBy((String)dao.getDBTreaty().getLoginUserId());
		attendanceOvertime.setDeleteTime(new Date());
		try {
			boolean suc = dao.updateEntity(attendanceOvertime,SaveMode.NOT_NULL_FIELDS);
			return suc?ErrorDesc.success():ErrorDesc.failure();
		}
		catch(Exception e) {
			Result r= ErrorDesc.failure();
	 ...
	 * */
	@Override
	public Result update(AttendanceOvertime attendanceOvertime , SaveMode mode) {
		return this.update(attendanceOvertime,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(AttendanceOvertime attendanceOvertime , SaveMode mode,boolean throwsException) {
		Result r=super.update(attendanceOvertime , mode , throwsException);
		return r;
	}

	/**
	 * 更新实体集，事务内
	 * @param attendanceOvertimeList 数据对象列表
	 * @param mode 保存模式
	 * @return 保存是否成功
	 * */
	@Override
	public Result updateList(List<AttendanceOvertime> attendanceOvertimeList , SaveMode mode) {
		return super.updateList(attendanceOvertimeList , mode);
	}
	 ...
	 *
	 * @param id 主键
	 * @return AttendanceOvertime 数据对象
	 */
	public AttendanceOvertime getById(String id) {
		AttendanceOvertime sample = new AttendanceOvertime();
		if(id==null) throw new IllegalArgumentException("id 不允许为 null ");
		sample.setId(id);
	 ...
	 * */
	@Override
	public List<AttendanceOvertime> getByIds(List<String> ids) {
		return this.queryListByIds(ids);
	}

	@Override
	public List<AttendanceOvertime> queryListByIds(List<String> ids) {
		return super.queryListByUKeys("id",ids);
	}

	@Override
	public Map<String, AttendanceOvertime> queryMapByIds(List<String> ids) {
		return super.queryMapByUKeys("id",ids, AttendanceOvertime::getId);
	}
	 ...
	 * */
	@Override
	public List<AttendanceOvertime> queryList(AttendanceOvertimeVO sample) {
	 ...
	 * */
	@Override
	public PagedList<AttendanceOvertime> queryPagedList(AttendanceOvertimeVO sample, int pageSize, int pageIndex) {
	 ...
	 * */
	@Override
	public PagedList<AttendanceOvertime> queryPagedList(AttendanceOvertime sample, ConditionExpr condition, int pageSize, int pageIndex) {
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(AttendanceOvertime attendanceOvertime) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(attendanceOvertime, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
	...
	@Override
	public ExcelWriter exportExcel(AttendanceOvertime sample) {
	...
	public List<ValidateResult> importData(RcdSet rs) {
		...
		HashMap<String,String> typeDictMap=queryDictItemDataByDictCode("hr_attendance_overtime_type");
