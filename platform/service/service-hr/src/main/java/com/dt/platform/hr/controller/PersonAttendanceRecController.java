...
public class PersonAttendanceRecController extends SuperController {
    ...
    public Result<PersonAttendanceRec> getById(String id) {
        ...
        // join 关联的对象
        personAttendanceRecService.dao().fill(personAttendanceRec).with(PersonAttendanceRecMeta.PERSON).with(PersonAttendanceRecMeta.EMPLOYEE).execute();
    ...
    public Result<PagedList<PersonAttendanceRec>> queryPagedList(PersonAttendanceRecVO sample) {
        ...
        // join 关联的对象
        personAttendanceRecService.dao().fill(list).with(PersonAttendanceRecMeta.PERSON).with(PersonAttendanceRecMeta.EMPLOYEE).execute();
        result.success(true).data(list);
        return result;
    }
