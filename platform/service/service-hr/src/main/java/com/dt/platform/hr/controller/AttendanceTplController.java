...
public class AttendanceTplController extends SuperController {
    ...
    @ApiImplicitParams({
		...
		@ApiImplicitParam(name = AttendanceTplVOMeta.NAME, value = "名称", required = false, dataTypeClass = String.class, example = "默认组"),
		@ApiImplicitParam(name = AttendanceTplVOMeta.NOTES, value = "备注", required = false, dataTypeClass = String.class, example = "默认考勤组"),
		...
		@ApiImplicitParam(name = AttendanceTplVOMeta.TPL_TYPE, value = "类型", required = false, dataTypeClass = String.class)
	})
