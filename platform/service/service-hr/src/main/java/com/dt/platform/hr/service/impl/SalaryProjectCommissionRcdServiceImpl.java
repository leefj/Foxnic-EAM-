...
@Service("HrSalaryProjectCommissionRcdService")

public class SalaryProjectCommissionRcdServiceImpl extends SuperService<SalaryProjectCommissionRcd> implements ISalaryProjectCommissionRcdService {
	 ...
	 * */
	@Override
	public Result insert(SalaryProjectCommissionRcd salaryProjectCommissionRcd) {
		return this.insert(salaryProjectCommissionRcd,true);
	}
	 ...
	 * */
	@Override
	public Result insertList(List<SalaryProjectCommissionRcd> salaryProjectCommissionRcdList) {
		return super.insertList(salaryProjectCommissionRcdList);
	}
	...
	public Result deleteByIdPhysical(String id) {
		SalaryProjectCommissionRcd salaryProjectCommissionRcd = new SalaryProjectCommissionRcd();
		if(id==null) return ErrorDesc.failure().message("id 不允许为 null 。");
		salaryProjectCommissionRcd.setId(id);
		try {
			boolean suc = dao.deleteEntity(salaryProjectCommissionRcd);
	...
	public Result deleteByIdLogical(String id) {
		...
		if(id==null) return ErrorDesc.failure().message("id 不允许为 null 。");
		salaryProjectCommissionRcd.setId(id);
		salaryProjectCommissionRcd.setDeleted(true);
		salaryProjectCommissionRcd.setDeleteBy((String)dao.getDBTreaty().getLoginUserId());
		salaryProjectCommissionRcd.setDeleteTime(new Date());
		try {
			boolean suc = dao.updateEntity(salaryProjectCommissionRcd,SaveMode.NOT_NULL_FIELDS);
			return suc?ErrorDesc.success():ErrorDesc.failure();
		}
		catch(Exception e) {
			Result r= ErrorDesc.failure();
	 ...
	 * */
	@Override
	public Result update(SalaryProjectCommissionRcd salaryProjectCommissionRcd , SaveMode mode) {
		return this.update(salaryProjectCommissionRcd,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(SalaryProjectCommissionRcd salaryProjectCommissionRcd , SaveMode mode,boolean throwsException) {
		Result r=super.update(salaryProjectCommissionRcd , mode , throwsException);
		return r;
	}
	 ...
	 * */
	@Override
	public Result updateList(List<SalaryProjectCommissionRcd> salaryProjectCommissionRcdList , SaveMode mode) {
		return super.updateList(salaryProjectCommissionRcdList , mode);
	}
	 ...
	 */
	public SalaryProjectCommissionRcd getById(String id) {
		SalaryProjectCommissionRcd sample = new SalaryProjectCommissionRcd();
		if(id==null) throw new IllegalArgumentException("id 不允许为 null ");
		sample.setId(id);
	 ...
	 * */
	@Override
	public List<SalaryProjectCommissionRcd> getByIds(List<String> ids) {
		return this.queryListByIds(ids);
	}

	@Override
	public List<SalaryProjectCommissionRcd> queryListByIds(List<String> ids) {
		return super.queryListByUKeys("id",ids);
	}

	@Override
	public Map<String, SalaryProjectCommissionRcd> queryMapByIds(List<String> ids) {
		return super.queryMapByUKeys("id",ids, SalaryProjectCommissionRcd::getId);
	}
	 ...
	 * */
	@Override
	public List<SalaryProjectCommissionRcd> queryList(SalaryProjectCommissionRcdVO sample) {
	 ...
	 * */
	@Override
	public PagedList<SalaryProjectCommissionRcd> queryPagedList(SalaryProjectCommissionRcdVO sample, int pageSize, int pageIndex) {
	 ...
	 * */
	@Override
	public PagedList<SalaryProjectCommissionRcd> queryPagedList(SalaryProjectCommissionRcd sample, ConditionExpr condition, int pageSize, int pageIndex) {
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(SalaryProjectCommissionRcd salaryProjectCommissionRcd) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(salaryProjectCommissionRcd, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
	...
	@Override
	public Result insert(SalaryProjectCommissionRcd salaryProjectCommissionRcd,boolean throwsException) {
		Result r=super.insert(salaryProjectCommissionRcd,throwsException);
		return r;
	}
