...
@Service("HrAttendanceHolidayService")

public class AttendanceHolidayServiceImpl extends SuperService<AttendanceHoliday> implements IAttendanceHolidayService {
	 ...
	 *
	 * @param attendanceHoliday  数据对象
	 * @param throwsException 是否抛出异常，如果不抛出异常，则返回一个失败的 Result 对象
	 * @return 结果 , 如果失败返回 false，成功返回 true
	 */
	@Override
	public Result insert(AttendanceHoliday attendanceHoliday,boolean throwsException) {
		Result r=super.insert(attendanceHoliday,throwsException);
		return r;
	}
	 ...
	 * */
	@Override
	public Result insert(AttendanceHoliday attendanceHoliday) {
		return this.insert(attendanceHoliday,true);
	}

	/**
	 * 批量插入实体，事务内
	 * @param attendanceHolidayList 实体数据清单
	 * @return 插入是否成功
	 * */
	@Override
	public Result insertList(List<AttendanceHoliday> attendanceHolidayList) {
		return super.insertList(attendanceHolidayList);
	}
	...
	public Result deleteByIdPhysical(String id) {
		...
		attendanceHoliday.setId(id);
		try {
			boolean suc = dao.deleteEntity(attendanceHoliday);
	...
	public Result deleteByIdLogical(String id) {
		...
		if(id==null) return ErrorDesc.failure().message("id 不允许为 null 。");
		attendanceHoliday.setId(id);
		attendanceHoliday.setDeleted(true);
		attendanceHoliday.setDeleteBy((String)dao.getDBTreaty().getLoginUserId());
		attendanceHoliday.setDeleteTime(new Date());
		try {
			boolean suc = dao.updateEntity(attendanceHoliday,SaveMode.NOT_NULL_FIELDS);
			return suc?ErrorDesc.success():ErrorDesc.failure();
		}
		catch(Exception e) {
			Result r= ErrorDesc.failure();
	 ...
	 * */
	@Override
	public Result update(AttendanceHoliday attendanceHoliday , SaveMode mode) {
		return this.update(attendanceHoliday,mode,true);
	}
	 ...
	 * */
	@Override
	public Result update(AttendanceHoliday attendanceHoliday , SaveMode mode,boolean throwsException) {
		Result r=super.update(attendanceHoliday , mode , throwsException);
		return r;
	}

	/**
	 * 更新实体集，事务内
	 * @param attendanceHolidayList 数据对象列表
	 * @param mode 保存模式
	 * @return 保存是否成功
	 * */
	@Override
	public Result updateList(List<AttendanceHoliday> attendanceHolidayList , SaveMode mode) {
		return super.updateList(attendanceHolidayList , mode);
	}
	 ...
	 *
	 * @param id 主键
	 * @return AttendanceHoliday 数据对象
	 */
	public AttendanceHoliday getById(String id) {
		AttendanceHoliday sample = new AttendanceHoliday();
		if(id==null) throw new IllegalArgumentException("id 不允许为 null ");
		sample.setId(id);
	 ...
	 * */
	@Override
	public List<AttendanceHoliday> getByIds(List<String> ids) {
		return this.queryListByIds(ids);
	}

	@Override
	public List<AttendanceHoliday> queryListByIds(List<String> ids) {
		return super.queryListByUKeys("id",ids);
	}

	@Override
	public Map<String, AttendanceHoliday> queryMapByIds(List<String> ids) {
		return super.queryMapByUKeys("id",ids, AttendanceHoliday::getId);
	}
	 ...
	 * */
	@Override
	public List<AttendanceHoliday> queryList(AttendanceHolidayVO sample) {
	 ...
	 * */
	@Override
	public PagedList<AttendanceHoliday> queryPagedList(AttendanceHolidayVO sample, int pageSize, int pageIndex) {
	 ...
	 * */
	@Override
	public PagedList<AttendanceHoliday> queryPagedList(AttendanceHoliday sample, ConditionExpr condition, int pageSize, int pageIndex) {
	 ...
	 * @return 判断结果
	 */
	public Boolean checkExists(AttendanceHoliday attendanceHoliday) {
		//TDOD 此处添加判断段的代码
		//boolean exists=super.checkExists(attendanceHoliday, SYS_ROLE.NAME);
		//return exists;
		return false;
	}
	...
	@Override
	public ExcelWriter exportExcel(AttendanceHoliday sample) {
	...
	public List<ValidateResult> importData(RcdSet rs) {
		...
		HashMap<String,String> typeDictMap=queryDictItemDataByDictCode("hr_attendance_h_type");
