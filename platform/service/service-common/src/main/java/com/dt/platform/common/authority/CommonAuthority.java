...
public class CommonAuthority extends ModuleAuthority {
    ...
    public String[] getAuthorities() {
      ...
      //  Result<List<KeyCode>> res=KeyCodeServiceProxy.api().queryList(vo);
        String[] s=new String[] {"system:report","system:employee","pay","system_monitor_list","bigscreen","system:mngr","system_ops","common_system","data_backup","auto_perm","sys_tpl_file:mngr","system_monitor"};
