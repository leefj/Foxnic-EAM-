...
public class ScreenController extends SuperController {
	...
	*/
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = ScreenVOMeta.ID , value = "主键" , required = true , dataTypeClass=String.class , example = "716023070585782272"),
		@ApiImplicitParam(name = ScreenVOMeta.CODE , value = "编号" , required = false , dataTypeClass=String.class , example = "bigscreen"),
		@ApiImplicitParam(name = ScreenVOMeta.NAME , value = "名称" , required = false , dataTypeClass=String.class , example = "大屏"),
