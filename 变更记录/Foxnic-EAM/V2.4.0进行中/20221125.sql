...
CREATE TABLE `eam_asset_depreciation_detail` (
                                                 ...
                                                 `first_depreciation_date` varchar(50) DEFAULT NULL COMMENT '首次折旧方式',
                                                 ...
                                                 `asset_enav_price` decimal(10,2) DEFAULT NULL COMMENT '资产净值,(当前)',
                                                 `asset_tax_amount_rate` decimal(10,2) DEFAULT NULL COMMENT '税额',
                                                 `asset_service_life` decimal(10,2) DEFAULT NULL COMMENT '可使用期限,月',
                                                 `asset_redidual_rate` decimal(10,2) DEFAULT NULL COMMENT '本期残值率',
                                                 `asset_redidual_price` decimal(10,2) DEFAULT NULL COMMENT '本期残值',
                                                 ...
                                                 first_depreciation varchar(1) DEFAULT NULL COMMENT '首次折旧,0否,1是',
...
CREATE TABLE `eam_asset_depreciation_calculation` (
                                                      `id` varchar(50) NOT NULL COMMENT '主键',
                                                      `depreciation_id` varchar(50) DEFAULT NULL COMMENT '折旧方案',
                                                      `status` varchar(50) DEFAULT NULL COMMENT '状态',
                                                      `rule_number` int(11) DEFAULT '0' COMMENT '规则顺序',
